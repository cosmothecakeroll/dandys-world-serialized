...
local winterMintTisha = Instance.new("Model")
winterMintTisha.Name = "WinterMintTisha"
do
	local inLobby = Instance.new("BoolValue")
	inLobby.Name = "InLobby"
	inLobby.Parent = winterMintTisha
	local showDuster = Instance.new("Script")
	showDuster.Name = "ShowDuster"
	showDuster.Parent = winterMintTisha
	...
	humanoid.Parent = winterMintTisha
	...
	config.Parent = winterMintTisha
	local animations = Instance.new("Configuration")
	animations.Name = "Animations"
	do
		local idle = Instance.new("Animation")
		idle.Name = "Idle"
		idle.AnimationId = "rbxassetid://100527134720369"
		idle.Parent = animations
		local ability = Instance.new("Animation")
		ability.Name = "Ability"
		ability.AnimationId = "rbxassetid://133255474562854"
		ability.Parent = animations
		local decode = Instance.new("Animation")
		decode.Name = "Decode"
		decode.AnimationId = "rbxassetid://73194617893805"
		decode.Parent = animations
		local quirk = Instance.new("Animation")
		quirk.Name = "Quirk"
		quirk.AnimationId = "rbxassetid://77442035732104"
		quirk.Parent = animations
		local idleToExtract = Instance.new("Animation")
		idleToExtract.Name = "IdleToExtract"
		idleToExtract.AnimationId = "rbxassetid://109473811458829"
		idleToExtract.Parent = animations
		local walk = Instance.new("Animation")
		walk.Name = "Walk"
		walk.AnimationId = "rbxassetid://132404299819701"
		walk.Parent = animations
		local run = Instance.new("Animation")
		run.Name = "Run"
		run.AnimationId = "rbxassetid://116741313910962"
		run.Parent = animations
	end
	animations.Parent = winterMintTisha
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-49.3893, 1.9481, -92.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = winterMintTisha
	...
	featherStick.CFrame = CFrame.new(Vector3.new(-49.3893, 5.4033, -89.5559)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		featherStick_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://103246698703295", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		featherStick_2.TextureID = "rbxassetid://134668668117322"
		featherStick_2.CollisionGroup = "Player"
		...
		featherStick_2.CFrame = CFrame.new(Vector3.new(-49.3893, 5.4033, -89.5559)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	featherStick.Parent = winterMintTisha
	...
	torso.CFrame = CFrame.new(Vector3.new(-49.3888, 3.9267, -92.5944)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		torso_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://125357984785644", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		torso_2.TextureID = "rbxassetid://134668668117322"
		...
		torso_2.Size = Vector3.new(1.7592, 1.7583, 1.7592)
		torso_2.CFrame = CFrame.new(Vector3.new(-49.3888, 3.9267, -92.5944)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		torso_2.PivotOffset = CFrame.new(Vector3.new(0, 0.0278, 0))
		do
			torsoMotor6d_2 = Instance.new("Motor6D")
			torsoMotor6d_2.Name = "TorsoMotor6D"
			torsoMotor6d_2.MaxVelocity = 0.1
			torsoMotor6d_2.C0 = CFrame.new(Vector3.yAxis * 1.9215)
	...
	head.TextureID = "rbxassetid://134668668117322"
	...
	head.CFrame = CFrame.new(Vector3.new(-49.4128, 6.1285, -92.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		head_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://122990534337949", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		head_2.TextureID = "rbxassetid://134668668117322"
		...
		head_2.Size = Vector3.new(4.3957, 2.9482, 1.9816)
		head_2.CFrame = CFrame.new(Vector3.new(-49.4128, 6.1285, -92.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		head_2.PivotOffset = CFrame.new(Vector3.new(0, -0.0218, 0))
		do
			headMotor6d_2 = Instance.new("Motor6D")
			headMotor6d_2.Name = "HeadMotor6D"
			headMotor6d_2.MaxVelocity = 0.1
			headMotor6d_2.C0 = CFrame.new(Vector3.new(0, 4.202, 0.0234))
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-49.2384, 2.6277, -92.8189)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://113301962732646", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftLeg_2.TextureID = "rbxassetid://134668668117322"
		...
		leftLeg_2.Size = Vector3.new(0.4205, 1.4225, 0.6005)
		leftLeg_2.CFrame = CFrame.new(Vector3.new(-49.2384, 2.6277, -92.8189)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		leftLeg_2.PivotOffset = CFrame.new(Vector3.new(0, 0.5715, 0))
		do
			leftLegMotor6d_2 = Instance.new("Motor6D")
			leftLegMotor6d_2.Name = "LeftLegMotor6D"
			leftLegMotor6d_2.MaxVelocity = 0.1
			leftLegMotor6d_2.C0 = CFrame.new(Vector3.new(-0.2253, 0.6795, -0.151))
	...
	leftLeg.Parent = winterMintTisha
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-49.2384, 2.6277, -92.3683)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://137206055034364", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightLeg_2.TextureID = "rbxassetid://134668668117322"
		...
		rightLeg_2.Size = Vector3.new(0.4205, 1.4225, 0.6005)
		rightLeg_2.CFrame = CFrame.new(Vector3.new(-49.2384, 2.6277, -92.3683)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		rightLeg_2.PivotOffset = CFrame.new(Vector3.new(0, 0.5715, 0))
		do
			rightLegMotor6d_2 = Instance.new("Motor6D")
			rightLegMotor6d_2.Name = "RightLegMotor6D"
			rightLegMotor6d_2.MaxVelocity = 0.1
			rightLegMotor6d_2.C0 = CFrame.new(Vector3.new(0.2252, 0.6795, -0.151))
	...
	rightLeg.Parent = winterMintTisha
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-49.3658, 4.5691, -93.8216)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://119006825096114", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftArm_2.TextureID = "rbxassetid://134668668117322"
		...
		leftArm_2.Size = Vector3.new(1.8565, 0.7287, 0.6389)
		leftArm_2.CFrame = CFrame.new(Vector3.new(-49.3658, 4.5691, -93.8216)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		leftArm_2.PivotOffset = CFrame.new(Vector3.new(0.9091, -0.0227, 0))
		do
			leftArmMotor6d_2 = Instance.new("Motor6D")
			leftArmMotor6d_2.Name = "LeftArmMotor6D"
			leftArmMotor6d_2.MaxVelocity = 0.1
			leftArmMotor6d_2.C0 = CFrame.new(Vector3.new(-1.228, 2.5741, -0.0236))
	...
	leftArm.Parent = winterMintTisha
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-49.3658, 4.5691, -91.3656)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://124086741673267", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightArm_2.TextureID = "rbxassetid://134668668117322"
		...
		rightArm_2.Size = Vector3.new(1.8565, 0.7287, 0.6389)
		rightArm_2.CFrame = CFrame.new(Vector3.new(-49.3658, 4.5691, -91.3656)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		rightArm_2.PivotOffset = CFrame.new(Vector3.new(-0.9092, -0.0227, 0))
		do
			rightArmMotor6d_2 = Instance.new("Motor6D")
			rightArmMotor6d_2.Name = "RightArmMotor6D"
			rightArmMotor6d_2.MaxVelocity = 0.1
			rightArmMotor6d_2.C0 = CFrame.new(Vector3.new(1.2279, 2.5741, -0.0236))
	...
	rightArm.Parent = winterMintTisha
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-49.3893, 1.9481, -92.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		weldConstraint = Instance.new("WeldConstraint")
		weldConstraint.Parent = rootPart
		local rootJnt = Instance.new("Bone")
		rootJnt.Name = "root_jnt"
		rootJnt.CFrame = CFrame.new(Vector3.new(0, -0.8001, 0.003))
		do
			...
			do
				...
				do
					...
					do
						...
						local lRibbonJnt = Instance.new("Bone")
						lRibbonJnt.Name = "L_ribbon_jnt"
						lRibbonJnt.CFrame = CFrame.new(Vector3.new(-1.886, 1.3461, -0.317))
						lRibbonJnt.Parent = headJnt
						local rRibbonJnt = Instance.new("Bone")
						rRibbonJnt.Name = "R_ribbon_jnt"
						rRibbonJnt.CFrame = CFrame.new(Vector3.new(1.8731, 1.3461, -0.317))
						rRibbonJnt.Parent = headJnt
					end
	...
	stats.Parent = winterMintTisha
end

winterMintTisha.PrimaryPart = humanoidRootPart
