...
local partyHat = Instance.new("Model")
partyHat.Name = "PartyHat"
do
	...
	animations.Parent = partyHat
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://123253832816232"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://98091512483620"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://100068767758938"
	...
	humanoid.Parent = partyHat
	head = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://115174944077734", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	head.TextureID = "rbxassetid://123253832816232"
	...
	head.Size = Vector3.new(4.0063, 4.003, 2.4407)
	head.CFrame = CFrame.new(Vector3.new(-49.25, 5.1513, -9.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	head.PivotOffset = CFrame.new(Vector3.new(0, -4.9722, 0.1393)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
	do
		headMotor6d = Instance.new("Motor6D")
		headMotor6d.Name = "HeadMotor6D"
		headMotor6d.MaxVelocity = 0.1
		headMotor6d.C0 = CFrame.new(Vector3.new(0, 4.9721, -0.1394))
		headMotor6d.Parent = head
	end
	head.Parent = partyHat
	leftArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://115246372883645", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	leftArm.TextureID = "rbxassetid://123253832816232"
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-49.3893, 2.7379, -10.7814)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.Parent = partyHat
	leftHand = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://124951390350656", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	leftHand.TextureID = "rbxassetid://123253832816232"
	...
	leftHand.CFrame = CFrame.new(Vector3.new(-49.3823, 2.7286, -12.8282)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftHand.Parent = partyHat
	leftLeg = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://93622353173599", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	leftLeg.TextureID = "rbxassetid://123253832816232"
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-49.2689, 1.1209, -9.3351)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.Parent = partyHat
	rightArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://130023149086793", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	rightArm.TextureID = "rbxassetid://123253832816232"
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-49.3893, 2.7379, -7.4058)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.Parent = partyHat
	rightHand = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://122897730425688", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	rightHand.TextureID = "rbxassetid://123253832816232"
	...
	rightHand.CFrame = CFrame.new(Vector3.new(-49.3823, 2.7286, -5.359)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightHand.Parent = partyHat
	rightLeg = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://137556072287762", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	rightLeg.TextureID = "rbxassetid://123253832816232"
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-49.2689, 1.1209, -8.8521)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.Parent = partyHat
	torso = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://85343667760569", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	torso.TextureID = "rbxassetid://123253832816232"
	torso.Name = "Torso"
	torso.CollisionGroup = "Player"
	torso.Massless = true
	torso.CanTouch = false
	torso.CanQuery = false
	torso.Size = Vector3.new(1.2336, 1.6955, 1.0008)
	torso.CFrame = CFrame.new(Vector3.new(-49.3657, 2.585, -9.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	torso.PivotOffset = CFrame.new(Vector3.new(0, -2.4059, 0.0236)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
	do
		torsoMotor6d = Instance.new("Motor6D")
		torsoMotor6d.Name = "TorsoMotor6D"
		torsoMotor6d.MaxVelocity = 0.1
		torsoMotor6d.C0 = CFrame.new(Vector3.new(0, 2.4058, -0.0237))
		torsoMotor6d.Parent = torso
	end
	torso.Parent = partyHat
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-49.3893, 0.1791, -9.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-49.3893, 2.1791, -9.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = partyHat
	local decoding = Instance.new("BoolValue")
	decoding.Name = "Decoding"
	decoding.Parent = partyHat
end

partyHat.PrimaryPart = humanoidRootPart
