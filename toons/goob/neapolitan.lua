...
local neapolitan = Instance.new("Model")
...
do
	...
	do
		...
		normalTexture.Texture = "rbxassetid://137238295457228"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://123537734089773"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://99315725741709"
	...
	humanoid.Parent = neapolitan
	local decoding = Instance.new("BoolValue")
	decoding.Name = "Decoding"
	decoding.Parent = neapolitan
	head = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://139072996832105", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	head.TextureID = "rbxassetid://109962215762348"
	...
	head.Size = Vector3.new(4.1362, 3.403, 2.4469)
	head.CFrame = CFrame.new(Vector3.new(-46.2469, 4.8806, -9.0287)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	head.PivotOffset = CFrame.new(Vector3.new(-0.065, -4.6722, 0.1424)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
	do
		headMotor6d = Instance.new("Motor6D")
		headMotor6d.Name = "HeadMotor6D"
		headMotor6d.MaxVelocity = 0.1
		headMotor6d.C0 = CFrame.new(Vector3.new(0.0649, 4.6721, -0.1425))
		headMotor6d.Parent = head
	end
	head.Parent = neapolitan
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-46.3893, 2.1791, -9.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = neapolitan
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-46.3893, 0.2085, -9.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = neapolitan
	torso = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://110967464232128", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	torso.TextureID = "rbxassetid://109962215762348"
	torso.Name = "Torso"
	torso.CollisionGroup = "Player"
	torso.Massless = true
	torso.CanTouch = false
	torso.CanQuery = false
	torso.Size = Vector3.new(1.394, 1.7152, 1.1292)
	torso.CFrame = CFrame.new(Vector3.new(-46.4079, 2.6044, -9.112)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	torso.PivotOffset = CFrame.new(Vector3.new(0.0183, -2.396, -0.0186)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
	do
		torsoMotor6d = Instance.new("Motor6D")
		torsoMotor6d.Name = "TorsoMotor6D"
		torsoMotor6d.MaxVelocity = 0.1
		torsoMotor6d.C0 = CFrame.new(Vector3.new(-0.0184, 2.3959, 0.0185))
		torsoMotor6d.Parent = torso
	end
	torso.Parent = neapolitan
	rightLeg = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://122771274246911", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	rightLeg.TextureID = "rbxassetid://109962215762348"
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-46.2689, 1.1502, -8.8521)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.Parent = neapolitan
	rightHand = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://138103672277195", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	rightHand.TextureID = "rbxassetid://109962215762348"
	...
	rightHand.CFrame = CFrame.new(Vector3.new(-46.3823, 2.7579, -5.359)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightHand.Parent = neapolitan
	rightArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://138835618593883", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	rightArm.TextureID = "rbxassetid://109962215762348"
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-46.3893, 2.7672, -7.4058)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.Parent = neapolitan
	leftLeg = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://88970422074611", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	leftLeg.TextureID = "rbxassetid://109962215762348"
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-46.2689, 1.1502, -9.3351)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.Parent = neapolitan
	leftHand = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://140169014649156", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	leftHand.TextureID = "rbxassetid://109962215762348"
	...
	leftHand.CFrame = CFrame.new(Vector3.new(-46.3823, 2.7579, -12.8282)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftHand.Parent = neapolitan
	leftArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://134112929099200", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	leftArm.TextureID = "rbxassetid://109962215762348"
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-46.3893, 2.7672, -10.7814)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.Parent = neapolitan
end

neapolitan.PrimaryPart = humanoidRootPart
