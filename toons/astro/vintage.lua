...
local vintageAstro = Instance.new("Model")
vintageAstro.Name = "VintageAstro"
vintageAstro.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	passiveAbility.Parent = vintageAstro
	...
	animations.Parent = vintageAstro
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://17661462304"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://17661468753"
	...
	hatGeo.TextureID = "rbxassetid://17661462304"
	hatGeo.Name = "HatGeo"
	...
	hatGeo.CFrame = CFrame.new(Vector3.new(-55.0707, 6.4088, 107.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	head.TextureID = "rbxassetid://17661462304"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-54.3951, 4.0521, 107.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.TextureID = "rbxassetid://17661462304"
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-54.2415, 0.7287, 107.6723)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.TextureID = "rbxassetid://17661462304"
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-54.2415, 0.7287, 108.1405)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	starBigGeo.TextureID = "rbxassetid://17661462304"
	...
	starBigGeo.CFrame = CFrame.new(Vector3.new(-54.1933, 2.1972, 107.9084)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	starBigGeo.Parent = vintageAstro
	...
	starSmallGeo.TextureID = "rbxassetid://17661462304"
	...
	starSmallGeo.CFrame = CFrame.new(Vector3.new(-54.2966, 1.9818, 107.9045)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	starSmallGeo.Parent = vintageAstro
	...
	torso.TextureID = "rbxassetid://17661462304"
	torso.Name = "Torso"
	torso.Massless = true
	...
	torso.CFrame = CFrame.new(Vector3.new(-54.3905, 1.9975, 107.9233)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-54.3893, -0.0519, 107.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-54.3893, 1.9481, 107.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = vintageAstro
end

vintageAstro.PrimaryPart = humanoidRootPart
