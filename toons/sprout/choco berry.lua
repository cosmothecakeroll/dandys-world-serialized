local sproutRigV002HeadGeo, sproutRigV002HeadGeoMotor6d, sproutRigV002Head, sproutRigV002HeadMotor6d, weld, sproutRigV002TorsoGeo, sproutRigV002TorsoGeoMotor6d, sproutRigV002Torso, sproutRigV002TorsoMotor6d, weld_2, sproutRigV002LeftArm, sproutRigV002LeftArmMotor6d, sproutRigV002LeftArm_2, sproutRigV002LeftArmMotor6d_2, weld_3, sproutRigV002LeftLeg, sproutRigV002LeftLegMotor6d, sproutRigV002LeftLeg_2, sproutRigV002LeftLegMotor6d_2, weld_4, sproutRigV002RightLeg, sproutRigV002RightLegMotor6d, sproutRigV002RightLeg_2, sproutRigV002RightLegMotor6d_2, weld_5, sproutRigV002RightArm, sproutRigV002RightArmMotor6d, sproutRigV002RightArm_2, sproutRigV002RightArmMotor6d_2, weld_6, sproutRigV002CharmSavory, sproutRigV002CharmSavoryMotor6d, rootPart, weldConstraint, humanoidRootPart

local chocoBerry = Instance.new("Model")
...
do
	...
	do
		...
		hurtTexture.Texture = "rbxassetid://78638305968685"
	...
	sproutRigV002HeadGeo.TextureID = "rbxassetid://80785358680340"
	...
	sproutRigV002HeadGeo.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
	sproutRigV002HeadGeo.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
	sproutRigV002HeadGeo.CFrame = CFrame.new(Vector3.new(-49.3117, 6.7164, -76.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		sproutRigV002Head = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://120116278144930", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		sproutRigV002Head.TextureID = "rbxassetid://80785358680340"
		sproutRigV002Head.Name = "Sprout_rig_v002:Head"
		sproutRigV002Head.CollisionGroup = "Player"
		sproutRigV002Head.CanQuery = false
		sproutRigV002Head.CanTouch = false
		sproutRigV002Head.Massless = true
		sproutRigV002Head.CanCollide = false
		sproutRigV002Head.Size = Vector3.new(2.6907, 3.6539, 2.2768)
		sproutRigV002Head.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
		sproutRigV002Head.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
		sproutRigV002Head.CFrame = CFrame.new(Vector3.new(-49.3117, 6.7164, -76.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		sproutRigV002Head.PivotOffset = CFrame.new(Vector3.new(-0.0854, -0.6755, 0))
		do
			sproutRigV002HeadMotor6d = Instance.new("Motor6D")
			sproutRigV002HeadMotor6d.Name = "Sprout_rig_v002:HeadMotor6D"
			sproutRigV002HeadMotor6d.MaxVelocity = 0.1
			sproutRigV002HeadMotor6d.C0 = CFrame.new(Vector3.new(0.0853, 4.7682, -0.0777))
			sproutRigV002HeadMotor6d.Parent = sproutRigV002Head
			weld = Instance.new("Weld")
			weld.Parent = sproutRigV002Head
		end
		sproutRigV002Head.Parent = sproutRigV002HeadGeo
	end
	sproutRigV002HeadGeo.Parent = chocoBerry
	...
	sproutRigV002TorsoGeo.TextureID = "rbxassetid://80785358680340"
	...
	sproutRigV002TorsoGeo.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
	sproutRigV002TorsoGeo.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
	sproutRigV002TorsoGeo.CFrame = CFrame.new(Vector3.new(-49.4682, 4.2841, -76.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		sproutRigV002Torso = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://126888515934106", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		sproutRigV002Torso.TextureID = "rbxassetid://80785358680340"
		sproutRigV002Torso.Name = "Sprout_rig_v002:Torso"
		sproutRigV002Torso.CollisionGroup = "Player"
		sproutRigV002Torso.CanQuery = false
		sproutRigV002Torso.CanTouch = false
		sproutRigV002Torso.Massless = true
		sproutRigV002Torso.CanCollide = false
		sproutRigV002Torso.Size = Vector3.new(2.5939, 2.1074, 1.7365)
		sproutRigV002Torso.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
		sproutRigV002Torso.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
		sproutRigV002Torso.CFrame = CFrame.new(Vector3.new(-49.4682, 4.2841, -76.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		sproutRigV002Torso.PivotOffset = CFrame.new(Vector3.new(0, 0.3325, 0.2143))
		do
			sproutRigV002TorsoMotor6d = Instance.new("Motor6D")
			sproutRigV002TorsoMotor6d.Name = "Sprout_rig_v002:TorsoMotor6D"
			sproutRigV002TorsoMotor6d.MaxVelocity = 0.1
			sproutRigV002TorsoMotor6d.C0 = CFrame.new(Vector3.new(0, 2.5214, 0.2822))
			sproutRigV002TorsoMotor6d.Parent = sproutRigV002Torso
			weld_2 = Instance.new("Weld")
			weld_2.Parent = sproutRigV002Torso
		end
		sproutRigV002Torso.Parent = sproutRigV002TorsoGeo
	end
	sproutRigV002TorsoGeo.Parent = chocoBerry
	...
	sproutRigV002LeftArm.TextureID = "rbxassetid://80785358680340"
	...
	sproutRigV002LeftArm.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
	sproutRigV002LeftArm.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
	sproutRigV002LeftArm.CFrame = CFrame.new(Vector3.new(-49.5319, 4.6682, -78.0405)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		sproutRigV002LeftArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://110134221396675", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		sproutRigV002LeftArm_2.TextureID = "rbxassetid://80785358680340"
		sproutRigV002LeftArm_2.Name = "Sprout_rig_v002:LeftArm"
		sproutRigV002LeftArm_2.CollisionGroup = "Player"
		sproutRigV002LeftArm_2.CanQuery = false
		sproutRigV002LeftArm_2.CanTouch = false
		sproutRigV002LeftArm_2.Massless = true
		sproutRigV002LeftArm_2.CanCollide = false
		sproutRigV002LeftArm_2.Size = Vector3.new(2.136, 0.7537, 0.5182)
		sproutRigV002LeftArm_2.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
		sproutRigV002LeftArm_2.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
		sproutRigV002LeftArm_2.CFrame = CFrame.new(Vector3.new(-49.5319, 4.6682, -78.0405)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			weld_3.Parent = sproutRigV002LeftArm_2
		end
		sproutRigV002LeftArm_2.Parent = sproutRigV002LeftArm
	end
	sproutRigV002LeftArm.Parent = chocoBerry
	...
	sproutRigV002LeftLeg.TextureID = "rbxassetid://80785358680340"
	...
	sproutRigV002LeftLeg.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
	sproutRigV002LeftLeg.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
	sproutRigV002LeftLeg.CFrame = CFrame.new(Vector3.new(-49.2421, 2.8511, -76.8483)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		sproutRigV002LeftLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://140081937019625", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		sproutRigV002LeftLeg_2.TextureID = "rbxassetid://80785358680340"
		sproutRigV002LeftLeg_2.Name = "Sprout_rig_v002:LeftLeg"
		sproutRigV002LeftLeg_2.CollisionGroup = "Player"
		sproutRigV002LeftLeg_2.CanQuery = false
		sproutRigV002LeftLeg_2.CanTouch = false
		sproutRigV002LeftLeg_2.Massless = true
		sproutRigV002LeftLeg_2.CanCollide = false
		sproutRigV002LeftLeg_2.Size = Vector3.new(0.6311, 1.9877, 0.7301)
		sproutRigV002LeftLeg_2.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
		sproutRigV002LeftLeg_2.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
		sproutRigV002LeftLeg_2.CFrame = CFrame.new(Vector3.new(-49.2421, 2.8511, -76.8483)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		sproutRigV002LeftLeg_2.PivotOffset = CFrame.new(Vector3.new(0, 0.8108, -0.0315))
		do
			...
			sproutRigV002LeftLegMotor6d_2.C0 = CFrame.new(Vector3.new(-0.2548, 0.9029, -0.1159))
			sproutRigV002LeftLegMotor6d_2.Parent = sproutRigV002LeftLeg_2
			weld_4 = Instance.new("Weld")
			weld_4.Parent = sproutRigV002LeftLeg_2
		end
		sproutRigV002LeftLeg_2.Parent = sproutRigV002LeftLeg
	end
	sproutRigV002LeftLeg.Parent = chocoBerry
	...
	sproutRigV002RightLeg.TextureID = "rbxassetid://80785358680340"
	...
	sproutRigV002RightLeg.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
	sproutRigV002RightLeg.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
	sproutRigV002RightLeg.CFrame = CFrame.new(Vector3.new(-49.2421, 2.8511, -76.3389)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		sproutRigV002RightLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://87555507211816", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		sproutRigV002RightLeg_2.TextureID = "rbxassetid://80785358680340"
		sproutRigV002RightLeg_2.Name = "Sprout_rig_v002:RightLeg"
		sproutRigV002RightLeg_2.CollisionGroup = "Player"
		sproutRigV002RightLeg_2.CanQuery = false
		sproutRigV002RightLeg_2.CanTouch = false
		sproutRigV002RightLeg_2.Massless = true
		sproutRigV002RightLeg_2.CanCollide = false
		sproutRigV002RightLeg_2.Size = Vector3.new(0.6311, 1.9877, 0.7301)
		sproutRigV002RightLeg_2.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
		sproutRigV002RightLeg_2.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
		sproutRigV002RightLeg_2.CFrame = CFrame.new(Vector3.new(-49.2421, 2.8511, -76.3389)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		sproutRigV002RightLeg_2.PivotOffset = CFrame.new(Vector3.new(0, 0.8108, -0.0315))
		do
			...
			sproutRigV002RightLegMotor6d_2.C0 = CFrame.new(Vector3.new(0.2547, 0.9029, -0.1159))
			sproutRigV002RightLegMotor6d_2.Parent = sproutRigV002RightLeg_2
			weld_5 = Instance.new("Weld")
			weld_5.Parent = sproutRigV002RightLeg_2
		end
		sproutRigV002RightLeg_2.Parent = sproutRigV002RightLeg
	end
	sproutRigV002RightLeg.Parent = chocoBerry
	...
	sproutRigV002RightArm.TextureID = "rbxassetid://80785358680340"
	...
	sproutRigV002RightArm.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
	sproutRigV002RightArm.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
	sproutRigV002RightArm.CFrame = CFrame.new(Vector3.new(-49.5319, 4.6682, -75.1467)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		sproutRigV002RightArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://132944740932267", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		sproutRigV002RightArm_2.TextureID = "rbxassetid://80785358680340"
		sproutRigV002RightArm_2.Name = "Sprout_rig_v002:RightArm"
		sproutRigV002RightArm_2.CollisionGroup = "Player"
		sproutRigV002RightArm_2.CanQuery = false
		sproutRigV002RightArm_2.CanTouch = false
		sproutRigV002RightArm_2.Massless = true
		sproutRigV002RightArm_2.CanCollide = false
		sproutRigV002RightArm_2.Size = Vector3.new(2.136, 0.7537, 0.5182)
		sproutRigV002RightArm_2.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
		sproutRigV002RightArm_2.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
		sproutRigV002RightArm_2.CFrame = CFrame.new(Vector3.new(-49.5319, 4.6682, -75.1467)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			weld_6.Parent = sproutRigV002RightArm_2
		end
		sproutRigV002RightArm_2.Parent = sproutRigV002RightArm
	end
	sproutRigV002RightArm.Parent = chocoBerry
	...
	sproutRigV002CharmSavory.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
	sproutRigV002CharmSavory.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
	sproutRigV002CharmSavory.CFrame = CFrame.new(Vector3.new(-49.496, 4.155, -76.5918)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	sproutRigV002CharmSavory.Parent = chocoBerry
	...
	rootPart.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
	rootPart.Size = Vector3.new(2, 2, 1)
	rootPart.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
	rootPart.CFrame = CFrame.new(Vector3.new(-49.3893, 1.9481, -76.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		do
			local sproutRigV002Torso_2 = Instance.new("Bone")
			sproutRigV002Torso_2.Name = "Sprout_rig_v002:torso"
			sproutRigV002Torso_2.CFrame = CFrame.new(Vector3.new(0, 0.3621, -0.0185))
			do
				...
				do
					local sproutRigV002Head_2 = Instance.new("Bone")
					sproutRigV002Head_2.Name = "Sprout_rig_v002:head"
					sproutRigV002Head_2.CFrame = CFrame.new(Vector3.new(0, 0.3426, -0.0031))
					sproutRigV002Head_2.Parent = sproutRigV002Chest
				...
				sproutRigV002Chest.Parent = sproutRigV002Torso_2
				...
				sproutRigV002Attachment.Parent = sproutRigV002Torso_2
			end
			sproutRigV002Torso_2.Parent = sproutRigV002Root
	...
	rootPart.Parent = chocoBerry
	humanoidRootPart = Instance.new("Part")
	humanoidRootPart.Name = "HumanoidRootPart"
	humanoidRootPart.CollisionGroup = "Player"
	humanoidRootPart.Transparency = 1
	humanoidRootPart.AssemblyAngularVelocity = Vector3.yAxis * 14.1006
	humanoidRootPart.Size = Vector3.new(2, 2, 1)
	humanoidRootPart.AssemblyLinearVelocity = Vector3.new(-11.6307, 0, 10.9819)
	humanoidRootPart.CustomPhysicalProperties = PhysicalProperties.new(15, 1, 0.3, 1, 1, 1)
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-49.3893, 1.9481, -76.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
...
weld_3.Part0 = sproutRigV002LeftArm_2
...
weld_4.Part0 = sproutRigV002LeftLeg_2
...
weld_5.Part0 = sproutRigV002RightLeg_2
...
weld_6.Part0 = sproutRigV002RightArm_2
