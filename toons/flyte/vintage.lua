...
local vintageFlyte = Instance.new("Model")
vintageFlyte.Name = "VintageFlyte"
do
	...
	animations.Parent = vintageFlyte
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://77678357664294"
		normalTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://105145745885574"
		hurtTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://112446707586788"
	...
	torso.TextureID = "rbxassetid://77678357664294"
	torso.Name = "Torso"
	...
	torso.CFrame = CFrame.new(Vector3.new(-47.3875, 5.4358, 15.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightAntenna.TextureID = "rbxassetid://77678357664294"
	...
	rightAntenna.AssemblyAngularVelocity = Vector3.yAxis * 0
	rightAntenna.CustomPhysicalProperties = PhysicalProperties.new(15, 0.3, 0.5, 1, 3, 1)
	rightAntenna.CFrame = CFrame.new(Vector3.new(-47.9404, 8.9379, 16.2755)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rightAntenna.Parent = vintageFlyte
	...
	leftAntenna.TextureID = "rbxassetid://77678357664294"
	...
	leftAntenna.AssemblyAngularVelocity = Vector3.yAxis * 0
	leftAntenna.CustomPhysicalProperties = PhysicalProperties.new(15, 0.3, 0.5, 1, 3, 1)
	leftAntenna.CFrame = CFrame.new(Vector3.new(-47.9404, 8.9379, 14.5373)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	leftAntenna.Parent = vintageFlyte
	...
	leftWing.TextureID = "rbxassetid://77678357664294"
	...
	leftWing.AssemblyAngularVelocity = Vector3.yAxis * 0
	leftWing.CustomPhysicalProperties = PhysicalProperties.new(15, 0.3, 0.5, 1, 3, 1)
	leftWing.CFrame = CFrame.new(Vector3.new(-48.3011, 5.944, 13.7703)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightWing.TextureID = "rbxassetid://77678357664294"
	...
	rightWing.AssemblyAngularVelocity = Vector3.yAxis * 0
	rightWing.CustomPhysicalProperties = PhysicalProperties.new(15, 0.3, 0.5, 1, 3, 1)
	rightWing.CFrame = CFrame.new(Vector3.new(-48.3011, 5.944, 17.0425)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftUpperLeg.TextureID = "rbxassetid://77678357664294"
	...
	leftUpperLeg.CFrame = CFrame.new(Vector3.new(-47.3878, 4.012, 15.1429)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftUpperLeg.Parent = vintageFlyte
	...
	rightUpperLeg.TextureID = "rbxassetid://77678357664294"
	...
	rightUpperLeg.CFrame = CFrame.new(Vector3.new(-47.3878, 4.012, 15.6699)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rightUpperLeg.Parent = vintageFlyte
	...
	head.TextureID = "rbxassetid://77678357664294"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-47.04, 7.2019, 15.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rightLowerLeg.TextureID = "rbxassetid://77678357664294"
	...
	rightLowerLeg.CFrame = CFrame.new(Vector3.new(-47.393, 3.1416, 15.679)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerLeg.Parent = vintageFlyte
	...
	leftLowerLeg.TextureID = "rbxassetid://77678357664294"
	...
	leftLowerLeg.CFrame = CFrame.new(Vector3.new(-47.393, 3.1416, 15.1338)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerLeg.Parent = vintageFlyte
	...
	leftFoot.TextureID = "rbxassetid://77678357664294"
	...
	leftFoot.CFrame = CFrame.new(Vector3.new(-47.2341, 2.6141, 15.134)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightFoot.TextureID = "rbxassetid://77678357664294"
	...
	rightFoot.CFrame = CFrame.new(Vector3.new(-47.2341, 2.6141, 15.6788)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-47.3893, 2.4481, 15.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		do
			...
			torso_2.CFrame = CFrame.new(Vector3.new(-1.0397, 0.0477, 0)) * CFrame.fromEulerAnglesXYZ(math.rad(90.005), math.rad(-3.6448), 0)
			do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-47.3893, 2.4481, 15.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	humanoidRootPart.Parent = vintageFlyte
end

vintageFlyte.PrimaryPart = humanoidRootPart
