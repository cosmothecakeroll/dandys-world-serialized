...
do
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-50.8893, -0.0519, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		do
			...
			do
				...
				do
					...
					capeBack.CFrame = CFrame.new(Vector3.new(0, 0.3662, 0.3308))
					...
					do
						...
						do
							...
							do
								...
								capeL.Name = "Cape.L"
								capeL.SecondaryAxis = Vector3.new(-0.0011, 0.9989, -0.0448)
								capeL.Axis = Vector3.new(0, -0.0448, -0.999)
								capeL.CFrame = CFrame.new(Vector3.new(0, -0.3967, -0.1756)) * CFrame.fromEulerAnglesXYZ(math.rad(-90.5954), math.rad(89.944), math.rad(88.0316))
								...
								forearmStretchL.CFrame = CFrame.new(Vector3.new(0, 0.3586, 0)) * CFrame.fromEulerAnglesXYZ(0, 0, math.rad(0.1236))
								do
									...
									do
										...
										handL.Name = "hand.l"
										handL.SecondaryAxis = Vector3.new(0.0012, 1, -0.0076)
										handL.Axis = Vector3.new(1, -0.0013, 0)
										handL.CFrame = CFrame.new(Vector3.new(0, 0.3023, 0)) * CFrame.fromEulerAnglesXYZ(math.rad(-0.4303), 0, math.rad(-0.0693))
										do
											local fingersL = Instance.new("Bone")
											fingersL.Name = "Fingers.L"
											fingersL.SecondaryAxis = Vector3.new(0, 1, -0.0102)
											fingersL.CFrame = CFrame.new(Vector3.new(0, 0.4178, 0.0031)) * CFrame.fromEulerAnglesXYZ(math.rad(-0.5837), 0, 0)
					...
					do
						...
						cArmTwistOffsetR.CFrame = CFrame.new(Vector3.new(0, 0.2581, 0)) * CFrame.fromEulerAnglesXYZ(math.rad(-41.6927), math.rad(-0.0009), math.rad(0.0578))
						do
							...
							do
								...
								capeR.Name = "Cape.R"
								capeR.SecondaryAxis = Vector3.new(0.0009, 0.9989, -0.045)
								capeR.Axis = Vector3.new(0, 0.0449, 0.9989)
								capeR.CFrame = CFrame.new(Vector3.new(0, -0.3967, -0.1755)) * CFrame.fromEulerAnglesXYZ(math.rad(-90.3115), math.rad(-89.9441), math.rad(-87.7373))
								...
								forearmStretchR.CFrame = CFrame.new(Vector3.new(0, 0.3586, 0)) * CFrame.fromEulerAnglesXYZ(math.rad(-0.0198), 0, math.rad(-0.1237))
								do
									...
									do
										...
										handR.Name = "hand.r"
										handR.SecondaryAxis = Vector3.new(-0.0013, 1, -0.0328)
										handR.Axis = Vector3.new(1, 0.0012, 0)
										handR.CFrame = CFrame.new(Vector3.new(0, 0.3023, 0)) * CFrame.fromEulerAnglesXYZ(math.rad(-1.8746), math.rad(-0.0012), math.rad(0.0692))
										do
											local fingersR = Instance.new("Bone")
											fingersR.Name = "Fingers.R"
											fingersR.SecondaryAxis = Vector3.new(0, 1, 0.0328)
											fingersR.CFrame = CFrame.new(Vector3.new(0, 0.4176, 0.0137)) * CFrame.fromEulerAnglesXYZ(math.rad(1.8844), 0, 0)
					...
					neckX.Name = "neck.x"
					neckX.CFrame = CFrame.new(Vector3.new(0, 0.3151, 0))
					do
						local headX = Instance.new("Bone")
						headX.Name = "head.x"
						headX.CFrame = CFrame.new(Vector3.new(0, 0.202, 0))
						do
							...
							do
								...
								ear2L.Name = "Ear2.L"
								ear2L.CFrame = CFrame.new(Vector3.new(-0.0181, 0.4524, 0))
								ear2L.Parent = ear1L
							end
							ear1L.Parent = headX
							...
							do
								...
								ear2R.Name = "Ear2.R"
								ear2R.CFrame = CFrame.new(Vector3.new(0.018, 0.4524, 0))
								ear2R.Parent = ear1R
							end
							ear1R.Parent = headX
						end
			...
			do
				...
				do
					...
					do
						...
						legTwistL.CFrame = CFrame.new(Vector3.new(0, 0.4507, 0))
						do
							local footL = Instance.new("Bone")
							footL.Name = "foot.l"
							footL.SecondaryAxis = Vector3.new(-0.93, -0.149, 0.3362)
							footL.Axis = Vector3.new(-0.3401, 0, -0.9404)
							footL.CFrame = CFrame.new(Vector3.new(0, 0.4507, 0)) * CFrame.fromEulerAnglesXYZ(math.rad(-87.0638), math.rad(-8.0519), math.rad(110.088))
							do
			...
			do
				...
				do
					...
					do
						...
						legTwistR.CFrame = CFrame.new(Vector3.new(0, 0.4507, 0))
						do
							local footR = Instance.new("Bone")
							footR.Name = "foot.r"
							footR.SecondaryAxis = Vector3.new(0.9299, -0.149, 0.3362)
							footR.Axis = Vector3.new(-0.3401, 0, 0.9403)
							footR.CFrame = CFrame.new(Vector3.new(0, 0.4507, 0)) * CFrame.fromEulerAnglesXYZ(math.rad(-87.0638), math.rad(8.0518), math.rad(-110.0881))
							do
			...
			do
				...
				do
					...
					tail3.Name = "Tail3"
					tail3.CFrame = CFrame.new(Vector3.new(0, 0.1356, 0.5052))
					tail3.Parent = tail2
				end
				tail2.Parent = tail1
			end
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-50.8893, 1.9481, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = loneWolf
	...
	tailGeo.CFrame = CFrame.new(Vector3.new(-52.2061, 1.637, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		tailGeo_2.CFrame = CFrame.new(Vector3.new(-52.2061, 1.637, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			tailGeo_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://106031876311535", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			tailGeo_3.TextureID = "rbxassetid://86352383057320"
			...
			tailGeo_3.CFrame = CFrame.new(Vector3.new(-52.2061, 1.637, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			tailGeo_3.PivotOffset = CFrame.new(Vector3.new(0, -1.689, -1.3169)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
			do
				tailGeoMotor6d_3 = Instance.new("Motor6D")
				tailGeoMotor6d_3.Name = "Tail_GeoMotor6D"
				tailGeoMotor6d_3.MaxVelocity = 0.1
				tailGeoMotor6d_3.C0 = CFrame.new(Vector3.new(0, 1.6889, 1.3168))
	...
	torso.CFrame = CFrame.new(Vector3.new(-50.8712, 2.3625, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		torso_2.CFrame = CFrame.new(Vector3.new(-50.8712, 2.3625, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			torso_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://105734437085708", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			torso_3.TextureID = "rbxassetid://86352383057320"
			torso_3.Name = "Torso"
			torso_3.Massless = true
			torso_3.CanTouch = false
			torso_3.CanQuery = false
			torso_3.Size = Vector3.new(1.1034, 1.5497, 0.859)
			torso_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			torso_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			torso_3.CFrame = CFrame.new(Vector3.new(-50.8712, 2.3625, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			torso_3.PivotOffset = CFrame.new(Vector3.new(0, -2.4146, 0.018)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
			do
				torsoMotor6d_3 = Instance.new("Motor6D")
				torsoMotor6d_3.Name = "TorsoMotor6D"
				torsoMotor6d_3.MaxVelocity = 0.1
				torsoMotor6d_3.C0 = CFrame.new(Vector3.new(0, 2.4145, -0.0181))
	...
	capeGeo.CFrame = CFrame.new(Vector3.new(-50.95, 2.7261, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		capeGeo_2.CFrame = CFrame.new(Vector3.new(-50.95, 2.7261, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			capeGeo_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://71982954359178", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			capeGeo_3.TextureID = "rbxassetid://86352383057320"
			capeGeo_3.Name = "Cape_Geo"
			capeGeo_3.CanCollide = false
			capeGeo_3.CanTouch = false
			capeGeo_3.Massless = true
			capeGeo_3.CanQuery = false
			capeGeo_3.Size = Vector3.new(2.3275, 1.6739, 1.4468)
			capeGeo_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			capeGeo_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			capeGeo_3.CFrame = CFrame.new(Vector3.new(-50.95, 2.7261, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			capeGeo_3.PivotOffset = CFrame.new(Vector3.new(0, -2.736, -0.0983)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
			do
				capeGeoMotor6d_3 = Instance.new("Motor6D")
				capeGeoMotor6d_3.Name = "Cape_GeoMotor6D"
				capeGeoMotor6d_3.MaxVelocity = 0.1
				capeGeoMotor6d_3.C0 = CFrame.new(Vector3.new(0, 2.7359, 0.0982))
	...
	head.CFrame = CFrame.new(Vector3.new(-50.8372, 4.9234, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		head_2.CFrame = CFrame.new(Vector3.new(-50.8372, 4.9234, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			head_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://119722182405702", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			head_3.TextureID = "rbxassetid://86352383057320"
			head_3.Name = "Head"
			head_3.CanCollide = false
			head_3.CanTouch = false
			head_3.Massless = true
			head_3.CanQuery = false
			head_3.Size = Vector3.new(3.2978, 3.8127, 2.9581)
			head_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			head_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			head_3.CFrame = CFrame.new(Vector3.new(-50.8372, 4.9234, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			head_3.PivotOffset = CFrame.new(Vector3.new(0, -4.9756, 0.0521)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
			do
				headMotor6d_3 = Instance.new("Motor6D")
				headMotor6d_3.Name = "HeadMotor6D"
				headMotor6d_3.MaxVelocity = 0.1
				headMotor6d_3.C0 = CFrame.new(Vector3.new(0, 4.9755, -0.0522))
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-50.7753, 2.9063, 35.6104)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftArm_2.CFrame = CFrame.new(Vector3.new(-50.7753, 2.9063, 35.6104)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			leftArm_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://93107824794171", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			leftArm_3.TextureID = "rbxassetid://86352383057320"
			leftArm_3.Name = "LeftArm"
			leftArm_3.CanCollide = false
			leftArm_3.CanTouch = false
			leftArm_3.Massless = true
			leftArm_3.CanQuery = false
			leftArm_3.Size = Vector3.new(1.9484, 0.4057, 0.7111)
			leftArm_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			leftArm_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			leftArm_3.CFrame = CFrame.new(Vector3.new(-50.7753, 2.9063, 35.6104)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			leftArm_3.PivotOffset = CFrame.new(Vector3.new(1.296, -2.9584, 0.1139)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
			do
				leftArmMotor6d_3 = Instance.new("Motor6D")
				leftArmMotor6d_3.Name = "LeftArmMotor6D"
				leftArmMotor6d_3.MaxVelocity = 0.1
				leftArmMotor6d_3.C0 = CFrame.new(Vector3.new(-1.2961, 2.9583, -0.114))
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-50.8271, 0.9541, 36.568)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftLeg_2.CFrame = CFrame.new(Vector3.new(-50.8271, 0.9541, 36.568)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			leftLeg_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://119454168202676", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			leftLeg_3.TextureID = "rbxassetid://86352383057320"
			leftLeg_3.Name = "LeftLeg"
			leftLeg_3.CanCollide = false
			leftLeg_3.CanTouch = false
			leftLeg_3.Massless = true
			leftLeg_3.CanQuery = false
			leftLeg_3.Size = Vector3.new(0.641, 2.012, 0.7067)
			leftLeg_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			leftLeg_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			leftLeg_3.CFrame = CFrame.new(Vector3.new(-50.8271, 0.9541, 36.568)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			leftLeg_3.PivotOffset = CFrame.new(Vector3.new(0.3384, -1.0061, 0.0621)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
			do
				leftLegMotor6d_3 = Instance.new("Motor6D")
				leftLegMotor6d_3.Name = "LeftLegMotor6D"
				leftLegMotor6d_3.MaxVelocity = 0.1
				leftLegMotor6d_3.C0 = CFrame.new(Vector3.new(-0.3385, 1.006, -0.0622))
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-50.7753, 2.9063, 38.2024)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightArm_2.CFrame = CFrame.new(Vector3.new(-50.7753, 2.9063, 38.2024)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			rightArm_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://102881701492689", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			rightArm_3.TextureID = "rbxassetid://86352383057320"
			...
			rightArm_3.Size = Vector3.new(1.9484, 0.4057, 0.7111)
			rightArm_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			rightArm_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			rightArm_3.CFrame = CFrame.new(Vector3.new(-50.7753, 2.9063, 38.2024)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			rightArm_3.PivotOffset = CFrame.new(Vector3.new(-1.2961, -2.9584, 0.1139)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
			do
				rightArmMotor6d_3 = Instance.new("Motor6D")
				rightArmMotor6d_3.Name = "RightArmMotor6D"
				rightArmMotor6d_3.MaxVelocity = 0.1
				rightArmMotor6d_3.C0 = CFrame.new(Vector3.new(1.296, 2.9583, -0.114))
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-50.8271, 0.9541, 37.2448)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightLeg_2.CFrame = CFrame.new(Vector3.new(-50.8271, 0.9541, 37.2448)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			rightLeg_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://87642510854176", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			rightLeg_3.TextureID = "rbxassetid://86352383057320"
			...
			rightLeg_3.Size = Vector3.new(0.641, 2.012, 0.7067)
			rightLeg_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			rightLeg_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			rightLeg_3.CFrame = CFrame.new(Vector3.new(-50.8271, 0.9541, 37.2448)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			rightLeg_3.PivotOffset = CFrame.new(Vector3.new(-0.3385, -1.0061, 0.0621)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
			do
				rightLegMotor6d_3 = Instance.new("Motor6D")
				rightLegMotor6d_3.Name = "RightLegMotor6D"
				rightLegMotor6d_3.MaxVelocity = 0.1
				rightLegMotor6d_3.C0 = CFrame.new(Vector3.new(0.3384, 1.006, -0.0622))
	...
	rightLeg.Parent = loneWolf
end

loneWolf.PrimaryPart = humanoidRootPart
