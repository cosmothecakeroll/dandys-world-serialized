local cape, capeGeoMotor6d, head, headMotor6d, leftArm, leftArmMotor6d, leftLeg, leftLegMotor6d, rightArm, rightArmMotor6d, rightLeg, rightLegMotor6d, tail, tailGeoMotor6d, torso, torsoMotor6d, rootPart, weldConstraint, humanoidRootPart

local vintageEclipse = Instance.new("Model")
vintageEclipse.Name = "VintageEclipse"
vintageEclipse.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	animations.Parent = vintageEclipse
	...
	humanoid.Parent = vintageEclipse
	cape = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://100805349600773", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	cape.TextureID = "rbxassetid://123902502438768"
	cape.Name = "Cape"
	cape.CanCollide = false
	cape.CanTouch = false
	cape.Massless = true
	cape.CanQuery = false
	cape.Size = Vector3.new(2.2871, 0.9583, 1.2015)
	cape.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	cape.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
	cape.CFrame = CFrame.new(Vector3.new(-54.4501, 2.7261, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	cape.PivotOffset = CFrame.new(Vector3.new(0, -2.778, -0.0608)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
	do
		...
		capeGeoMotor6d.Parent = cape
	end
	cape.Parent = vintageEclipse
	...
	head.TextureID = "rbxassetid://123902502438768"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-54.3372, 4.9234, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.TextureID = "rbxassetid://123902502438768"
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-54.2753, 2.9063, 35.6104)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.TextureID = "rbxassetid://123902502438768"
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-54.3272, 0.9541, 36.568)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.TextureID = "rbxassetid://123902502438768"
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-54.2753, 2.9063, 38.2024)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.Parent = vintageEclipse
	...
	rightLeg.TextureID = "rbxassetid://123902502438768"
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-54.3272, 0.9541, 37.2448)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.Parent = vintageEclipse
	tail = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://93194142965836", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	tail.TextureID = "rbxassetid://123902502438768"
	tail.Name = "Tail"
	tail.CanCollide = false
	tail.CanTouch = false
	tail.Massless = true
	tail.CanQuery = false
	tail.Size = Vector3.new(0.7971, 1.1193, 2.1702)
	tail.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	tail.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
	tail.CFrame = CFrame.new(Vector3.new(-55.7061, 1.637, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	tail.PivotOffset = CFrame.new(Vector3.new(0, -1.6889, -1.3168)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
	do
		...
		tailGeoMotor6d.Parent = tail
	end
	tail.Parent = vintageEclipse
	...
	torso.TextureID = "rbxassetid://123902502438768"
	torso.Name = "Torso"
	...
	torso.CFrame = CFrame.new(Vector3.new(-54.3713, 2.3625, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-54.3893, -0.0519, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = vintageEclipse
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-54.3893, 1.9481, 36.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = vintageEclipse
end

vintageEclipse.PrimaryPart = humanoidRootPart
capeGeoMotor6d.Part0 = rootPart
capeGeoMotor6d.Part1 = cape
