local rightUpperLeg, rightUpperLegMotor6d, leftLowerLeg, leftLowerLegMotor6d, rightLowerLeg, rightLowerLegMotor6d, head, nameTagOverride, headMotor6d, torso, torsoMotor6d, leftFoot, leftFootMotor6d, rightFoot, rightFootMotor6d, leftLowerArm, leftLowerArmMotor6d, leftUpperArm, leftUpperArmMotor6d, leftUpperTail, leftUpperTailMotor6d, leftLowerTail, leftLowerTailMotor6d, rightLowerTail, rightLowerTailMotor6d, rightLowerArm, rightLowerArmMotor6d, rightUpperArm, rightUpperArmMotor6d, rightUpperTail, rightUpperTailMotor6d, leftHand, leftHandMotor6d, rightHand, rightHandMotor6d, humanoidRootPart, rootPart, weld, nameTagOverridePosition, leftUpperLeg, leftUpperLegMotor6d

local colorfulAprilOld = Instance.new("Model")
colorfulAprilOld.Name = "ColorfulAprilOLD"
do
	rightUpperLeg = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://111546765298939", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	rightUpperLeg.TextureID = "rbxassetid://139484602386880"
	...
	rightUpperLeg.CFrame = CFrame.new(Vector3.new(-45.9065, 9.4591, -107.8338)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightUpperLeg.Parent = colorfulAprilOld
	leftLowerLeg = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://130902552114008", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	leftLowerLeg.TextureID = "rbxassetid://139484602386880"
	...
	leftLowerLeg.CFrame = CFrame.new(Vector3.new(-45.9615, 8.5569, -108.3536)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerLeg.Parent = colorfulAprilOld
	rightLowerLeg = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://83048691842981", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	rightLowerLeg.TextureID = "rbxassetid://139484602386880"
	...
	rightLowerLeg.CFrame = CFrame.new(Vector3.new(-45.9615, 8.5569, -107.8336)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerLeg.Parent = colorfulAprilOld
	head = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://82986876375607", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	head.TextureID = "rbxassetid://139484602386880"
	head.Name = "Head"
	head.Massless = true
	...
	head.AssemblyLinearVelocity = Vector3.yAxis * -4.9051
	head.CFrame = CFrame.new(Vector3.new(-46.2323, 12.6419, -108.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	head.Parent = colorfulAprilOld
	torso = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://107495530106616", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	torso.TextureID = "rbxassetid://139484602386880"
	torso.Name = "Torso"
	torso.CanTouch = false
	torso.CanQuery = false
	torso.Massless = true
	torso.AssemblyLinearVelocity = Vector3.yAxis * -4.9051
	torso.Size = Vector3.new(1.6585, 1.5202, 1.0828)
	torso.CFrame = CFrame.new(Vector3.new(-45.8522, 10.4277, -108.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	torso.Parent = colorfulAprilOld
	leftFoot = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://114436740467376", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	leftFoot.TextureID = "rbxassetid://139484602386880"
	...
	leftFoot.CFrame = CFrame.new(Vector3.new(-45.785, 8.1316, -108.3534)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftFoot.Parent = colorfulAprilOld
	rightFoot = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://102566457066973", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	rightFoot.TextureID = "rbxassetid://139484602386880"
	...
	rightFoot.CFrame = CFrame.new(Vector3.new(-45.785, 8.1316, -107.8338)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rightFoot.Parent = colorfulAprilOld
	leftLowerArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://102943415269693", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	leftLowerArm.TextureID = "rbxassetid://139484602386880"
	...
	leftLowerArm.CFrame = CFrame.new(Vector3.new(-45.8936, 10.9091, -109.3723)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerArm.Parent = colorfulAprilOld
	leftUpperArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://124508240974263", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	leftUpperArm.TextureID = "rbxassetid://139484602386880"
	...
	leftUpperArm.CFrame = CFrame.new(Vector3.new(-45.8936, 10.9091, -108.747)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftUpperArm.Parent = colorfulAprilOld
	leftUpperTail = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://124988458803002", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	leftUpperTail.TextureID = "rbxassetid://139484602386880"
	...
	leftUpperTail.CFrame = CFrame.new(Vector3.new(-48.2031, 10.2277, -108.2323)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	leftUpperTail.Parent = colorfulAprilOld
	leftLowerTail = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://89900152065667", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	leftLowerTail.TextureID = "rbxassetid://139484602386880"
	...
	leftLowerTail.CFrame = CFrame.new(Vector3.new(-47.804, 10.0223, -108.3066)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerTail.Parent = colorfulAprilOld
	rightLowerTail = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://117930962843451", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	rightLowerTail.TextureID = "rbxassetid://139484602386880"
	...
	rightLowerTail.CFrame = CFrame.new(Vector3.new(-47.804, 10.0223, -107.8806)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerTail.Parent = colorfulAprilOld
	rightLowerArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://92706618555446", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	rightLowerArm.TextureID = "rbxassetid://139484602386880"
	...
	rightLowerArm.CFrame = CFrame.new(Vector3.new(-45.8936, 10.9091, -106.8149)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerArm.Parent = colorfulAprilOld
	rightUpperArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://107241103993343", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	rightUpperArm.TextureID = "rbxassetid://139484602386880"
	...
	rightUpperArm.CFrame = CFrame.new(Vector3.new(-45.8936, 10.9091, -107.4403)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightUpperArm.Parent = colorfulAprilOld
	rightUpperTail = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://140694337150668", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	rightUpperTail.TextureID = "rbxassetid://139484602386880"
	...
	rightUpperTail.CFrame = CFrame.new(Vector3.new(-48.2031, 10.2277, -107.9549)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rightUpperTail.Parent = colorfulAprilOld
	leftHand = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://108328557205360", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	leftHand.TextureID = "rbxassetid://139484602386880"
	...
	leftHand.CFrame = CFrame.new(Vector3.new(-45.8936, 10.9761, -110.0134)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftHand.Parent = colorfulAprilOld
	rightHand = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://82234686128966", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	rightHand.TextureID = "rbxassetid://139484602386880"
	...
	rightHand.CFrame = CFrame.new(Vector3.new(-45.8936, 10.9761, -106.1738)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightHand.Parent = colorfulAprilOld
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-45.8894, 7.9481, -108.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		local imageLabel = Instance.new("ImageLabel")
		imageLabel.Image = "rbxassetid://18850392282"
		imageLabel.ZIndex = 0
		imageLabel.BackgroundTransparency = 1
		imageLabel.ImageTransparency = 0.3454
		imageLabel.AnchorPoint = Vector2.one * 0.5
		imageLabel.Size = UDim2.fromOffset(8, 8)
		imageLabel.Position = UDim2.new(0.2554, 143, 0.0942, -272)
		...
		imageLabel_2.ImageTransparency = 0.3628
		imageLabel_2.AnchorPoint = Vector2.one * 0.5
		imageLabel_2.Size = UDim2.fromOffset(26, 26)
		imageLabel_2.Position = UDim2.new(0.1229, -928, 0.0225, -327)
	...
	humanoidRootPart.Parent = colorfulAprilOld
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-45.8894, 7.9481, -108.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = colorfulAprilOld
	...
	animations.Parent = colorfulAprilOld
	...
	do
		...
		normalTexture.Texture = "rbxassetid://123268694166967"
		normalTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://100758849186044"
		hurtTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://102920239261271"
		blinkTexture.Parent = config
	end
	config.Parent = colorfulAprilOld
	local humanoid = Instance.new("Humanoid")
	humanoid.HipHeight = 1.25
	do
		local animation = Instance.new("Animation")
		animation.AnimationId = "rbxassetid://90995410917513"
		animation.Parent = humanoid
		local animation_2 = Instance.new("Animation")
		animation_2.AnimationId = "rbxassetid://123004445709017"
		animation_2.Parent = humanoid
		local animation_3 = Instance.new("Animation")
		animation_3.AnimationId = "rbxassetid://95318848230976"
		animation_3.Parent = humanoid
		local animation_4 = Instance.new("Animation")
		animation_4.AnimationId = "rbxassetid://70825239219915"
		animation_4.Parent = humanoid
		local animator = Instance.new("Animator")
		animator.Parent = humanoid
	end
	humanoid.Parent = colorfulAprilOld
	leftUpperLeg = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://111241900624569", Enum.CollisionFidelity.Default, Enum.RenderFidelity.Automatic)
	leftUpperLeg.TextureID = "rbxassetid://139484602386880"
	...
	leftUpperLeg.CFrame = CFrame.new(Vector3.new(-45.9065, 9.4591, -108.3534)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftUpperLeg.Parent = colorfulAprilOld
end

colorfulAprilOld.PrimaryPart = humanoidRootPart
