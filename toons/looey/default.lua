local humanoidRootPart, head, nameTagOverride, headMotor6d, rootPart, nameTagOverridePosition, weld, leftFoot, leftFootMotor6d, leftHand, leftHandMotor6d, leftLowerArm, leftLowerArmMotor6d, leftLowerLeg, leftLowerLegMotor6d, leftUpperArm, leftUpperArmMotor6d, leftUpperLeg, leftUpperLegMotor6d, lowerTorso, lowerTorsoMotor6d, rightFoot, rightFootMotor6d, rightHand, rightHandMotor6d, rightLowerArm, rightLowerArmMotor6d, rightLowerLeg, rightLowerLegMotor6d, rightUpperLeg, rightUpperLegMotor6d, rightUpperrArm, rightUpperrArmMotor6d, tail_2, tailMotor6d, upperTorso, upperTorsoMotor6d

local looey = Instance.new("Model")
looey.Name = "Looey"
looey.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	do
		...
		normalTexture.Texture = "rbxassetid://137340232239830"
		normalTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://87231051716532"
		...
		blinkTexture.Texture = "rbxassetid://92525958143024"
	...
	do
		...
		swimidle1.Parent = animations
		local walk1 = Instance.new("Animation")
		walk1.Name = "walk 1"
		walk1.AnimationId = "rbxassetid://122462750231968"
		walk1.Parent = animations
	end
	animations.Parent = looey
	local toonName = Instance.new("StringValue")
	toonName.Name = "ToonName"
	toonName.Value = "Looey"
	toonName.Parent = looey
	humanoidRootPart = Instance.new("Part")
	humanoidRootPart.Name = "HumanoidRootPart"
	humanoidRootPart.Transparency = 1
	humanoidRootPart.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	humanoidRootPart.Size = Vector3.new(2, 2, 1)
	humanoidRootPart.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 2.4481, -20.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = looey
	head = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://98043891149776", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	head.TextureID = "rbxassetid://78100045378383"
	head.Name = "Head"
	head.CanCollide = false
	head.EnableFluidForces = false
	head.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	head.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	head.Size = Vector3.new(3.2974, 4.0369, 2.5387)
	head.Color = Color3.fromRGB(201, 191, 140)
	head.CFrame = CFrame.new(Vector3.new(-40.4029, 7.478, -20.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	rootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 2.4481, -20.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		do
			...
			do
				...
				do
					...
					head_2.Name = "head"
					head_2.CFrame = CFrame.new(Vector3.new(-0.5464, -0.0155, 0))
					do
	...
	leftFoot.TextureID = "rbxassetid://78100045378383"
	leftFoot.Name = "LeftFoot"
	leftFoot.CanCollide = false
	leftFoot.EnableFluidForces = false
	leftFoot.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	leftFoot.Size = Vector3.new(0.4376, 0.3882, 0.6482)
	leftFoot.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	leftFoot.CFrame = CFrame.new(Vector3.new(-40.2318, 2.6215, -20.8394)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftHand.TextureID = "rbxassetid://78100045378383"
	leftHand.Name = "LeftHand"
	leftHand.CanCollide = false
	leftHand.EnableFluidForces = false
	leftHand.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	leftHand.Size = Vector3.new(0.8191, 0.6944, 0.2958)
	leftHand.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	leftHand.CFrame = CFrame.new(Vector3.new(-40.394, 5.3352, -22.5524)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerArm.TextureID = "rbxassetid://78100045378383"
	leftLowerArm.Name = "LeftLowerArm"
	leftLowerArm.CanCollide = false
	leftLowerArm.EnableFluidForces = false
	leftLowerArm.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	leftLowerArm.Size = Vector3.new(0.7933, 0.3385, 0.3613)
	leftLowerArm.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	leftLowerArm.CFrame = CFrame.new(Vector3.new(-40.394, 5.262, -21.9653)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerLeg.TextureID = "rbxassetid://78100045378383"
	leftLowerLeg.Name = "LeftLowerLeg"
	leftLowerLeg.CanCollide = false
	leftLowerLeg.EnableFluidForces = false
	leftLowerLeg.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	leftLowerLeg.Size = Vector3.new(0.4376, 0.8912, 0.3839)
	leftLowerLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	leftLowerLeg.CFrame = CFrame.new(Vector3.new(-40.3647, 2.9945, -20.8394)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftUpperArm.TextureID = "rbxassetid://78100045378383"
	leftUpperArm.Name = "LeftUpperArm"
	leftUpperArm.EnableFluidForces = false
	leftUpperArm.CanCollide = false
	leftUpperArm.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	leftUpperArm.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	leftUpperArm.Size = Vector3.new(0.8599, 0.3331, 0.3952)
	leftUpperArm.CFrame = CFrame.new(Vector3.new(-40.394, 5.262, -21.3372)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	leftUpperLeg.TextureID = "rbxassetid://78100045378383"
	leftUpperLeg.Name = "LeftUpperLeg"
	leftUpperLeg.CanCollide = false
	leftUpperLeg.EnableFluidForces = false
	leftUpperLeg.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	leftUpperLeg.Size = Vector3.new(0.3597, 1.1768, 0.3517)
	leftUpperLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	leftUpperLeg.CFrame = CFrame.new(Vector3.new(-40.3962, 3.7998, -20.8394)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	lowerTorso.TextureID = "rbxassetid://78100045378383"
	lowerTorso.Name = "LowerTorso"
	lowerTorso.EnableFluidForces = false
	lowerTorso.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	lowerTorso.Size = Vector3.new(1.0246, 1.4693, 0.8279)
	lowerTorso.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	lowerTorso.CFrame = CFrame.new(Vector3.new(-40.394, 4.7516, -20.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightFoot.TextureID = "rbxassetid://78100045378383"
	rightFoot.Name = "RightFoot"
	rightFoot.CanCollide = false
	rightFoot.EnableFluidForces = false
	rightFoot.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	rightFoot.Size = Vector3.new(0.4376, 0.3882, 0.6482)
	rightFoot.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	rightFoot.CFrame = CFrame.new(Vector3.new(-40.2318, 2.6215, -20.3478)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightHand.TextureID = "rbxassetid://78100045378383"
	rightHand.Name = "RightHand"
	rightHand.CanCollide = false
	rightHand.EnableFluidForces = false
	rightHand.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	rightHand.Size = Vector3.new(0.8191, 0.6944, 0.2958)
	rightHand.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	rightHand.CFrame = CFrame.new(Vector3.new(-40.394, 5.3352, -18.6349)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerArm.TextureID = "rbxassetid://78100045378383"
	rightLowerArm.Name = "RightLowerArm"
	rightLowerArm.CanCollide = false
	rightLowerArm.EnableFluidForces = false
	rightLowerArm.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	rightLowerArm.Size = Vector3.new(0.7933, 0.3385, 0.3613)
	rightLowerArm.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	rightLowerArm.CFrame = CFrame.new(Vector3.new(-40.394, 5.262, -19.2219)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerLeg.TextureID = "rbxassetid://78100045378383"
	rightLowerLeg.Name = "RightLowerLeg"
	rightLowerLeg.CanCollide = false
	rightLowerLeg.EnableFluidForces = false
	rightLowerLeg.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	rightLowerLeg.Size = Vector3.new(0.4376, 0.8912, 0.3839)
	rightLowerLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	rightLowerLeg.CFrame = CFrame.new(Vector3.new(-40.3647, 2.9945, -20.3478)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightUpperLeg.TextureID = "rbxassetid://78100045378383"
	rightUpperLeg.Name = "RightUpperLeg"
	rightUpperLeg.CanCollide = false
	rightUpperLeg.EnableFluidForces = false
	rightUpperLeg.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	rightUpperLeg.Size = Vector3.new(0.3597, 1.1768, 0.3517)
	rightUpperLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	rightUpperLeg.CFrame = CFrame.new(Vector3.new(-40.3962, 3.7998, -20.3478)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightUpperrArm.TextureID = "rbxassetid://78100045378383"
	rightUpperrArm.Name = "RightUpperrArm"
	rightUpperrArm.EnableFluidForces = false
	rightUpperrArm.CanCollide = false
	rightUpperrArm.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	rightUpperrArm.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	rightUpperrArm.Size = Vector3.new(0.8599, 0.3331, 0.3952)
	rightUpperrArm.CFrame = CFrame.new(Vector3.new(-40.394, 5.262, -19.85)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	tail_2.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	tail_2.Size = Vector3.new(0.8761, 0.8761, 2.5541)
	tail_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	tail_2.CFrame = CFrame.new(Vector3.new(-42.0054, 4.3489, -20.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	upperTorso.TextureID = "rbxassetid://78100045378383"
	upperTorso.Name = "UpperTorso"
	upperTorso.EnableFluidForces = false
	upperTorso.AssemblyLinearVelocity = Vector3.new(0.0011, 0, 0)
	upperTorso.Size = Vector3.new(1.2827, 0.9273, 1.1555)
	upperTorso.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	upperTorso.CFrame = CFrame.new(Vector3.new(-40.4029, 5.2003, -20.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	upperTorso.Parent = looey
end

looey.PrimaryPart = humanoidRootPart
