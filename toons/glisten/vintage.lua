local head, headMotor6d, leftArm, leftArmMotor6d, leftLeg, leftLegMotor6d, rightArm, rightArmMotor6d, rightLeg, rightLegMotor6d, torso, torsoMotor6d, humanoidRootPart, weldConstraint

local vintageGlisten = Instance.new("Model")
vintageGlisten.Name = "VintageGlisten"
vintageGlisten.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	animations.Parent = vintageGlisten
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://81752249962155"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://118836627627884"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://100301932235171"
	...
	humanoid.Parent = vintageGlisten
	local toonName = Instance.new("StringValue")
	toonName.Name = "ToonName"
	toonName.Value = "Glisten"
	toonName.Parent = vintageGlisten
	...
	head.TextureID = "rbxassetid://81752249962155"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-46.7268, 6.3853, -2.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		bubbleChat.CFrame = CFrame.new(Vector3.yAxis * -0.6111)
		bubbleChat.Parent = head
		local stickerOverride = Instance.new("Attachment")
		stickerOverride.Name = "StickerOverride"
		stickerOverride.CFrame = CFrame.new(Vector3.yAxis * 2.865)
		stickerOverride.Parent = head
	end
	head.Parent = vintageGlisten
	...
	leftArm.TextureID = "rbxassetid://81752249962155"
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-46.8757, 4.6598, -3.7328)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.TextureID = "rbxassetid://81752249962155"
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-46.7792, 2.8654, -2.8277)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.TextureID = "rbxassetid://81752249962155"
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-46.8757, 4.6598, -1.4544)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.Parent = vintageGlisten
	...
	rightLeg.TextureID = "rbxassetid://81752249962155"
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-46.7792, 2.8654, -2.3595)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.Parent = vintageGlisten
	...
	torso.TextureID = "rbxassetid://81752249962155"
	torso.Name = "Torso"
	torso.Massless = true
	...
	torso.CFrame = CFrame.new(Vector3.new(-47.1872, 4.2833, -2.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-46.8893, 1.9481, -2.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = vintageGlisten
end

vintageGlisten.PrimaryPart = humanoidRootPart
