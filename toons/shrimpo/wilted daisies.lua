...
local wiltedDaisies = Instance.new("Model")
wiltedDaisies.Name = "WiltedDaisies"
wiltedDaisies.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	do
		...
		decode.Name = "Decode"
		decode.AnimationId = "rbxassetid://82115028837237"
		decode.Parent = animations
		local idle = Instance.new("Animation")
		idle.Name = "Idle"
		idle.AnimationId = "rbxassetid://104855983361844"
		idle.Parent = animations
		local quirk = Instance.new("Animation")
		quirk.Name = "Quirk"
		quirk.AnimationId = "rbxassetid://118596195257950"
		quirk.Parent = animations
		local run = Instance.new("Animation")
		run.Name = "Run"
		run.AnimationId = "rbxassetid://118408617438325"
		run.Parent = animations
		local walk = Instance.new("Animation")
		walk.Name = "Walk"
		walk.AnimationId = "rbxassetid://83797003369894"
		walk.Parent = animations
	end
	animations.Parent = wiltedDaisies
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://76434637519785"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://76896409373948"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://138242547005242"
		hurtTexture.Parent = config
		local characterName = Instance.new("StringValue")
		characterName.Name = "CharacterName"
		characterName.Value = "Shrimpo_WiltedDaisies_Rig"
		characterName.Parent = config
		local moduleName = Instance.new("StringValue")
		moduleName.Name = "ModuleName"
		moduleName.Value = "Shrimpo_WiltedDaisies_Rig"
		moduleName.Parent = config
	end
	config.Parent = wiltedDaisies
	...
	humanoid.Parent = wiltedDaisies
	head = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://89102708929910", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	head.TextureID = "rbxassetid://76434637519785"
	head.Name = "Head"
	head.CanCollide = false
	head.CanTouch = false
	head.Massless = true
	head.CanQuery = false
	head.Size = Vector3.new(2.989, 3.893, 3.7578)
	head.AssemblyAngularVelocity = Vector3.new(-0.0014, 0, 0.0064)
	head.AssemblyLinearVelocity = Vector3.new(-0.0051, 0.036, 0.0014)
	head.CFrame = CFrame.new(Vector3.new(-70.0874, 4.6429, -65.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	head.PivotOffset = CFrame.new(Vector3.new(0, -4.06, -0.6981)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
	do
		headMotor6d = Instance.new("Motor6D")
		headMotor6d.Name = "HeadMotor6D"
		headMotor6d.MaxVelocity = 0.1
		headMotor6d.C0 = CFrame.new(Vector3.new(0, 4.0599, 0.698))
		headMotor6d.Parent = head
	end
	head.Parent = wiltedDaisies
	leftArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://140477649039037", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	leftArm.TextureID = "rbxassetid://76434637519785"
	leftArm.Name = "LeftArm"
	leftArm.CanCollide = false
	leftArm.CanTouch = false
	leftArm.Massless = true
	leftArm.CanQuery = false
	leftArm.Size = Vector3.new(1.7769, 0.5355, 0.4662)
	leftArm.AssemblyAngularVelocity = Vector3.new(-0.0014, 0, 0.0064)
	leftArm.AssemblyLinearVelocity = Vector3.new(-0.0051, 0.036, 0.0014)
	leftArm.CFrame = CFrame.new(Vector3.new(-69.4295, 2.9269, -66.7717)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	leftArm.PivotOffset = CFrame.new(Vector3.new(1.1781, -2.3441, -0.0402)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
	do
		leftArmMotor6d = Instance.new("Motor6D")
		leftArmMotor6d.Name = "LeftArmMotor6D"
		leftArmMotor6d.MaxVelocity = 0.1
		leftArmMotor6d.C0 = CFrame.new(Vector3.new(-1.1782, 2.344, 0.0401))
		leftArmMotor6d.Parent = leftArm
	end
	leftArm.Parent = wiltedDaisies
	leftLeg = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://131800087080289", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	leftLeg.TextureID = "rbxassetid://76434637519785"
	leftLeg.Name = "LeftLeg"
	leftLeg.CanCollide = false
	leftLeg.CanTouch = false
	leftLeg.Massless = true
	leftLeg.CanQuery = false
	leftLeg.Size = Vector3.new(0.4838, 1.5562, 0.6796)
	leftLeg.AssemblyAngularVelocity = Vector3.new(-0.0014, 0, 0.0064)
	leftLeg.AssemblyLinearVelocity = Vector3.new(-0.0051, 0.036, 0.0014)
	leftLeg.CFrame = CFrame.new(Vector3.new(-69.2885, 1.3529, -65.8113)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	leftLeg.PivotOffset = CFrame.new(Vector3.new(0.2177, -0.77, 0.1007)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
	do
		leftLegMotor6d = Instance.new("Motor6D")
		leftLegMotor6d.Name = "LeftLegMotor6D"
		leftLegMotor6d.MaxVelocity = 0.1
		leftLegMotor6d.C0 = CFrame.new(Vector3.new(-0.2178, 0.7699, -0.1008))
		leftLegMotor6d.Parent = leftLeg
	end
	leftLeg.Parent = wiltedDaisies
	rightArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://74093922947917", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	rightArm.TextureID = "rbxassetid://76434637519785"
	rightArm.Name = "RightArm"
	rightArm.CanCollide = false
	rightArm.CanTouch = false
	rightArm.Massless = true
	rightArm.CanQuery = false
	rightArm.Size = Vector3.new(1.7769, 0.5355, 0.4662)
	rightArm.AssemblyAngularVelocity = Vector3.new(-0.0014, 0, 0.0064)
	rightArm.AssemblyLinearVelocity = Vector3.new(-0.0051, 0.036, 0.0014)
	rightArm.CFrame = CFrame.new(Vector3.new(-69.4295, 2.9269, -64.4155)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	rightArm.PivotOffset = CFrame.new(Vector3.new(-1.1782, -2.3441, -0.0402)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
	do
		rightArmMotor6d = Instance.new("Motor6D")
		rightArmMotor6d.Name = "RightArmMotor6D"
		rightArmMotor6d.MaxVelocity = 0.1
		rightArmMotor6d.C0 = CFrame.new(Vector3.new(1.1781, 2.344, 0.0401))
		rightArmMotor6d.Parent = rightArm
	end
	rightArm.Parent = wiltedDaisies
	rightLeg = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://117044640111053", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	rightLeg.TextureID = "rbxassetid://76434637519785"
	rightLeg.Name = "RightLeg"
	rightLeg.CanCollide = false
	rightLeg.CanTouch = false
	rightLeg.Massless = true
	rightLeg.CanQuery = false
	rightLeg.Size = Vector3.new(0.4838, 1.5562, 0.6796)
	rightLeg.AssemblyAngularVelocity = Vector3.new(-0.0014, 0, 0.0064)
	rightLeg.AssemblyLinearVelocity = Vector3.new(-0.0051, 0.036, 0.0014)
	rightLeg.CFrame = CFrame.new(Vector3.new(-69.2885, 1.3529, -65.3759)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	rightLeg.PivotOffset = CFrame.new(Vector3.new(-0.2178, -0.77, 0.1007)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
	do
		rightLegMotor6d = Instance.new("Motor6D")
		rightLegMotor6d.Name = "RightLegMotor6D"
		rightLegMotor6d.MaxVelocity = 0.1
		rightLegMotor6d.C0 = CFrame.new(Vector3.new(0.2177, 0.7699, -0.1008))
		rightLegMotor6d.Parent = rightLeg
	end
	rightLeg.Parent = wiltedDaisies
	torso = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://90521843597360", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	torso.TextureID = "rbxassetid://76434637519785"
	torso.Name = "Torso"
	torso.Massless = true
	torso.CanTouch = false
	torso.CanQuery = false
	torso.Size = Vector3.new(1.1192, 1.3253, 0.9222)
	torso.AssemblyAngularVelocity = Vector3.new(-0.0014, 0, 0.0064)
	torso.AssemblyLinearVelocity = Vector3.new(-0.0051, 0.036, 0.0014)
	torso.CFrame = CFrame.new(Vector3.new(-69.3758, 2.5276, -65.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	torso.PivotOffset = CFrame.new(Vector3.new(0, -1.9447, 0.0134)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
	do
		torsoMotor6d = Instance.new("Motor6D")
		torsoMotor6d.Name = "TorsoMotor6D"
		torsoMotor6d.MaxVelocity = 0.1
		torsoMotor6d.C0 = CFrame.new(Vector3.new(0, 1.9446, -0.0135))
		torsoMotor6d.Parent = torso
	end
	torso.Parent = wiltedDaisies
	...
	rootPart.AssemblyAngularVelocity = Vector3.new(-0.0014, 0, 0.0064)
	rootPart.Size = Vector3.new(2, 2, 1)
	rootPart.AssemblyLinearVelocity = Vector3.new(-0.0051, 0.036, 0.0014)
	rootPart.CFrame = CFrame.new(Vector3.new(-69.3893, 0.5829, -65.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		local rootX = Instance.new("Bone")
		rootX.Name = "root.x"
		rootX.SecondaryAxis = -Vector3.yAxis
		rootX.CFrame = CFrame.new(Vector3.yAxis * 1.0499) * CFrame.fromEulerAnglesXYZ(math.rad(-180), 0, 0)
		do
	...
	rootPart.Parent = wiltedDaisies
	humanoidRootPart = Instance.new("Part")
	humanoidRootPart.Name = "HumanoidRootPart"
	humanoidRootPart.Transparency = 1
	humanoidRootPart.AssemblyLinearVelocity = Vector3.new(-0.0051, 0.036, 0.0014)
	humanoidRootPart.Size = Vector3.new(2, 2, 1)
	humanoidRootPart.AssemblyAngularVelocity = Vector3.new(-0.0014, 0, 0.0064)
	humanoidRootPart.CustomPhysicalProperties = PhysicalProperties.new(15, 1, 0.3, 1, 1, 1)
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-69.3893, 2.19, -65.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = wiltedDaisies
end

wiltedDaisies.PrimaryPart = humanoidRootPart
