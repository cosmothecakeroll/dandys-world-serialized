...
do
	...
	rightLowerArm.TextureID = "rbxassetid://99267622651297"
	...
	rightLowerArm.CFrame = CFrame.new(Vector3.new(-46.9255, 5.5806, -32.5587)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		rightLowerArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://115922835966242", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightLowerArm_2.TextureID = "rbxassetid://99267622651297"
		...
		rightLowerArm_2.Size = Vector3.new(0.9196, 0.6325, 0.6411)
		...
		rightLowerArm_2.CFrame = CFrame.new(Vector3.new(-46.9255, 5.5806, -32.5587)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		do
			...
			rightLowerArmMotor6d_2.C0 = CFrame.new(Vector3.new(1.5203, 3.1321, 0.0362))
	...
	rightLowerArm.Parent = radiantDreamOld
	...
	humanoid.Parent = radiantDreamOld
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://83754525807359"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://95681621783865"
		hurtTexture.Parent = config
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://99267622651297"
	...
	animations.Parent = radiantDreamOld
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-46.8893, 2.4481, -34.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = radiantDreamOld
	...
	leftFoot.TextureID = "rbxassetid://99267622651297"
	...
	leftFoot.CFrame = CFrame.new(Vector3.new(-46.7429, 2.6384, -34.3688)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftFoot_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://102590967561118", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftFoot_2.TextureID = "rbxassetid://99267622651297"
		...
		leftFoot_2.CFrame = CFrame.new(Vector3.new(-46.7429, 2.6384, -34.3688)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftFoot.Parent = radiantDreamOld
	...
	rightFoot.TextureID = "rbxassetid://99267622651297"
	...
	rightFoot.CFrame = CFrame.new(Vector3.new(-46.7429, 2.6384, -33.8184)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightFoot_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://76607180417544", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightFoot_2.TextureID = "rbxassetid://99267622651297"
		...
		rightFoot_2.CFrame = CFrame.new(Vector3.new(-46.7429, 2.6384, -33.8184)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightFoot.Parent = radiantDreamOld
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-46.8893, 2.4481, -34.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = radiantDreamOld
	...
	leftHead_2.TextureID = "rbxassetid://99267622651297"
	...
	leftHead_2.CFrame = CFrame.new(Vector3.new(-46.3857, 7.3694, -35.3653)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		leftHead_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://125243929245975", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftHead_3.TextureID = "rbxassetid://99267622651297"
		...
		leftHead_3.CFrame = CFrame.new(Vector3.new(-46.3857, 7.3694, -35.3653)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		do
	...
	leftHead_2.Parent = radiantDreamOld
	...
	leftNeck.TextureID = "rbxassetid://99267622651297"
	...
	leftNeck.CFrame = CFrame.new(Vector3.new(-46.785, 6.3585, -34.7938)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftNeck_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://70823255749412", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftNeck_2.TextureID = "rbxassetid://99267622651297"
		...
		leftNeck_2.CFrame = CFrame.new(Vector3.new(-46.785, 6.3585, -34.7938)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftNeck.Parent = radiantDreamOld
	...
	rightNeck.TextureID = "rbxassetid://99267622651297"
	...
	rightNeck.CFrame = CFrame.new(Vector3.new(-46.785, 6.3585, -33.3934)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightNeck_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://83363720903637", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightNeck_2.TextureID = "rbxassetid://99267622651297"
		...
		rightNeck_2.CFrame = CFrame.new(Vector3.new(-46.785, 6.3585, -33.3934)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightNeck.Parent = radiantDreamOld
	...
	rightHead_2.TextureID = "rbxassetid://99267622651297"
	...
	rightHead_2.CFrame = CFrame.new(Vector3.new(-46.3857, 7.3694, -32.8214)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		rightHead_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://129482152155442", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightHead_3.TextureID = "rbxassetid://99267622651297"
		...
		rightHead_3.CFrame = CFrame.new(Vector3.new(-46.3857, 7.3694, -32.8214)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		do
	...
	rightHead_2.Parent = radiantDreamOld
	...
	torso_2.TextureID = "rbxassetid://99267622651297"
	torso_2.Name = "Torso"
	...
	torso_2.CFrame = CFrame.new(Vector3.new(-46.8539, 5.0829, -34.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		torso_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://82380187819175", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		torso_3.TextureID = "rbxassetid://99267622651297"
		torso_3.Name = "Torso"
		torso_3.CanCollide = false
		torso_3.CanTouch = false
		torso_3.Massless = true
		torso_3.CanQuery = false
		torso_3.Size = Vector3.new(1.4779, 1.7727, 1.2992)
		...
		torso_3.CFrame = CFrame.new(Vector3.new(-46.8539, 5.0829, -34.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		torso_3.PivotOffset = CFrame.new(Vector3.new(0, -0.008, 0))
		do
			torsoMotor6d_2 = Instance.new("Motor6D")
			torsoMotor6d_2.Name = "TorsoMotor6D"
			torsoMotor6d_2.MaxVelocity = 0.1
			torsoMotor6d_2.C0 = CFrame.new(Vector3.new(0, 2.6347, -0.0354))
	...
	torso_2.Parent = radiantDreamOld
	...
	leftUpperLeg.TextureID = "rbxassetid://99267622651297"
	...
	leftUpperLeg.CFrame = CFrame.new(Vector3.new(-46.9213, 3.999, -34.3688)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		leftUpperLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://135743907726690", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftUpperLeg_2.TextureID = "rbxassetid://99267622651297"
		...
		leftUpperLeg_2.CFrame = CFrame.new(Vector3.new(-46.9213, 3.999, -34.3688)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		do
	...
	leftUpperLeg.Parent = radiantDreamOld
	...
	leftUpperArm.TextureID = "rbxassetid://99267622651297"
	...
	leftUpperArm.CFrame = CFrame.new(Vector3.new(-46.9255, 5.5803, -34.9279)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftUpperArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://131011544601697", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftUpperArm_2.TextureID = "rbxassetid://99267622651297"
		...
		leftUpperArm_2.Size = Vector3.new(0.964, 0.6023, 0.6583)
		...
		leftUpperArm_2.CFrame = CFrame.new(Vector3.new(-46.9255, 5.5803, -34.9279)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		leftUpperArm_2.PivotOffset = CFrame.new(Vector3.new(0.3737, 0, 0))
		do
			...
			leftUpperArmMotor6d_2.C0 = CFrame.new(Vector3.new(-0.8332, 3.132, 0.0362))
	...
	leftUpperArm.Parent = radiantDreamOld
	...
	leftHand.TextureID = "rbxassetid://99267622651297"
	...
	leftHand.CFrame = CFrame.new(Vector3.new(-46.9255, 5.6622, -36.2873)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftHand_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://106928769443739", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftHand_2.TextureID = "rbxassetid://99267622651297"
		...
		leftHand_2.CFrame = CFrame.new(Vector3.new(-46.9255, 5.6622, -36.2873)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftHand.Parent = radiantDreamOld
	...
	leftLowerArm.TextureID = "rbxassetid://99267622651297"
	...
	leftLowerArm.CFrame = CFrame.new(Vector3.new(-46.9255, 5.5806, -35.6286)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		leftLowerArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://111406723855910", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftLowerArm_2.TextureID = "rbxassetid://99267622651297"
		...
		leftLowerArm_2.Size = Vector3.new(0.9196, 0.6325, 0.6411)
		...
		leftLowerArm_2.CFrame = CFrame.new(Vector3.new(-46.9255, 5.5806, -35.6286)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		do
			...
			leftLowerArmMotor6d_2.C0 = CFrame.new(Vector3.new(-1.5204, 3.1321, 0.0362))
	...
	leftLowerArm.Parent = radiantDreamOld
	...
	leftLowerLeg.TextureID = "rbxassetid://99267622651297"
	...
	leftLowerLeg.CFrame = CFrame.new(Vector3.new(-46.8955, 3.1089, -34.3688)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		leftLowerLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://134820174712119", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftLowerLeg_2.TextureID = "rbxassetid://99267622651297"
		...
		leftLowerLeg_2.CFrame = CFrame.new(Vector3.new(-46.8955, 3.1089, -34.3688)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		do
	...
	leftLowerLeg.Parent = radiantDreamOld
	...
	rightUpperArm.TextureID = "rbxassetid://99267622651297"
	...
	rightUpperArm.CFrame = CFrame.new(Vector3.new(-46.9255, 5.5803, -33.2594)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightUpperArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://129809122854665", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightUpperArm_2.TextureID = "rbxassetid://99267622651297"
		...
		rightUpperArm_2.Size = Vector3.new(0.964, 0.6023, 0.6583)
		...
		rightUpperArm_2.CFrame = CFrame.new(Vector3.new(-46.9255, 5.5803, -33.2594)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		rightUpperArm_2.PivotOffset = CFrame.new(Vector3.new(-0.3738, 0, 0))
		do
			...
			rightUpperArmMotor6d_2.C0 = CFrame.new(Vector3.new(0.8331, 3.132, 0.0362))
	...
	rightUpperArm.Parent = radiantDreamOld
	...
	rightUpperLeg.TextureID = "rbxassetid://99267622651297"
	...
	rightUpperLeg.CFrame = CFrame.new(Vector3.new(-46.9213, 3.999, -33.8184)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		rightUpperLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://111488417702230", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightUpperLeg_2.TextureID = "rbxassetid://99267622651297"
		...
		rightUpperLeg_2.CFrame = CFrame.new(Vector3.new(-46.9213, 3.999, -33.8184)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		do
	...
	rightUpperLeg.Parent = radiantDreamOld
	...
	rightLowerLeg.TextureID = "rbxassetid://99267622651297"
	...
	rightLowerLeg.CFrame = CFrame.new(Vector3.new(-46.8955, 3.1089, -33.8184)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		rightLowerLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://122786179285079", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightLowerLeg_2.TextureID = "rbxassetid://99267622651297"
		...
		rightLowerLeg_2.CFrame = CFrame.new(Vector3.new(-46.8955, 3.1089, -33.8184)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		do
	...
	rightLowerLeg.Parent = radiantDreamOld
	...
	rightHand.TextureID = "rbxassetid://99267622651297"
	...
	rightHand.CFrame = CFrame.new(Vector3.new(-46.9255, 5.6622, -31.8999)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		rightHand_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://71276716347340", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightHand_2.TextureID = "rbxassetid://99267622651297"
		...
		rightHand_2.CFrame = CFrame.new(Vector3.new(-46.9255, 5.6622, -31.8999)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		do
	...
	rightHand.Parent = radiantDreamOld
end

radiantDreamOld.PrimaryPart = humanoidRootPart
