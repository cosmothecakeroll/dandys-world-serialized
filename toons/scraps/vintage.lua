...
local vintageScraps = Instance.new("Model")
vintageScraps.Name = "VintageScraps"
do
	...
	loadoutFrame.Parent = vintageScraps
	...
	animations.Parent = vintageScraps
	...
	do
		...
		hurtTexture.Texture = "rbxassetid://75321884934972"
		hurtTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://106681119524959"
		blinkTexture.Parent = config
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://76741729863078"
		normalTexture.Parent = config
	end
	config.Parent = vintageScraps
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-57.3893, 2.1789, -55.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = vintageScraps
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-57.3893, 2.1789, -55.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	torso.TextureID = "rbxassetid://76741729863078"
	torso.Name = "Torso"
	...
	torso.CFrame = CFrame.new(Vector3.new(-57.3893, 4.3897, -55.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	tail.TextureID = "rbxassetid://76741729863078"
	...
	tail.CFrame = CFrame.new(Vector3.new(-58.9629, 3.672, -55.594)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.TextureID = "rbxassetid://76741729863078"
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-57.2213, 2.948, -55.3218)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.TextureID = "rbxassetid://76741729863078"
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-57.3893, 4.8354, -54.3701)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.TextureID = "rbxassetid://76741729863078"
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-57.2213, 2.948, -55.8654)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.TextureID = "rbxassetid://76741729863078"
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-57.3893, 4.8354, -56.8171)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	head.TextureID = "rbxassetid://76741729863078"
	...
	head.CFrame = CFrame.new(Vector3.new(-57.4335, 6.4719, -55.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	head.Parent = vintageScraps
end

vintageScraps.PrimaryPart = humanoidRootPart
