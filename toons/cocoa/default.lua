...
local cocoa = Instance.new("Model")
cocoa.Name = "Cocoa"
cocoa.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	animations.Parent = cocoa
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://112946385085010"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://108509460291629"
		hurtTexture.Parent = config
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://105044687107365"
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 1.9481, 63.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	head.TextureID = "rbxassetid://105044687107365"
	head.Name = "Head"
	head.CanQuery = false
	head.CanTouch = false
	...
	head.CFrame = CFrame.new(Vector3.new(-41.3344, 5.5491, 63.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerArm.TextureID = "rbxassetid://105044687107365"
	...
	rightLowerArm.CFrame = CFrame.new(Vector3.new(-40.3898, 4.5104, 64.6187)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rightLowerLeg.TextureID = "rbxassetid://105044687107365"
	...
	rightLowerLeg.CFrame = CFrame.new(Vector3.new(-40.4355, 2.3413, 63.7554)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightMiddleLeg.TextureID = "rbxassetid://105044687107365"
	...
	rightMiddleLeg.CFrame = CFrame.new(Vector3.new(-40.4427, 2.6912, 63.7473)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	torso.TextureID = "rbxassetid://105044687107365"
	torso.Name = "Torso"
	...
	torso.CFrame = CFrame.new(Vector3.new(-40.3781, 4.0529, 63.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rightUpperArm.TextureID = "rbxassetid://105044687107365"
	...
	rightUpperArm.CFrame = CFrame.new(Vector3.new(-40.3898, 4.5076, 64.0561)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerLeg.TextureID = "rbxassetid://105044687107365"
	...
	leftLowerLeg.CFrame = CFrame.new(Vector3.new(-40.4355, 2.3413, 63.0574)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerArm.TextureID = "rbxassetid://105044687107365"
	...
	leftLowerArm.CFrame = CFrame.new(Vector3.new(-40.3898, 4.5104, 62.1941)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	leftUpperArm.TextureID = "rbxassetid://105044687107365"
	...
	leftUpperArm.CFrame = CFrame.new(Vector3.new(-40.3898, 4.5076, 62.7567)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftMiddleLeg.TextureID = "rbxassetid://105044687107365"
	...
	leftMiddleLeg.CFrame = CFrame.new(Vector3.new(-40.4427, 2.6912, 63.0655)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftUpperLeg.TextureID = "rbxassetid://105044687107365"
	...
	leftUpperLeg.CFrame = CFrame.new(Vector3.new(-40.3716, 3.2063, 63.0029)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rightUpperLeg.TextureID = "rbxassetid://105044687107365"
	...
	rightUpperLeg.CFrame = CFrame.new(Vector3.new(-40.3716, 3.2063, 63.8098)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	tail.TextureID = "rbxassetid://105044687107365"
	tail.Name = "Tail"
	tail.CanQuery = false
	tail.CanTouch = false
	...
	tail.CFrame = CFrame.new(Vector3.new(-41.2239, 3.6523, 63.4043)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rightHand.TextureID = "rbxassetid://105044687107365"
	...
	rightHand.CFrame = CFrame.new(Vector3.new(-40.3176, 4.508, 65.1705)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rightFoot.TextureID = "rbxassetid://105044687107365"
	...
	rightFoot.CFrame = CFrame.new(Vector3.new(-40.2675, 2.1151, 63.7601)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	leftFoot.TextureID = "rbxassetid://105044687107365"
	...
	leftFoot.CFrame = CFrame.new(Vector3.new(-40.2675, 2.1151, 63.0527)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	leftHand.TextureID = "rbxassetid://105044687107365"
	...
	leftHand.CFrame = CFrame.new(Vector3.new(-40.3176, 4.508, 61.6423)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 1.9481, 63.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = cocoa
end

cocoa.PrimaryPart = humanoidRootPart
