local boaGeo, boaGeoMotor6d, boaGeo_2, boaGeoMotor6d_2, weld, head, headMotor6d, head_2, headMotor6d_2, weld_2, leftArm, leftArmMotor6d, leftArm_2, leftArmMotor6d_2, weld_3, leftLeg, leftLegMotor6d, leftLeg_2, leftLegMotor6d_2, weld_4, rightArm, rightArmMotor6d, rightArm_2, rightArmMotor6d_2, weld_5, rightLeg, rightLegMotor6d, rightLeg_2, rightLegMotor6d_2, weld_6, torso, torsoMotor6d, torso_2, torsoMotor6d_2, weld_7, rootPart, weldConstraint, humanoidRootPart

local fancyDress = Instance.new("Model")
fancyDress.Name = "FancyDress"
do
	...
	do
		...
		normalTexture.Texture = "rbxassetid://125433663600110"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://76755104822738"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://138129765167615"
	...
	boaGeo.TextureID = "rbxassetid://125433663600110"
	boaGeo.Name = "BoaGeo"
	...
	boaGeo.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
	boaGeo.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	boaGeo.CFrame = CFrame.new(Vector3.new(-44.0357, 3.2769, -87.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		boaGeo_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://86481368716745", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		boaGeo_2.TextureID = "rbxassetid://125433663600110"
		boaGeo_2.Name = "BoaGeo"
		boaGeo_2.CanCollide = false
		boaGeo_2.CanTouch = false
		boaGeo_2.Massless = true
		boaGeo_2.CanQuery = false
		boaGeo_2.Size = Vector3.new(3.6877, 0.7329, 3.0363)
		boaGeo_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		boaGeo_2.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
		boaGeo_2.CFrame = CFrame.new(Vector3.new(-44.0357, 3.2769, -87.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		boaGeo_2.PivotOffset = CFrame.new(Vector3.new(0, -3.2105, 0.3538)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			boaGeoMotor6d_2 = Instance.new("Motor6D")
			boaGeoMotor6d_2.Name = "BoaGeoMotor6D"
			boaGeoMotor6d_2.MaxVelocity = 0.1
			boaGeoMotor6d_2.C0 = CFrame.new(Vector3.new(0, 3.2104, -0.3539))
			boaGeoMotor6d_2.Parent = boaGeo_2
			weld = Instance.new("Weld")
			weld.Parent = boaGeo_2
		end
		boaGeo_2.Parent = boaGeo
	end
	boaGeo.Parent = fancyDress
	...
	head.TextureID = "rbxassetid://125433663600110"
	head.Name = "Head"
	head.Transparency = 1
	head.CanQuery = false
	head.CanTouch = false
	...
	head.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
	head.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	head.CFrame = CFrame.new(Vector3.new(-44.7884, 4.3791, -87.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		head_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://88549497002506", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		head_2.TextureID = "rbxassetid://125433663600110"
		head_2.Name = "Head"
		head_2.CanCollide = false
		head_2.CanTouch = false
		head_2.Massless = true
		head_2.CanQuery = false
		head_2.Size = Vector3.new(3.5348, 2.5089, 3.6921)
		head_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		head_2.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
		head_2.CFrame = CFrame.new(Vector3.new(-44.7884, 4.3791, -87.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		head_2.PivotOffset = CFrame.new(Vector3.new(0, -4.3128, -0.396)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			headMotor6d_2 = Instance.new("Motor6D")
			headMotor6d_2.Name = "HeadMotor6D"
			headMotor6d_2.MaxVelocity = 0.1
			headMotor6d_2.C0 = CFrame.new(Vector3.new(0, 4.3127, 0.3959))
	...
	leftArm.TextureID = "rbxassetid://125433663600110"
	...
	leftArm.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
	leftArm.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	leftArm.CFrame = CFrame.new(Vector3.new(-44.5195, 3.0498, -88.4703)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://116379246646963", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftArm_2.TextureID = "rbxassetid://125433663600110"
		leftArm_2.Name = "LeftArm"
		leftArm_2.CanCollide = false
		leftArm_2.CanTouch = false
		leftArm_2.Massless = true
		leftArm_2.CanQuery = false
		leftArm_2.Size = Vector3.new(2.1094, 0.7113, 0.4058)
		leftArm_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		leftArm_2.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
		leftArm_2.CFrame = CFrame.new(Vector3.new(-44.5195, 3.0498, -88.4703)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		leftArm_2.PivotOffset = CFrame.new(Vector3.new(1.3766, -2.9834, -0.1299)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			leftArmMotor6d_2 = Instance.new("Motor6D")
			leftArmMotor6d_2.Name = "LeftArmMotor6D"
			leftArmMotor6d_2.MaxVelocity = 0.1
			leftArmMotor6d_2.C0 = CFrame.new(Vector3.new(-1.3767, 2.9833, 0.1298))
	...
	leftLeg.TextureID = "rbxassetid://125433663600110"
	...
	leftLeg.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
	leftLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	leftLeg.CFrame = CFrame.new(Vector3.new(-44.2282, 0.4281, -87.3459)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://122145576436615", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftLeg_2.TextureID = "rbxassetid://125433663600110"
		leftLeg_2.Name = "LeftLeg"
		leftLeg_2.CanCollide = false
		leftLeg_2.CanTouch = false
		leftLeg_2.Massless = true
		leftLeg_2.CanQuery = false
		leftLeg_2.Size = Vector3.new(0.4588, 0.729, 0.6716)
		leftLeg_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		leftLeg_2.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
		leftLeg_2.CFrame = CFrame.new(Vector3.new(-44.2282, 0.4281, -87.3459)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		leftLeg_2.PivotOffset = CFrame.new(Vector3.new(0.2523, -0.3617, 0.1613)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			leftLegMotor6d_2 = Instance.new("Motor6D")
			leftLegMotor6d_2.Name = "LeftLegMotor6D"
			leftLegMotor6d_2.MaxVelocity = 0.1
			leftLegMotor6d_2.C0 = CFrame.new(Vector3.new(-0.2524, 0.3616, -0.1614))
	...
	rightArm.TextureID = "rbxassetid://125433663600110"
	...
	rightArm.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
	rightArm.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	rightArm.CFrame = CFrame.new(Vector3.new(-44.5195, 3.0498, -85.7169)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://120914054903185", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightArm_2.TextureID = "rbxassetid://125433663600110"
		...
		rightArm_2.Size = Vector3.new(2.1094, 0.7113, 0.4058)
		rightArm_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		rightArm_2.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
		rightArm_2.CFrame = CFrame.new(Vector3.new(-44.5195, 3.0498, -85.7169)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		rightArm_2.PivotOffset = CFrame.new(Vector3.new(-1.3767, -2.9834, -0.1299)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			rightArmMotor6d_2 = Instance.new("Motor6D")
			rightArmMotor6d_2.Name = "RightArmMotor6D"
			rightArmMotor6d_2.MaxVelocity = 0.1
			rightArmMotor6d_2.C0 = CFrame.new(Vector3.new(1.3766, 2.9833, 0.1298))
	...
	rightLeg.TextureID = "rbxassetid://125433663600110"
	...
	rightLeg.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
	rightLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	rightLeg.CFrame = CFrame.new(Vector3.new(-44.2282, 0.4281, -86.8413)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://101123873809395", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightLeg_2.TextureID = "rbxassetid://125433663600110"
		...
		rightLeg_2.Size = Vector3.new(0.4588, 0.729, 0.6716)
		rightLeg_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		rightLeg_2.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
		rightLeg_2.CFrame = CFrame.new(Vector3.new(-44.2282, 0.4281, -86.8413)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		rightLeg_2.PivotOffset = CFrame.new(Vector3.new(-0.2524, -0.3617, 0.1613)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			rightLegMotor6d_2 = Instance.new("Motor6D")
			rightLegMotor6d_2.Name = "RightLegMotor6D"
			rightLegMotor6d_2.MaxVelocity = 0.1
			rightLegMotor6d_2.C0 = CFrame.new(Vector3.new(0.2523, 0.3616, -0.1614))
	...
	torso.TextureID = "rbxassetid://125433663600110"
	torso.Name = "Torso"
	...
	torso.Massless = true
	torso.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
	torso.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	torso.Size = Vector3.new(1.6478, 2.981, 1.4163)
	torso.CFrame = CFrame.new(Vector3.new(-44.3958, 1.9481, -87.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		torso_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://117389673539982", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		torso_2.TextureID = "rbxassetid://125433663600110"
		torso_2.Name = "Torso"
		torso_2.CanCollide = false
		torso_2.CanTouch = false
		torso_2.Massless = true
		torso_2.CanQuery = false
		torso_2.Size = Vector3.new(1.6427, 2.9915, 1.3983)
		torso_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		torso_2.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
		torso_2.CFrame = CFrame.new(Vector3.new(-44.3958, 1.9481, -87.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		torso_2.PivotOffset = CFrame.new(Vector3.new(0, -1.888, -0.006)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			torsoMotor6d_2 = Instance.new("Motor6D")
			torsoMotor6d_2.Name = "TorsoMotor6D"
			torsoMotor6d_2.MaxVelocity = 0.1
			torsoMotor6d_2.C0 = CFrame.new(Vector3.new(0, 1.8879, 0.0059))
	...
	rootPart.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
	rootPart.CFrame = CFrame.new(Vector3.new(-44.3893, 0.0664, -87.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = fancyDress
	humanoidRootPart = Instance.new("Part")
	humanoidRootPart.Name = "HumanoidRootPart"
	humanoidRootPart.Transparency = 1
	humanoidRootPart.AssemblyLinearVelocity = Vector3.new(0, -17.1636, 0)
	humanoidRootPart.Size = Vector3.new(2, 2, 1)
	humanoidRootPart.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	humanoidRootPart.CustomPhysicalProperties = PhysicalProperties.new(15, 1, 0.3, 1, 1, 1)
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-44.3893, 1.9481, -87.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = fancyDress
end

fancyDress.PrimaryPart = humanoidRootPart
