local torso, torsoMotor6d, head, headMotor6d, boaGeo, boaGeoMotor6d, leftArm, leftArmMotor6d, leftLeg, leftLegMotor6d, rightArm, rightArmMotor6d, rightLeg, rightLegMotor6d, rootPart, weldConstraint, humanoidRootPart

local teagan = Instance.new("Model")
teagan.Name = "Teagan"
teagan.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	do
		...
		ability.AnimationId = "rbxassetid://93255474598680"
		ability.Parent = animations
		local decode = Instance.new("Animation")
		decode.Name = "Decode"
		decode.AnimationId = "rbxassetid://121462974835251"
		decode.Parent = animations
		local idle = Instance.new("Animation")
		idle.Name = "Idle"
		idle.AnimationId = "rbxassetid://127898631498312"
		idle.Parent = animations
		local quirk = Instance.new("Animation")
		quirk.Name = "Quirk"
		quirk.AnimationId = "rbxassetid://98233057863420"
		quirk.Parent = animations
		local walk = Instance.new("Animation")
		walk.Name = "Walk"
		walk.AnimationId = "rbxassetid://94579968743372"
		walk.Parent = animations
		local run = Instance.new("Animation")
		run.Name = "Run"
		run.AnimationId = "rbxassetid://97811360419711"
		run.Parent = animations
	end
	animations.Parent = teagan
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://123043988891616"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://80222226756035"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://79093860059063"
	...
	torso.CFrame = CFrame.new(Vector3.new(-40.3958, 1.9481, -87.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	head.TextureID = "rbxassetid://123043988891616"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-40.7884, 4.3791, -87.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	boaGeo.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
	boaGeo.CFrame = CFrame.new(Vector3.new(-40.0357, 3.2769, -87.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-40.5195, 3.0498, -88.4703)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-40.2282, 0.4281, -87.3459)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-40.5195, 3.0498, -85.7169)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-40.2282, 0.4281, -86.8413)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 0.0664, -87.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 1.9481, -87.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = teagan
end

teagan.PrimaryPart = humanoidRootPart
