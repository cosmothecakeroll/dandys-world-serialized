local leftFoot, leftFootMotor6d, rigidConstraint, rightTrail, leftTrail, humanoidRootPart, rootPart, headBoneAttachment, leftBack, leftFront, rightBack, rightFront, chestAttachment, rigidConstraint_2, weldConstraint, leftUpperLeg, leftUpperLegMotor6d, rightHand, rightHandMotor6d, rightLowerArm, rightLowerArmMotor6d, rightUpperArm, rightUpperArmMotor6d, leftUpperArm, leftUpperArmMotor6d, leftLowerArm, leftLowerArmMotor6d, leftHand, leftHandMotor6d, head_2, headMotor6d, staticScreen, rigidConstraint_3, staticScreen_2, attachment, leftTrail_2, rightTrail_2, tail_2, tailMotor6d, torso_2, torsoMotor6d, rightLowerLeg, rightLowerLegMotor6d, rightFoot, rightFootMotor6d, rightUpperLeg, rightUpperLegMotor6d, leftLowerLeg, leftLowerLegMotor6d

local vintageVee = Instance.new("Model")
vintageVee.Name = "VintageVee"
do
	...
	leftFoot.TextureID = "rbxassetid://129753335817013"
	...
	leftFoot.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	leftFoot.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	leftFoot.CFrame = CFrame.new(Vector3.new(-65.7279, 1.8558, -102.8128)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	animations.Parent = vintageVee
	humanoidRootPart = Instance.new("Part")
	humanoidRootPart.Name = "HumanoidRootPart"
	humanoidRootPart.Transparency = 1
	humanoidRootPart.CanQuery = false
	humanoidRootPart.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	humanoidRootPart.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	humanoidRootPart.Size = Vector3.new(2, 2, 1)
	humanoidRootPart.CustomPhysicalProperties = PhysicalProperties.new(15, 0.3, 0.5, 1, 1, 1)
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-65.8913, 1.6971, -102.5756)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	do
	...
	humanoidRootPart.Parent = vintageVee
	...
	rootPart.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	rootPart.Size = Vector3.new(2, 2, 1)
	rootPart.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	rootPart.CFrame = CFrame.new(Vector3.new(-65.8913, 1.6971, -102.5756)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	do
	...
	leftUpperLeg.TextureID = "rbxassetid://129753335817013"
	...
	leftUpperLeg.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	leftUpperLeg.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	leftUpperLeg.CFrame = CFrame.new(Vector3.new(-65.9117, 2.9756, -102.8209)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	leftUpperLeg.Parent = vintageVee
	...
	rightHand.TextureID = "rbxassetid://129753335817013"
	...
	rightHand.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	rightHand.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	rightHand.CFrame = CFrame.new(Vector3.new(-65.9568, 4.5088, -100.7287)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	rightLowerArm.TextureID = "rbxassetid://129753335817013"
	...
	rightLowerArm.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	rightLowerArm.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	rightLowerArm.CFrame = CFrame.new(Vector3.new(-65.9546, 4.4317, -101.2707)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	rightLowerArm.Parent = vintageVee
	...
	rightUpperArm.TextureID = "rbxassetid://129753335817013"
	...
	rightUpperArm.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	rightUpperArm.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	rightUpperArm.CFrame = CFrame.new(Vector3.new(-65.9538, 4.4272, -101.916)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	rightUpperArm.Parent = vintageVee
	...
	leftUpperArm.TextureID = "rbxassetid://129753335817013"
	...
	leftUpperArm.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	leftUpperArm.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	leftUpperArm.CFrame = CFrame.new(Vector3.new(-65.9521, 4.4176, -103.2739)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	leftUpperArm.Parent = vintageVee
	...
	leftLowerArm.TextureID = "rbxassetid://129753335817013"
	...
	leftLowerArm.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	leftLowerArm.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	leftLowerArm.CFrame = CFrame.new(Vector3.new(-65.9513, 4.413, -103.9191)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	leftLowerArm.Parent = vintageVee
	...
	leftHand.TextureID = "rbxassetid://129753335817013"
	...
	leftHand.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	leftHand.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	leftHand.CFrame = CFrame.new(Vector3.new(-65.9522, 4.4824, -104.4622)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	head_2.TextureID = "rbxassetid://129753335817013"
	head_2.Name = "Head"
	...
	head_2.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	head_2.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	head_2.CFrame = CFrame.new(Vector3.new(-65.9436, 6.8072, -102.6118)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	do
		...
		do
			...
			staticScreen_2.TextureID = "rbxassetid://129753335817013"
			...
			staticScreen_2.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
			staticScreen_2.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
			staticScreen_2.CFrame = CFrame.new(Vector3.new(-64.8897, 3.9483, -102.5939)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			...
			do
				...
				decal.Texture = "http://www.roblox.com/asset/?id=4388381606"
	...
	tail_2.TextureID = "rbxassetid://129753335817013"
	tail_2.Name = "Tail"
	...
	tail_2.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	tail_2.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	tail_2.CFrame = CFrame.new(Vector3.new(-68.6437, 3.5174, -102.5918)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	torso_2.TextureID = "rbxassetid://129753335817013"
	torso_2.Name = "Torso"
	torso_2.Massless = true
	torso_2.CanTouch = false
	torso_2.CanQuery = false
	torso_2.Size = Vector3.new(1.6127, 1.6085, 0.9043)
	torso_2.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	torso_2.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	torso_2.CFrame = CFrame.new(Vector3.new(-65.9129, 4.0317, -102.5921)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	rightLowerLeg.TextureID = "rbxassetid://129753335817013"
	...
	rightLowerLeg.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	rightLowerLeg.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	rightLowerLeg.CFrame = CFrame.new(Vector3.new(-65.8693, 2.212, -102.3429)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	rightLowerLeg.Parent = vintageVee
	...
	rightFoot.TextureID = "rbxassetid://129753335817013"
	...
	rightFoot.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	rightFoot.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	rightFoot.CFrame = CFrame.new(Vector3.new(-65.7285, 1.8591, -102.3403)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	rightUpperLeg.TextureID = "rbxassetid://129753335817013"
	...
	rightUpperLeg.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	rightUpperLeg.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	rightUpperLeg.CFrame = CFrame.new(Vector3.new(-65.9123, 2.979, -102.3484)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	rightUpperLeg.Parent = vintageVee
	...
	leftLowerLeg.TextureID = "rbxassetid://129753335817013"
	...
	leftLowerLeg.AssemblyAngularVelocity = Vector3.new(-6.6284, -0.2297, 3.5781)
	leftLowerLeg.AssemblyLinearVelocity = Vector3.new(0.0129, -15.8494, -0.0032)
	leftLowerLeg.CFrame = CFrame.new(Vector3.new(-65.8687, 2.2087, -102.8155)) * CFrame.fromEulerAnglesXYZ(math.rad(92.9556), math.rad(-88.8003), math.rad(93.3612))
	...
	leftLowerLeg.Parent = vintageVee
end

vintageVee.PrimaryPart = humanoidRootPart
