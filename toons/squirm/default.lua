...
local squrim = Instance.new("Model")
squrim.Name = "Squrim"
do
	...
	rightLegBack.TextureID = "rbxassetid://76995597949814"
	...
	rightLegBack.CFrame = CFrame.new(Vector3.new(-41.7556, 2.8088, -80.7226)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLegBack.Parent = squrim
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://76995597949814"
		...
		hurtTexture.Texture = "rbxassetid://109368427406766"
	...
	leftArm.TextureID = "rbxassetid://76995597949814"
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-39.4168, 4.675, -84.3701)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	head.TextureID = "rbxassetid://76995597949814"
	...
	head.CFrame = CFrame.new(Vector3.new(-39.4388, 6.946, -82.1059)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	torso.TextureID = "rbxassetid://76995597949814"
	torso.Name = "Torso"
	...
	torso.CFrame = CFrame.new(Vector3.new(-40.9315, 3.8485, -82.1059)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLegBack.TextureID = "rbxassetid://76995597949814"
	...
	leftLegBack.CFrame = CFrame.new(Vector3.new(-41.7556, 2.8088, -83.4892)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.TextureID = "rbxassetid://76995597949814"
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-39.4168, 4.675, -79.8417)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	book02.CFrame = CFrame.new(Vector3.new(-39.4364, 3.8962, -81.8715)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.8315, 2.0198, -82.1059)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = squrim
	...
	book04.CFrame = CFrame.new(Vector3.new(-39.4364, 3.5102, -82.0757)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLegFront.TextureID = "rbxassetid://76995597949814"
	...
	rightLegFront.CFrame = CFrame.new(Vector3.new(-39.9565, 2.8088, -80.8661)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-40.8315, 2.0198, -82.1059)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	book01.CFrame = CFrame.new(Vector3.new(-39.4364, 3.8922, -82.2559)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLegFront.TextureID = "rbxassetid://76995597949814"
	...
	leftLegFront.CFrame = CFrame.new(Vector3.new(-39.9565, 2.8088, -83.3457)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	book03.CFrame = CFrame.new(Vector3.new(-39.4364, 3.6128, -82.2117)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	book03.Parent = squrim
end

squrim.PrimaryPart = humanoidRootPart
