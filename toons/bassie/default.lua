local humanoidRootPart, head, headMotor6d, rightUpperArm, rightUpperArmMotor6d, rightLowerArm, rightLowerArmMotor6d, rightHand, rightHandMotor6d, leftHand, leftHandMotor6d, leftUpperArm, leftUpperArmMotor6d, leftLowerArm, leftLowerArmMotor6d, torso, torsoMotor6d, rightUpperLeg, rightUpperLegMotor6d, rightLowerLeg, rightLowerLegMotor6d, rightFoot, rightFootMotor6d, leftUpperLeg, leftUpperLegMotor6d, leftLowerLeg, leftLowerLegMotor6d, leftFoot, leftFootMotor6d, rootPart, weldConstraint

local bassie = Instance.new("Model")
bassie.Name = "Bassie"
bassie.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	animations.Parent = bassie
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://102582006493177"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://71525190974755"
		hurtTexture.Parent = config
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://127926925435189"
		normalTexture.Parent = config
		local characterName = Instance.new("StringValue")
		characterName.Name = "CharacterName"
		characterName.Value = "Bassie"
	...
	config.Parent = bassie
	local toonName = Instance.new("StringValue")
	toonName.Name = "ToonName"
	toonName.Value = "Bassie"
	toonName.Parent = bassie
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 1.9481, 101.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	humanoidRootPart.Parent = bassie
	...
	head.TextureID = "rbxassetid://127926925435189"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-40.2982, 6.1878, 101.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightUpperArm.TextureID = "rbxassetid://127926925435189"
	...
	rightUpperArm.CFrame = CFrame.new(Vector3.new(-40.3898, 4.9136, 102.5391)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerArm.TextureID = "rbxassetid://127926925435189"
	...
	rightLowerArm.CFrame = CFrame.new(Vector3.new(-40.3898, 4.9162, 103.2169)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightHand.TextureID = "rbxassetid://127926925435189"
	...
	rightHand.CFrame = CFrame.new(Vector3.new(-40.3898, 4.9813, 103.8672)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftHand.TextureID = "rbxassetid://127926925435189"
	...
	leftHand.CFrame = CFrame.new(Vector3.new(-40.3898, 4.9813, 99.9456)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftUpperArm.TextureID = "rbxassetid://127926925435189"
	...
	leftUpperArm.CFrame = CFrame.new(Vector3.new(-40.3898, 4.9136, 101.2737)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerArm.TextureID = "rbxassetid://127926925435189"
	...
	leftLowerArm.CFrame = CFrame.new(Vector3.new(-40.3898, 4.9162, 100.5959)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	torso.TextureID = "rbxassetid://127926925435189"
	torso.Name = "Torso"
	torso.Massless = true
	...
	torso.CFrame = CFrame.new(Vector3.new(-40.3893, 4.0411, 101.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightUpperLeg.TextureID = "rbxassetid://127926925435189"
	...
	rightUpperLeg.CFrame = CFrame.new(Vector3.new(-40.3912, 3.3921, 102.1517)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerLeg.TextureID = "rbxassetid://127926925435189"
	...
	rightLowerLeg.CFrame = CFrame.new(Vector3.new(-40.3684, 2.5949, 102.1528)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightFoot.TextureID = "rbxassetid://127926925435189"
	...
	rightFoot.CFrame = CFrame.new(Vector3.new(-40.2435, 2.1287, 102.1606)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftUpperLeg.TextureID = "rbxassetid://127926925435189"
	...
	leftUpperLeg.CFrame = CFrame.new(Vector3.new(-40.3912, 3.3921, 101.6611)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerLeg.TextureID = "rbxassetid://127926925435189"
	...
	leftLowerLeg.CFrame = CFrame.new(Vector3.new(-40.3684, 2.5949, 101.66)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftFoot.TextureID = "rbxassetid://127926925435189"
	...
	leftFoot.CFrame = CFrame.new(Vector3.new(-40.2435, 2.1287, 101.6522)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 1.9481, 101.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = bassie
end

bassie.PrimaryPart = humanoidRootPart
