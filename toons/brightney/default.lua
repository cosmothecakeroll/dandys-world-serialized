...
local brightney = Instance.new("Model")
...
do
	...
	do
		...
		normalTexture.Texture = "rbxassetid://138791199419011"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://85090520637156"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://106829257107686"
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 2.1789, 81.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = brightney
	...
	torso.TextureID = "rbxassetid://138791199419011"
	torso.Name = "Torso"
	...
	torso.CFrame = CFrame.new(Vector3.new(-40.4382, 4.7879, 81.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	head.TextureID = "rbxassetid://138791199419011"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-40.6992, 6.1292, 81.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.TextureID = "rbxassetid://138791199419011"
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-40.2616, 3.0332, 81.6141)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.TextureID = "rbxassetid://138791199419011"
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-40.2616, 3.0332, 81.1987)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.TextureID = "rbxassetid://138791199419011"
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-40.4885, 4.6601, 80.1429)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.TextureID = "rbxassetid://138791199419011"
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-40.4885, 4.6601, 82.6699)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	notepad.TextureID = "rbxassetid://93447133099296"
	...
	notepad.CFrame = CFrame.new(Vector3.new(-40.3893, 4.2994, 81.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	light.CFrame = CFrame.new(Vector3.new(-40.3893, 6.6389, 81.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 2.1789, 81.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = brightney
end

brightney.PrimaryPart = humanoidRootPart
