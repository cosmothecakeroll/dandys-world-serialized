local head, headMotor6d, torso, torsoMotor6d, rightWing, rightWingMotor6d, leftWing, leftWingMotor6d, rightLeg, rightLegMotor6d, leftLeg, leftLegMotor6d, rootPart, weldConstraint, humanoidRootPart

local vintageFlutter = Instance.new("Model")
vintageFlutter.Name = "VintageFlutter"
do
	...
	animations.Parent = vintageFlutter
	...
	humanoid.Parent = vintageFlutter
	...
	head.TextureID = "rbxassetid://137099996057145"
	head.Name = "Head"
	head.CanQuery = false
	head.CanTouch = false
	head.Massless = true
	...
	head.AssemblyLinearVelocity = Vector3.new(0.0659, 10.0346, -0.0325)
	head.AssemblyAngularVelocity = Vector3.new(-8.475, 0.3856, -0.2982)
	head.CFrame = CFrame.new(Vector3.new(-44.8525, 5.3632, 21.4034)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	torso.TextureID = "rbxassetid://137099996057145"
	torso.Name = "Torso"
	torso.Massless = true
	torso.CanTouch = false
	torso.CanQuery = false
	torso.Size = Vector3.new(1.9517, 2.1166, 1.4633)
	torso.AssemblyLinearVelocity = Vector3.new(0.0659, 10.0346, -0.0325)
	torso.AssemblyAngularVelocity = Vector3.new(-8.475, 0.3856, -0.2982)
	torso.CFrame = CFrame.new(Vector3.new(-45.5298, 3.5775, 21.3774)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rightWing.TextureID = "rbxassetid://137099996057145"
	...
	rightWing.AssemblyAngularVelocity = Vector3.new(-8.475, 0.3856, -0.2982)
	rightWing.AssemblyLinearVelocity = Vector3.new(0.0659, 10.0346, -0.0325)
	rightWing.CFrame = CFrame.new(Vector3.new(-45.7447, 4.0466, 23.0824)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightWing.Parent = vintageFlutter
	...
	leftWing.TextureID = "rbxassetid://137099996057145"
	...
	leftWing.AssemblyLinearVelocity = Vector3.new(0.0659, 10.0346, -0.0325)
	leftWing.AssemblyAngularVelocity = Vector3.new(-8.475, 0.3856, -0.2982)
	leftWing.CFrame = CFrame.new(Vector3.new(-45.7447, 4.0466, 19.7304)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	leftWing.Parent = vintageFlutter
	...
	rightLeg.TextureID = "rbxassetid://137099996057145"
	...
	rightLeg.AssemblyAngularVelocity = Vector3.new(-8.475, 0.3856, -0.2982)
	rightLeg.AssemblyLinearVelocity = Vector3.new(0.0659, 10.0346, -0.0325)
	rightLeg.CFrame = CFrame.new(Vector3.new(-45.3635, 2.2346, 21.7076)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.Parent = vintageFlutter
	...
	leftLeg.TextureID = "rbxassetid://137099996057145"
	...
	leftLeg.AssemblyAngularVelocity = Vector3.new(-8.475, 0.3856, -0.2982)
	leftLeg.AssemblyLinearVelocity = Vector3.new(0.0659, 10.0346, -0.0325)
	leftLeg.CFrame = CFrame.new(Vector3.new(-45.3635, 2.2346, 21.1052)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.AssemblyAngularVelocity = Vector3.new(-8.475, 0.3856, -0.2982)
	rootPart.Size = Vector3.new(2, 2, 1)
	rootPart.AssemblyLinearVelocity = Vector3.new(0.0659, 10.0346, -0.0325)
	rootPart.CFrame = CFrame.new(Vector3.new(-45.3893, 1.4481, 21.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = vintageFlutter
	humanoidRootPart = Instance.new("Part")
	humanoidRootPart.Name = "HumanoidRootPart"
	humanoidRootPart.Transparency = 1
	humanoidRootPart.AssemblyLinearVelocity = Vector3.new(0.0659, 10.0346, -0.0325)
	humanoidRootPart.Size = Vector3.new(2, 2, 1)
	humanoidRootPart.AssemblyAngularVelocity = Vector3.new(-8.475, 0.3856, -0.2982)
	humanoidRootPart.CustomPhysicalProperties = PhysicalProperties.new(15, 1, 0.3, 1, 1, 1)
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-45.3893, 1.4481, 21.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = vintageFlutter
end

vintageFlutter.PrimaryPart = humanoidRootPart
