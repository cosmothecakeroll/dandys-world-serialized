...
boxten.Name = "Boxten"
boxten.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	do
		...
		normalTexture.Texture = "rbxassetid://74568408102563"
		normalTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://105702401843937"
		hurtTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://80418423615745"
	...
	head.CFrame = CFrame.new(Vector3.new(-40.3931, 6.3696, 86.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	torso.CFrame = CFrame.new(Vector3.new(-40.4938, 4.6627, 86.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-40.3885, 5.1637, 87.6379)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-40.2376, 3.3214, 86.6321)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-40.2376, 3.3214, 86.1807)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-40.3885, 5.1637, 85.1749)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	gear.CFrame = CFrame.new(Vector3.new(-41.9332, 6.2829, 86.4016)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 2.4481, 86.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 2.4481, 86.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
