local head, headMotor6d, nameTagOverride, head_2, headMotor6d_2, nameTagOverride_2, weld, head_3, headMotor6d_3, weld_2, torso, torsoMotor6d, torso_2, torsoMotor6d_2, weld_3, torso_3, torsoMotor6d_3, weld_4, rightArm, rightArmMotor6d, rightArm_2, rightArmMotor6d_2, weld_5, rightArm_3, rightArmMotor6d_3, weld_6, rightLeg, rightLegMotor6d, rightLeg_2, rightLegMotor6d_2, weld_7, rightLeg_3, rightLegMotor6d_3, weld_8, leftLeg, leftLegMotor6d, leftLeg_2, leftLegMotor6d_2, weld_9, leftLeg_3, leftLegMotor6d_3, weld_10, leftArm, leftArmMotor6d, leftArm_2, leftArmMotor6d_2, weld_11, leftArm_3, leftArmMotor6d_3, weld_12, gear, gearMotor6d, gear_2, gearMotor6d_2, weld_13, gear_3, gearMotor6d_3, weld_14, rootPart, weldConstraint, nameTagOverridePosition, humanoidRootPart

local creepyChord = Instance.new("Model")
creepyChord.Name = "CreepyChord"
do
	...
	do
		...
		animation.AnimationId = "rbxassetid://77094326880176"
		animation.Parent = humanoid
		local animation_2 = Instance.new("Animation")
		animation_2.AnimationId = "rbxassetid://87726545658880"
		animation_2.Parent = humanoid
		local animation_3 = Instance.new("Animation")
		animation_3.AnimationId = "rbxassetid://93549863441049"
		animation_3.Parent = humanoid
		local animation_4 = Instance.new("Animation")
		animation_4.AnimationId = "rbxassetid://112588946795480"
		animation_4.Parent = humanoid
	end
	humanoid.Parent = creepyChord
	...
	head.TextureID = "rbxassetid://74568408102563"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-49.3931, 6.3696, 86.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		head_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://71685262146742", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		head_2.TextureID = "rbxassetid://74568408102563"
		head_2.Name = "Head"
		...
		head_2.CFrame = CFrame.new(Vector3.new(-49.3931, 6.3696, 86.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			bubbleChat_2.CFrame = CFrame.new(Vector3.yAxis * 0.5)
			do
			...
			stickerOverride_2.CFrame = CFrame.new(Vector3.yAxis * 0.624)
			stickerOverride_2.Parent = head_2
			weld = Instance.new("Weld")
			weld.Parent = head_2
			head_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://124387623319348", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			head_3.TextureID = "rbxassetid://133213755993813"
			head_3.Name = "Head"
			head_3.CanCollide = false
			head_3.CanTouch = false
			head_3.Massless = true
			head_3.CanQuery = false
			head_3.Size = Vector3.new(2.3001, 2.4084, 2.422)
			head_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			head_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			head_3.CFrame = CFrame.new(Vector3.new(-49.3931, 6.3696, 86.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			head_3.PivotOffset = CFrame.new(Vector3.new(0, -3.9215, -0.0038))
			do
				headMotor6d_3 = Instance.new("Motor6D")
				headMotor6d_3.Name = "HeadMotor6D"
				headMotor6d_3.MaxVelocity = 0.1
				headMotor6d_3.C0 = CFrame.new(Vector3.new(0, 3.9214, 0.0037))
	...
	torso.TextureID = "rbxassetid://74568408102563"
	torso.Name = "Torso"
	...
	torso.CFrame = CFrame.new(Vector3.new(-49.4938, 4.6627, 86.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		torso_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://93910691618033", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		torso_2.TextureID = "rbxassetid://74568408102563"
		torso_2.Name = "Torso"
		...
		torso_2.CFrame = CFrame.new(Vector3.new(-49.4938, 4.6627, 86.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			torso_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://119381448073254", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			torso_3.TextureID = "rbxassetid://133213755993813"
			torso_3.Name = "Torso"
			torso_3.Massless = true
			torso_3.CanTouch = false
			torso_3.CanQuery = false
			torso_3.Size = Vector3.new(1.0768, 1.5158, 0.9401)
			torso_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			torso_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			torso_3.CFrame = CFrame.new(Vector3.new(-49.4938, 4.6627, 86.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			torso_3.PivotOffset = CFrame.new(Vector3.new(-0.0383, -2.2146, 0.0514))
			do
				torsoMotor6d_3 = Instance.new("Motor6D")
				torsoMotor6d_3.Name = "TorsoMotor6D"
				torsoMotor6d_3.MaxVelocity = 0.1
				torsoMotor6d_3.C0 = CFrame.new(Vector3.new(0.0382, 2.2145, -0.0515))
	...
	rightArm.TextureID = "rbxassetid://74568408102563"
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-49.3885, 5.1637, 87.6379)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://101643467187530", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightArm_2.TextureID = "rbxassetid://74568408102563"
		...
		rightArm_2.CFrame = CFrame.new(Vector3.new(-49.3885, 5.1637, 87.6379)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			rightArm_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://94263288674317", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			rightArm_3.TextureID = "rbxassetid://133213755993813"
			...
			rightArm_3.Size = Vector3.new(1.8869, 0.6363, 0.3578)
			rightArm_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			rightArm_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			rightArm_3.CFrame = CFrame.new(Vector3.new(-49.3885, 5.1637, 87.6379)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			rightArm_3.PivotOffset = CFrame.new(Vector3.new(-1.2315, -2.7156, 0.0008))
			do
				rightArmMotor6d_3 = Instance.new("Motor6D")
				rightArmMotor6d_3.Name = "RightArmMotor6D"
				rightArmMotor6d_3.MaxVelocity = 0.1
				rightArmMotor6d_3.C0 = CFrame.new(Vector3.new(1.2314, 2.7155, -0.0009))
	...
	rightLeg.TextureID = "rbxassetid://74568408102563"
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-49.2376, 3.3214, 86.6321)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://80686582374706", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightLeg_2.TextureID = "rbxassetid://74568408102563"
		...
		rightLeg_2.CFrame = CFrame.new(Vector3.new(-49.2376, 3.3214, 86.6321)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			rightLeg_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://74422227483890", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			rightLeg_3.TextureID = "rbxassetid://133213755993813"
			...
			rightLeg_3.Size = Vector3.new(0.4212, 1.7133, 0.6126)
			rightLeg_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			rightLeg_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			rightLeg_3.CFrame = CFrame.new(Vector3.new(-49.2376, 3.3214, 86.6321)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			rightLeg_3.PivotOffset = CFrame.new(Vector3.new(-0.2258, -0.8733, 0.1474))
			do
				rightLegMotor6d_3 = Instance.new("Motor6D")
				rightLegMotor6d_3.Name = "RightLegMotor6D"
				rightLegMotor6d_3.MaxVelocity = 0.1
				rightLegMotor6d_3.C0 = CFrame.new(Vector3.new(0.2257, 0.8732, -0.1475))
	...
	leftLeg.TextureID = "rbxassetid://74568408102563"
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-49.2376, 3.3214, 86.1807)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://84919834155918", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftLeg_2.TextureID = "rbxassetid://74568408102563"
		...
		leftLeg_2.CFrame = CFrame.new(Vector3.new(-49.2376, 3.3214, 86.1807)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			weld_9.Parent = leftLeg_2
			leftLeg_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://132270888350195", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			leftLeg_3.TextureID = "rbxassetid://133213755993813"
			leftLeg_3.Name = "LeftLeg"
			leftLeg_3.CanCollide = false
			leftLeg_3.CanTouch = false
			leftLeg_3.Massless = true
			leftLeg_3.CanQuery = false
			leftLeg_3.Size = Vector3.new(0.4212, 1.7133, 0.6126)
			leftLeg_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			leftLeg_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			leftLeg_3.CFrame = CFrame.new(Vector3.new(-49.2376, 3.3214, 86.1807)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			leftLeg_3.PivotOffset = CFrame.new(Vector3.new(0.2257, -0.8733, 0.1474))
			do
				leftLegMotor6d_3 = Instance.new("Motor6D")
				leftLegMotor6d_3.Name = "LeftLegMotor6D"
				leftLegMotor6d_3.MaxVelocity = 0.1
				leftLegMotor6d_3.C0 = CFrame.new(Vector3.new(-0.2258, 0.8732, -0.1475))
				leftLegMotor6d_3.Parent = leftLeg_3
				weld_10 = Instance.new("Weld")
				weld_10.Parent = leftLeg_3
			end
			leftLeg_3.Parent = leftLeg_2
		end
		leftLeg_2.Parent = leftLeg
	end
	leftLeg.Parent = creepyChord
	...
	leftArm.TextureID = "rbxassetid://74568408102563"
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-49.3885, 5.1637, 85.1749)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://110887530381412", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftArm_2.TextureID = "rbxassetid://74568408102563"
		...
		leftArm_2.CFrame = CFrame.new(Vector3.new(-49.3885, 5.1637, 85.1749)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			leftArm_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://113366053097361", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			leftArm_3.TextureID = "rbxassetid://133213755993813"
			leftArm_3.Name = "LeftArm"
			leftArm_3.CanCollide = false
			leftArm_3.CanTouch = false
			leftArm_3.Massless = true
			leftArm_3.CanQuery = false
			leftArm_3.Size = Vector3.new(1.8869, 0.6363, 0.3578)
			leftArm_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			leftArm_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			leftArm_3.CFrame = CFrame.new(Vector3.new(-49.3885, 5.1637, 85.1749)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			leftArm_3.PivotOffset = CFrame.new(Vector3.new(1.2314, -2.7156, 0.0008))
			do
				leftArmMotor6d_3 = Instance.new("Motor6D")
				leftArmMotor6d_3.Name = "LeftArmMotor6D"
				leftArmMotor6d_3.MaxVelocity = 0.1
				leftArmMotor6d_3.C0 = CFrame.new(Vector3.new(-1.2315, 2.7155, -0.0009))
	...
	gear.TextureID = "rbxassetid://74568408102563"
	gear.Name = "Gear"
	...
	gear.CFrame = CFrame.new(Vector3.new(-50.9332, 6.2829, 86.4016)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		gear_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://88307545388637", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		gear_2.TextureID = "rbxassetid://74568408102563"
		gear_2.Name = "Gear"
		gear_2.Transparency = 1
		gear_2.CanCollide = false
		gear_2.CanTouch = false
		gear_2.CanQuery = false
		gear_2.Size = Vector3.new(0.1641, 1.5481, 1.6172)
		gear_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		gear_2.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
		gear_2.CFrame = CFrame.new(Vector3.new(-50.9332, 6.2829, 86.4016)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			weld_13.Parent = gear_2
			gear_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://82782015908795", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
			gear_3.TextureID = "rbxassetid://133213755993813"
			gear_3.Name = "Gear"
			gear_3.CanCollide = false
			gear_3.CanTouch = false
			gear_3.Massless = true
			gear_3.CanQuery = false
			gear_3.Size = Vector3.new(0.1641, 1.5481, 1.6172)
			gear_3.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
			gear_3.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
			gear_3.CFrame = CFrame.new(Vector3.new(-50.9332, 6.2829, 86.4016)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
			gear_3.PivotOffset = CFrame.new(Vector3.new(0.0047, -3.8348, -1.5439))
			do
				gearMotor6d_3 = Instance.new("Motor6D")
				gearMotor6d_3.Name = "GearMotor6D"
				gearMotor6d_3.MaxVelocity = 0.1
				gearMotor6d_3.C0 = CFrame.new(Vector3.new(-0.0048, -0.0868, 1.5401))
				gearMotor6d_3.Parent = gear_3
				weld_14 = Instance.new("Weld")
				weld_14.Parent = gear_3
			end
			gear_3.Parent = gear_2
		end
		gear_2.Parent = gear
	end
	gear.Parent = creepyChord
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-49.3893, 2.4481, 86.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		do
			...
			torso_4.CFrame = CFrame.new(Vector3.new(-0.2776, 0.0133, 0)) * CFrame.fromEulerAnglesXYZ(0, 0, math.rad(-3.5567))
			do
				...
				do
					...
					lArm.CFrame = CFrame.new(Vector3.new(-0.2229, 0.0086, 0.3894)) * CFrame.fromEulerAnglesXYZ(math.rad(-90.0013), math.rad(2.4521), math.rad(90.0012))
					do
					...
					rArm.CFrame = CFrame.new(Vector3.new(-0.2229, 0.0086, -0.389)) * CFrame.fromEulerAnglesXYZ(math.rad(90.0012), math.rad(-2.4522), math.rad(90.0012))
					do
					...
					rArm.Parent = chest
					local scarfJnt1 = Instance.new("Bone")
					scarfJnt1.Name = "scarf_jnt1"
					scarfJnt1.SecondaryAxis = Vector3.new(-0.9991, 0.0427, 0)
					scarfJnt1.Axis = Vector3.new(0, 0, -1)
					scarfJnt1.CFrame = CFrame.new(Vector3.new(-0.2509, -0.3946, -0.2492)) * CFrame.fromEulerAnglesXYZ(math.rad(-90.0013), math.rad(2.4521), math.rad(90.0012))
					do
						local scarfJnt2 = Instance.new("Bone")
						scarfJnt2.Name = "scarf_jnt2"
						scarfJnt2.CFrame = CFrame.new(Vector3.new(0.0467, -0.3385, -0.0012))
						do
							local scarfJnt3 = Instance.new("Bone")
							scarfJnt3.Name = "scarf_jnt3"
							scarfJnt3.CFrame = CFrame.new(Vector3.new(0.0973, -0.2918, -0.0245))
							scarfJnt3.Parent = scarfJnt2
						end
						scarfJnt2.Parent = scarfJnt1
					end
					scarfJnt1.Parent = chest
				end
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-49.3893, 2.4481, 86.4064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = creepyChord
end

creepyChord.PrimaryPart = humanoidRootPart
...
weld_9.Part1 = leftLeg
weld_9.Part0 = leftLeg_2
leftLegMotor6d_3.Part1 = leftLeg_3
weld_10.Part1 = leftLeg_2
weld_10.Part0 = leftLeg_3
...
weld_13.Part1 = gear
weld_13.Part0 = gear_2
gearMotor6d_3.Part0 = head_3
gearMotor6d_3.Part1 = gear_3
weld_14.Part1 = gear_2
weld_14.Part0 = gear_3
