...
local soulvester = Instance.new("Model")
soulvester.Name = "Soulvester"
soulvester.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	passiveAbility.Parent = soulvester
	...
	do
		...
		normalTexture.Texture = "rbxassetid://120951590747167"
		normalTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://139247579884344"
		hurtTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://70757933392883"
		blinkTexture.Parent = config
	end
	config.Parent = soulvester
	...
	humanoid.Parent = soulvester
	local animations = Instance.new("Configuration")
	animations.Name = "Animations"
	do
		local run = Instance.new("Animation")
		run.Name = "Run"
		run.AnimationId = "rbxassetid://91028079804968"
		run.Parent = animations
		local walk = Instance.new("Animation")
		walk.Name = "Walk"
		walk.AnimationId = "rbxassetid://83051123680745"
		walk.Parent = animations
		local idle = Instance.new("Animation")
		idle.Name = "Idle"
		idle.AnimationId = "rbxassetid://101764467881665"
		idle.Parent = animations
		local quirk = Instance.new("Animation")
		quirk.Name = "Quirk"
		quirk.AnimationId = "rbxassetid://112190441330104"
		quirk.Parent = animations
		local decode = Instance.new("Animation")
		decode.Name = "Decode"
		decode.AnimationId = "rbxassetid://75924382247509"
		decode.Parent = animations
	end
	animations.Parent = soulvester
	local toonName = Instance.new("StringValue")
	toonName.Name = "ToonName"
	toonName.Value = "Soulvester"
	toonName.Parent = soulvester
	...
	torso.TextureID = "rbxassetid://137820211074740"
	torso.Name = "Torso"
	torso.Massless = true
	...
	torso.CFrame = CFrame.new(Vector3.new(-40.3665, 5.1075, -71.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-40.3136, 5.4388, -69.5565)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-40.3136, 5.4388, -72.6307)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-40.229, 3.5422, -70.8812)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-40.229, 3.5422, -71.306)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	head.TextureID = "rbxassetid://137820211074740"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-41.3299, 9.2019, -71.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	main.CFrame = CFrame.new(Vector3.new(-39.4822, 7.7468, -71.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	cover.CFrame = CFrame.new(Vector3.new(-39.2341, 7.8475, -71.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 2.4481, -71.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 2.4481, -71.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = soulvester
end

soulvester.PrimaryPart = humanoidRootPart
