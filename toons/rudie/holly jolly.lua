...
do
	...
	humanoid.Parent = hollyJollyRudie
	local animSaves = Instance.new("ObjectValue")
	animSaves.Name = "AnimSaves"
	animSaves.Parent = hollyJollyRudie
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://119387049952357"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://80307347391509"
		hurtTexture.Parent = config
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://96516093645594"
	...
	leftHand.CFrame = CFrame.new(Vector3.new(-53.8942, 3.4615, -52.5663)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftHand_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://122876221277940", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftHand_2.TextureID = "rbxassetid://96516093645594"
		...
		leftHand_2.CFrame = CFrame.new(Vector3.new(-53.8942, 3.4615, -52.5663)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftHand.Parent = hollyJollyRudie
	...
	tail.CFrame = CFrame.new(Vector3.new(-54.9921, 2.3057, -50.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		tail_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://75634690616029", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		tail_2.TextureID = "rbxassetid://96516093645594"
		...
		tail_2.CFrame = CFrame.new(Vector3.new(-54.9921, 2.3057, -50.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerArm.CFrame = CFrame.new(Vector3.new(-53.8942, 3.4615, -49.1731)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightLowerArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://125018213338577", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightLowerArm_2.TextureID = "rbxassetid://96516093645594"
		...
		rightLowerArm_2.CFrame = CFrame.new(Vector3.new(-53.8942, 3.4615, -49.1731)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerArm.Parent = hollyJollyRudie
	...
	head.TextureID = "rbxassetid://96516093645594"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-53.7402, 5.3963, -50.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		head_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://78067571013172", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		head_2.TextureID = "rbxassetid://96516093645594"
		...
		head_2.CFrame = CFrame.new(Vector3.new(-53.7402, 5.3963, -50.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			weld_4.Parent = head_2
		end
		head_2.Parent = head
		nose = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://92769319902602", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		nose.TextureID = "rbxassetid://96516093645594"
		...
		nose.CFrame = CFrame.new(Vector3.new(-53.7402, 5.3963, -50.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightUpperArm.CFrame = CFrame.new(Vector3.new(-53.8942, 3.461, -49.7875)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightUpperArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://72971625927362", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightUpperArm_2.TextureID = "rbxassetid://96516093645594"
		...
		rightUpperArm_2.CFrame = CFrame.new(Vector3.new(-53.8942, 3.461, -49.7875)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightUpperArm.Parent = hollyJollyRudie
	...
	rightHand.CFrame = CFrame.new(Vector3.new(-53.8942, 3.4615, -48.6209)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightHand_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://92392419477804", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightHand_2.TextureID = "rbxassetid://96516093645594"
		...
		rightHand_2.CFrame = CFrame.new(Vector3.new(-53.8942, 3.4615, -48.6209)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightHand.Parent = hollyJollyRudie
	...
	leftLowerArm.CFrame = CFrame.new(Vector3.new(-53.8942, 3.4615, -52.0141)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftLowerArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://120828627998977", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftLowerArm_2.TextureID = "rbxassetid://96516093645594"
		...
		leftLowerArm_2.CFrame = CFrame.new(Vector3.new(-53.8942, 3.4615, -52.0141)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerArm.Parent = hollyJollyRudie
	...
	leftUpperArm.CFrame = CFrame.new(Vector3.new(-53.8942, 3.461, -51.3997)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftUpperArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://83306717926836", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftUpperArm_2.TextureID = "rbxassetid://96516093645594"
		...
		leftUpperArm_2.CFrame = CFrame.new(Vector3.new(-53.8942, 3.461, -51.3997)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftUpperArm.Parent = hollyJollyRudie
	...
	leftFoot.CFrame = CFrame.new(Vector3.new(-53.8482, 0.6497, -50.9857)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftFoot_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://108191196948643", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftFoot_2.TextureID = "rbxassetid://96516093645594"
		...
		leftFoot_2.CFrame = CFrame.new(Vector3.new(-53.8482, 0.6497, -50.9857)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftFoot.Parent = hollyJollyRudie
	...
	leftUpperLeg.CFrame = CFrame.new(Vector3.new(-53.8637, 2.0225, -50.9741)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftUpperLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://121184103816124", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftUpperLeg_2.TextureID = "rbxassetid://96516093645594"
		...
		leftUpperLeg_2.CFrame = CFrame.new(Vector3.new(-53.8637, 2.0225, -50.9741)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftUpperLeg.Parent = hollyJollyRudie
	...
	leftMiddleLeg.CFrame = CFrame.new(Vector3.new(-53.9583, 1.4628, -50.9596)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftMiddleLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://90195585307105", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftMiddleLeg_2.TextureID = "rbxassetid://96516093645594"
		...
		leftMiddleLeg_2.CFrame = CFrame.new(Vector3.new(-53.9583, 1.4628, -50.9596)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftMiddleLeg.Parent = hollyJollyRudie
	...
	leftLowerLeg.CFrame = CFrame.new(Vector3.new(-53.9793, 1.0382, -50.9634)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftLowerLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://120848470037010", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftLowerLeg_2.TextureID = "rbxassetid://96516093645594"
		...
		leftLowerLeg_2.CFrame = CFrame.new(Vector3.new(-53.9793, 1.0382, -50.9634)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLowerLeg.Parent = hollyJollyRudie
	...
	rightFoot.CFrame = CFrame.new(Vector3.new(-53.8482, 0.6497, -50.2015)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightFoot_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://104127043764059", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightFoot_2.TextureID = "rbxassetid://96516093645594"
		...
		rightFoot_2.CFrame = CFrame.new(Vector3.new(-53.8482, 0.6497, -50.2015)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightFoot.Parent = hollyJollyRudie
	...
	rightUpperLeg.CFrame = CFrame.new(Vector3.new(-53.8637, 2.0225, -50.2131)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightUpperLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://97622741158547", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightUpperLeg_2.TextureID = "rbxassetid://96516093645594"
		...
		rightUpperLeg_2.CFrame = CFrame.new(Vector3.new(-53.8637, 2.0225, -50.2131)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightUpperLeg.Parent = hollyJollyRudie
	...
	rightMiddleLeg.CFrame = CFrame.new(Vector3.new(-53.9583, 1.4628, -50.2276)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightMiddleLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://116884821915908", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightMiddleLeg_2.TextureID = "rbxassetid://96516093645594"
		...
		rightMiddleLeg_2.CFrame = CFrame.new(Vector3.new(-53.9583, 1.4628, -50.2276)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightMiddleLeg.Parent = hollyJollyRudie
	...
	rightLowerLeg.CFrame = CFrame.new(Vector3.new(-53.9793, 1.0382, -50.2238)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightLowerLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://137237005733698", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightLowerLeg_2.TextureID = "rbxassetid://96516093645594"
		...
		rightLowerLeg_2.CFrame = CFrame.new(Vector3.new(-53.9793, 1.0382, -50.2238)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLowerLeg.Parent = hollyJollyRudie
	...
	torso.CFrame = CFrame.new(Vector3.new(-53.8894, 3.0505, -50.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		torso_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://101742525075346", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		torso_2.TextureID = "rbxassetid://96516093645594"
		...
		torso_2.Size = Vector3.new(1.4186, 1.679, 1.2658)
		torso_2.CFrame = CFrame.new(Vector3.new(-53.8894, 3.0505, -50.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		torso_2.PivotOffset = CFrame.new(Vector3.new(0.0124, 0.002, -0.0041))
		do
			torsoMotor6d_2 = Instance.new("Motor6D")
			torsoMotor6d_2.Name = "TorsoMotor6D"
			torsoMotor6d_2.MaxVelocity = 0.1
			torsoMotor6d_2.C0 = CFrame.new(Vector3.new(-0.0125, 2.5278, 0.004))
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-53.8894, 1.9481, -50.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		do
			...
			do
				...
				do
					...
					scarf1Jnt.CFrame = CFrame.new(Vector3.new(-0.3515, 0.3014, 0.3521)) * CFrame.fromEulerAnglesXYZ(math.rad(-89.9988), math.rad(2.4521), math.rad(89.9987))
					do
						local scarf2Jnt = Instance.new("Bone")
						scarf2Jnt.Name = "scarf2_jnt"
						scarf2Jnt.CFrame = CFrame.new(Vector3.new(-0.1111, -0.5092, 0.0816))
			...
			rLeg.CFrame = CFrame.new(Vector3.new(-0.2988, 0.0165, -0.34)) * CFrame.fromEulerAnglesXYZ(math.rad(4.2728), math.rad(-0.3108), math.rad(171.2873))
			do
	...
	rootPart.Parent = hollyJollyRudie
	...
	stats.Parent = hollyJollyRudie
end

hollyJollyRudie.PrimaryPart = humanoidRootPart
