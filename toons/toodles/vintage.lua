...
local vintageToodles = Instance.new("Model")
vintageToodles.Name = "VintageToodles"
vintageToodles.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	animations.Parent = vintageToodles
	...
	head.TextureID = "rbxassetid://104112028738711"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-53.3893, 5.3155, -97.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.TextureID = "rbxassetid://104112028738711"
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-53.4726, 3.9486, -98.6002)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.TextureID = "rbxassetid://104112028738711"
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-53.2686, 2.5704, -97.7783)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.TextureID = "rbxassetid://104112028738711"
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-53.4726, 3.9486, -96.587)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.Parent = vintageToodles
	...
	rightLeg.TextureID = "rbxassetid://104112028738711"
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-53.2686, 2.5704, -97.4089)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.Parent = vintageToodles
	...
	torso.TextureID = "rbxassetid://104112028738711"
	torso.Name = "Torso"
	torso.Massless = true
	...
	torso.CFrame = CFrame.new(Vector3.new(-53.3817, 3.569, -97.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-53.3893, 1.9481, -97.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = vintageToodles
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-53.3893, 1.9481, -97.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = vintageToodles
end

vintageToodles.PrimaryPart = humanoidRootPart
