local head, headMotor6d, barnabyGeo, barnabyGeoMotor6d, leftArm, leftArmMotor6d, leftLeg, leftLegMotor6d, rightArm, rightArmMotor6d, rightLeg, rightLegMotor6d, torso, torsoMotor6d, rootPart, weldConstraint, humanoidRootPart

local finn = Instance.new("Model")
finn.Name = "Finn"
finn.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	local particleOnMove = Instance.new("Script")
	particleOnMove.Name = "ParticleOnMove"
	particleOnMove.Parent = finn
	local animations = Instance.new("Configuration")
	animations.Name = "Animations"
	do
		local run = Instance.new("Animation")
		run.Name = "Run"
		run.AnimationId = "rbxassetid://90436581661775"
		run.Parent = animations
		local walk = Instance.new("Animation")
		walk.Name = "Walk"
		walk.AnimationId = "rbxassetid://112448443680093"
		walk.Parent = animations
		local idle = Instance.new("Animation")
		idle.Name = "Idle"
		idle.AnimationId = "rbxassetid://120958423441835"
		idle.Parent = animations
		local quirk = Instance.new("Animation")
		quirk.Name = "Quirk"
		quirk.AnimationId = "rbxassetid://133665754361237"
		quirk.Parent = animations
		local decode = Instance.new("Animation")
		decode.Name = "Decode"
		decode.AnimationId = "rbxassetid://99440989798406"
		decode.Parent = animations
	end
	animations.Parent = finn
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://101160981749703"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://114425771963148"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://134244442209600"
	...
	head.TextureID = "rbxassetid://101160981749703"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-40.3861, 3.9988, 26.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	barnabyGeo.TextureID = "rbxassetid://129306656425043"
	...
	barnabyGeo.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
	barnabyGeo.CFrame = CFrame.new(Vector3.new(-40.3893, 4.012, 26.8645)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.TextureID = "rbxassetid://101160981749703"
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-40.381, 2.7445, 25.6574)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.TextureID = "rbxassetid://101160981749703"
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-40.243, 0.9755, 26.6775)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.TextureID = "rbxassetid://101160981749703"
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-40.381, 2.7445, 28.1554)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.TextureID = "rbxassetid://101160981749703"
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-40.243, 0.9755, 27.1353)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	torso.TextureID = "rbxassetid://101160981749703"
	torso.Name = "Torso"
	torso.Massless = true
	...
	torso.CFrame = CFrame.new(Vector3.new(-40.3811, 2.2799, 26.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 0.0712, 26.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 1.9481, 26.9064)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = finn
end

finn.PrimaryPart = humanoidRootPart
