...
local pebbleEgged = Instance.new("Model")
pebbleEgged.Name = "PebbleEgged"
do
	...
	humanoid.Parent = pebbleEgged
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://130115122284987"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://109119769897100"
		hurtTexture.Parent = config
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://100887598303838"
	...
	frontRightLeg.TextureID = "rbxassetid://100887598303838"
	...
	frontRightLeg.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
	frontRightLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	frontRightLeg.CFrame = CFrame.new(Vector3.new(-62.0426, 2.365, -23.795)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		frontRightLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://79647279316314", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		frontRightLeg_2.TextureID = "rbxassetid://100887598303838"
		frontRightLeg_2.Name = "FrontRightLeg"
		frontRightLeg_2.CanQuery = false
		frontRightLeg_2.CanTouch = false
		frontRightLeg_2.EnableFluidForces = false
		frontRightLeg_2.Massless = true
		frontRightLeg_2.CanCollide = false
		frontRightLeg_2.Size = Vector3.new(0.6183, 0.8284, 0.6373)
		frontRightLeg_2.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
		frontRightLeg_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		frontRightLeg_2.CFrame = CFrame.new(Vector3.new(-62.0426, 2.365, -23.795)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		frontRightLeg_2.PivotOffset = CFrame.new(Vector3.new(0, 0.1563, 0))
		do
	...
	frontRightLeg.Parent = pebbleEgged
	...
	frontLeftLeg.TextureID = "rbxassetid://100887598303838"
	...
	frontLeftLeg.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
	frontLeftLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	frontLeftLeg.CFrame = CFrame.new(Vector3.new(-62.0592, 2.3751, -25.3957)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		frontLeftLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://83135702563389", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		frontLeftLeg_2.TextureID = "rbxassetid://100887598303838"
		frontLeftLeg_2.Name = "FrontLeftLeg"
		frontLeftLeg_2.CanQuery = false
		frontLeftLeg_2.CanTouch = false
		frontLeftLeg_2.EnableFluidForces = false
		frontLeftLeg_2.Massless = true
		frontLeftLeg_2.CanCollide = false
		frontLeftLeg_2.Size = Vector3.new(0.6112, 0.8484, 0.604)
		frontLeftLeg_2.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
		frontLeftLeg_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		frontLeftLeg_2.CFrame = CFrame.new(Vector3.new(-62.0592, 2.3751, -25.3957)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		frontLeftLeg_2.PivotOffset = CFrame.new(Vector3.yAxis * 0.1563)
		do
	...
	frontLeftLeg.Parent = pebbleEgged
	...
	tail.TextureID = "rbxassetid://100887598303838"
	tail.Name = "Tail"
	tail.Transparency = 1
	tail.CanQuery = false
	tail.CanTouch = false
	...
	tail.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
	tail.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	tail.CFrame = CFrame.new(Vector3.new(-64.6055, 3.1784, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		tail_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://97603967738349", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		tail_2.TextureID = "rbxassetid://100887598303838"
		tail_2.Name = "Tail"
		...
		tail_2.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
		tail_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		tail_2.CFrame = CFrame.new(Vector3.new(-64.6055, 3.1784, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	backLeftLeg.TextureID = "rbxassetid://100887598303838"
	...
	backLeftLeg.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
	backLeftLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	backLeftLeg.CFrame = CFrame.new(Vector3.new(-63.5057, 2.3801, -25.3828)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		backLeftLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://104207462529071", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		backLeftLeg_2.TextureID = "rbxassetid://100887598303838"
		backLeftLeg_2.Name = "BackLeftLeg"
		backLeftLeg_2.CanQuery = false
		backLeftLeg_2.CanTouch = false
		backLeftLeg_2.EnableFluidForces = false
		backLeftLeg_2.Massless = true
		backLeftLeg_2.CanCollide = false
		backLeftLeg_2.Size = Vector3.new(0.5997, 0.8584, 0.6373)
		backLeftLeg_2.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
		backLeftLeg_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		backLeftLeg_2.CFrame = CFrame.new(Vector3.new(-63.5057, 2.3801, -25.3828)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		backLeftLeg_2.PivotOffset = CFrame.new(Vector3.new(0, 0.1563, 0))
		do
	...
	backLeftLeg.Parent = pebbleEgged
	...
	backRightLeg.TextureID = "rbxassetid://100887598303838"
	...
	backRightLeg.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
	backRightLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	backRightLeg.CFrame = CFrame.new(Vector3.new(-63.4984, 2.3801, -23.8043)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		backRightLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://113220531769153", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		backRightLeg_2.TextureID = "rbxassetid://100887598303838"
		backRightLeg_2.Name = "BackRightLeg"
		backRightLeg_2.CanQuery = false
		backRightLeg_2.CanTouch = false
		backRightLeg_2.EnableFluidForces = false
		backRightLeg_2.Massless = true
		backRightLeg_2.CanCollide = false
		backRightLeg_2.Size = Vector3.new(0.5997, 0.8584, 0.6154)
		backRightLeg_2.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
		backRightLeg_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		backRightLeg_2.CFrame = CFrame.new(Vector3.new(-63.4984, 2.3801, -23.8043)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		backRightLeg_2.PivotOffset = CFrame.new(Vector3.yAxis * 0.1563)
		do
	...
	backRightLeg.Parent = pebbleEgged
	...
	mainBody.TextureID = "rbxassetid://100887598303838"
	...
	mainBody.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
	mainBody.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	mainBody.CFrame = CFrame.new(Vector3.new(-62.7517, 3.1542, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		mainBody_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://125122107918859", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		mainBody_2.TextureID = "rbxassetid://100887598303838"
		mainBody_2.Name = "MainBody"
		mainBody_2.CanQuery = false
		mainBody_2.CanTouch = false
		mainBody_2.EnableFluidForces = false
		mainBody_2.Massless = true
		mainBody_2.CanCollide = false
		mainBody_2.Size = Vector3.new(3.2178, 1.9596, 4.1611)
		mainBody_2.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
		mainBody_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		mainBody_2.CFrame = CFrame.new(Vector3.new(-62.7517, 3.1542, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		mainBody_2.PivotOffset = CFrame.new(Vector3.new(0.2343, -0.5331, -0.462))
		do
			mainBodyMotor6d_2 = Instance.new("Motor6D")
			mainBodyMotor6d_2.Name = "MainBodyMotor6D"
			mainBodyMotor6d_2.MaxVelocity = 0.1
			mainBodyMotor6d_2.C0 = CFrame.new(Vector3.new(-0.2344, 1.533, 0.4579))
	...
	rootPart.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
	rootPart.CFrame = CFrame.new(Vector3.new(-62.8893, 1.9481, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.AssemblyLinearVelocity = Vector3.new(0, -7.3568, 0)
	humanoidRootPart.CustomPhysicalProperties = PhysicalProperties.new(15, 0.3, 0.5, 1, 1, 1)
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-62.8893, 1.9481, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	humanoidRootPart.Parent = pebbleEgged
end

pebbleEgged.PrimaryPart = humanoidRootPart
eyes.Value = mainBody
