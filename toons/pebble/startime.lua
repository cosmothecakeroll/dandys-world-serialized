local eyes, frontRightLeg, frontRightLegMotor6d, frontRightLeg_2, frontRightLegMotor6d_2, weld, frontLeftLeg, frontLeftLegMotor6d, frontLeftLeg_2, frontLeftLegMotor6d_2, weld_2, tail, tailMotor6d, tail_2, tailMotor6d_2, weld_3, backLeftLeg, backLeftLegMotor6d, backLeftLeg_2, backLeftLegMotor6d_2, weld_4, backRightLeg, backRightLegMotor6d, backRightLeg_2, backRightLegMotor6d_2, weld_5, mainBody, mainBodyMotor6d, mainBody_2, mainBodyMotor6d_2, attachment, attachment2, trail, weld_6, rootPart, weld_7, humanoidRootPart, tongue, weldConstraint

local dreamPebble = Instance.new("Model")
dreamPebble.Name = "DreamPebble"
do
	local dreamPebble_2 = Instance.new("ModuleScript")
	dreamPebble_2.Name = "DreamPebble"
	dreamPebble_2.Parent = dreamPebble
	...
	frontRightLeg.TextureID = "rbxassetid://94118610964552"
	...
	frontRightLeg.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
	frontRightLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	frontRightLeg.CFrame = CFrame.new(Vector3.new(-44.0426, 2.365, -23.795)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		frontRightLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://130372069567602", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		frontRightLeg_2.TextureID = "rbxassetid://126369239528925"
		...
		frontRightLeg_2.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
		frontRightLeg_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		frontRightLeg_2.CFrame = CFrame.new(Vector3.new(-44.0426, 2.365, -23.795)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		do
			...
			frontRightLegMotor6d_2.C0 = CFrame.new(Vector3.new(0.7986, 0.4168, -0.8529))
	...
	frontRightLeg.Parent = dreamPebble
	...
	frontLeftLeg.TextureID = "rbxassetid://94118610964552"
	...
	frontLeftLeg.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
	frontLeftLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	frontLeftLeg.CFrame = CFrame.new(Vector3.new(-44.0592, 2.3751, -25.3957)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		frontLeftLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://88505736061090", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		frontLeftLeg_2.TextureID = "rbxassetid://126369239528925"
		...
		frontLeftLeg_2.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
		frontLeftLeg_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		frontLeftLeg_2.CFrame = CFrame.new(Vector3.new(-44.0592, 2.3751, -25.3957)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		frontLeftLeg_2.PivotOffset = CFrame.identity
		do
			...
			frontLeftLegMotor6d_2.C0 = CFrame.new(Vector3.new(-0.8022, 0.4269, -0.8362))
	...
	frontLeftLeg.Parent = dreamPebble
	...
	tail.TextureID = "rbxassetid://94118610964552"
	tail.Name = "Tail"
	tail.Transparency = 1
	tail.CanQuery = false
	tail.CanTouch = false
	...
	tail.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
	tail.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	tail.CFrame = CFrame.new(Vector3.new(-46.6055, 3.1784, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		tail_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://86499619541694", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		tail_2.TextureID = "rbxassetid://126369239528925"
		tail_2.Name = "Tail"
		...
		tail_2.Size = Vector3.new(1.7698, 1.3513, 1.6876)
		tail_2.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
		tail_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		tail_2.CFrame = CFrame.new(Vector3.new(-46.6055, 3.1784, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		tail_2.PivotOffset = CFrame.new(Vector3.new(0, 0.0047, -0.0706))
		do
			tailMotor6d_2 = Instance.new("Motor6D")
			tailMotor6d_2.Name = "TailMotor6D"
			tailMotor6d_2.MaxVelocity = 0.1
			tailMotor6d_2.C0 = CFrame.new(Vector3.new(0, 1.2866, 1.7806))
	...
	backLeftLeg.TextureID = "rbxassetid://94118610964552"
	...
	backLeftLeg.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
	backLeftLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	backLeftLeg.CFrame = CFrame.new(Vector3.new(-45.5057, 2.3801, -25.3828)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		backLeftLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://121908447540527", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		backLeftLeg_2.TextureID = "rbxassetid://126369239528925"
		...
		backLeftLeg_2.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
		backLeftLeg_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		backLeftLeg_2.CFrame = CFrame.new(Vector3.new(-45.5057, 2.3801, -25.3828)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		backLeftLeg_2.PivotOffset = CFrame.identity
		do
			...
			backLeftLegMotor6d_2.C0 = CFrame.new(Vector3.new(-0.7893, 0.4319, 0.6103))
	...
	backLeftLeg.Parent = dreamPebble
	...
	backRightLeg.TextureID = "rbxassetid://94118610964552"
	...
	backRightLeg.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
	backRightLeg.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	backRightLeg.CFrame = CFrame.new(Vector3.new(-45.4984, 2.3801, -23.8043)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		backRightLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://109937841382326", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		backRightLeg_2.TextureID = "rbxassetid://126369239528925"
		...
		backRightLeg_2.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
		backRightLeg_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		backRightLeg_2.CFrame = CFrame.new(Vector3.new(-45.4984, 2.3801, -23.8043)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		backRightLeg_2.PivotOffset = CFrame.identity
		do
			...
			backRightLegMotor6d_2.C0 = CFrame.new(Vector3.new(0.7892, 0.4319, 0.6029))
	...
	backRightLeg.Parent = dreamPebble
	...
	mainBody.TextureID = "rbxassetid://94118610964552"
	...
	mainBody.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
	mainBody.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	mainBody.CFrame = CFrame.new(Vector3.new(-44.7517, 3.1542, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		mainBody_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://113553274136591", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		mainBody_2.TextureID = "rbxassetid://94118610964552"
		...
		mainBody_2.Size = Vector3.new(3, 2.1385, 2.9703)
		mainBody_2.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
		mainBody_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		mainBody_2.CFrame = CFrame.new(Vector3.new(-44.7517, 3.1542, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		...
		do
			...
			mainBodyMotor6d_2.C0 = CFrame.new(Vector3.new(0, 1.5186, -0.1437))
			mainBodyMotor6d_2.Parent = mainBody_2
			attachment = Instance.new("Attachment")
			attachment.CFrame = CFrame.new(Vector3.new(-1.2308, -3.4876, 0.166))
			attachment.Parent = mainBody_2
			attachment2 = Instance.new("Attachment")
			attachment2.Name = "Attachment2"
			attachment2.CFrame = CFrame.new(Vector3.new(1.2187, -3.4876, 0.166))
			attachment2.Parent = mainBody_2
			...
			particleEmitter.Parent = mainBody_2
	...
	rootPart.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
	rootPart.CFrame = CFrame.new(Vector3.new(-44.8893, 1.9481, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
	humanoidRootPart.CustomPhysicalProperties = PhysicalProperties.new(15, 0.3, 0.5, 1, 1, 1)
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-44.8893, 1.9481, -24.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	humanoidRootPart.Parent = dreamPebble
	...
	tongue.TextureID = "rbxassetid://14544206089"
	tongue.Name = "Tongue"
	tongue.Transparency = 1
	tongue.CanCollide = false
	tongue.EnableFluidForces = false
	tongue.AssemblyLinearVelocity = Vector3.new(0, -8.9917, 0)
	tongue.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	tongue.Size = Vector3.new(0.3693, 0.4972, 0.3792)
	tongue.CFrame = CFrame.new(Vector3.new(-44.7519, 3.1542, -24.5937)) * CFrame.fromEulerAnglesXYZ(0, math.rad(35.0015), 0)
	do
		weldConstraint = Instance.new("WeldConstraint")
		weldConstraint.Parent = tongue
	end
	tongue.Parent = dreamPebble
end

dreamPebble.PrimaryPart = humanoidRootPart
