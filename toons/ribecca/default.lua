local head, leftLeg, leftLegMotor6d, rightArm, rightArmMotor6d, leftArm, leftArmMotor6d, rightLeg, rightLegMotor6d, torso, torsoMotor6d, headGeo, headGeoMotor6d, jacket, jacketMotor6d, rootPart, weldConstraint, humanoidRootPart

local ribecca = Instance.new("Model")
ribecca.Name = "Ribecca"
ribecca.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	...
	do
		...
		normalTexture.Texture = "rbxassetid://103355374718193"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://120868821721119"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://77660077888874"
	...
	humanoid.Parent = ribecca
	local animations = Instance.new("Configuration")
	animations.Name = "Animations"
	do
		local run = Instance.new("Animation")
		run.Name = "Run"
		run.AnimationId = "rbxassetid://106226579017069"
		run.Parent = animations
		local walk = Instance.new("Animation")
		walk.Name = "Walk"
		walk.AnimationId = "rbxassetid://112706917216715"
		walk.Parent = animations
		local idle = Instance.new("Animation")
		idle.Name = "Idle"
		idle.AnimationId = "rbxassetid://119971912262127"
		idle.Parent = animations
		local quirk = Instance.new("Animation")
		quirk.Name = "Quirk"
		quirk.AnimationId = "rbxassetid://109990274878233"
		quirk.Parent = animations
		local decode = Instance.new("Animation")
		decode.Name = "Decode"
		decode.AnimationId = "rbxassetid://132743459384111"
		decode.Parent = animations
	end
	animations.Parent = ribecca
	...
	blinkingParts.Parent = ribecca
	local toonName = Instance.new("StringValue")
	toonName.Name = "ToonName"
	toonName.Value = "Ribecca"
	toonName.Parent = ribecca
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-40.2306, 2.9089, -40.3688)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-40.3139, 4.9631, -38.6212)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-40.3139, 4.9631, -41.566)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-40.2306, 2.9089, -39.8184)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	torso.TextureID = "rbxassetid://103355374718193"
	torso.Name = "Torso"
	torso.Massless = true
	...
	torso.CFrame = CFrame.new(Vector3.new(-40.3893, 4.8938, -40.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	headGeo.CFrame = CFrame.new(Vector3.new(-40.2665, 6.4911, -40.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	jacket.CFrame = CFrame.new(Vector3.new(-40.5204, 4.7551, -40.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 1.9481, -40.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-40.3893, 1.9481, -40.0936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = ribecca
end

ribecca.PrimaryPart = humanoidRootPart
head.Value = headGeo
