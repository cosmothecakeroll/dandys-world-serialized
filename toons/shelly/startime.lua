local torso, torsoMotor6d, torso_2, torsoMotor6d_2, attachment, attachment2, trail, weld, head, headMotor6d, bubbleChat, nameTagOverride, head_2, headMotor6d_2, weld_2, leftLeg, leftLegMotor6d, leftLeg_2, leftLegMotor6d_2, weld_3, leftArm, leftArmMotor6d, leftArm_2, leftArmMotor6d_2, weld_4, rightLeg, rightLegMotor6d, rightLeg_2, rightLegMotor6d_2, weld_5, rightArm, rightArmMotor6d, rightArm_2, rightArmMotor6d_2, weld_6, rootPart, weldConstraint, humanoidRootPart

local dreamShelly = Instance.new("Model")
dreamShelly.Name = "DreamShelly"
do
	...
	do
		...
		normalTexture.Texture = "rbxassetid://74210666376037"
		normalTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://84527293798215"
		blinkTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://79073924529831"
	...
	torso.TextureID = "rbxassetid://74210666376037"
	torso.Name = "Torso"
	...
	torso.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
	torso.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
	torso.CFrame = CFrame.new(Vector3.new(-48.8736, 4.2068, -60.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		torso_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://137714616796761", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		torso_2.TextureID = "rbxassetid://99182148252850"
		torso_2.Name = "Torso"
		torso_2.Massless = true
		torso_2.CanTouch = false
		torso_2.CanQuery = false
		torso_2.Size = Vector3.new(1.045, 1.6474, 0.8468)
		torso_2.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
		torso_2.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
		torso_2.CFrame = CFrame.new(Vector3.new(-48.8736, 4.2068, -60.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		torso_2.PivotOffset = CFrame.new(Vector3.new(0, -0.0385, 0.0091))
		do
			torsoMotor6d_2 = Instance.new("Motor6D")
			torsoMotor6d_2.Name = "TorsoMotor6D"
			torsoMotor6d_2.MaxVelocity = 0.1
			torsoMotor6d_2.C0 = CFrame.new(Vector3.new(0, 2.1789, -0.0228))
			torsoMotor6d_2.Parent = torso_2
			attachment = Instance.new("Attachment")
			attachment.CFrame = CFrame.new(Vector3.new(-1.0185, -3.919, -0.1596))
			attachment.Parent = torso_2
			attachment2 = Instance.new("Attachment")
			attachment2.Name = "Attachment2"
			attachment2.CFrame = CFrame.new(Vector3.new(0.9245, -3.919, -0.1596))
	...
	head.TextureID = "rbxassetid://74210666376037"
	head.Name = "Head"
	head.Transparency = 1
	head.CanTouch = false
	head.CanQuery = false
	...
	head.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
	head.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
	head.CFrame = CFrame.new(Vector3.new(-48.8704, 5.6816, -60.7934)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
		...
		head_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://121416005691205", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		head_2.TextureID = "rbxassetid://99182148252850"
		head_2.Name = "Head"
		head_2.CanQuery = false
		head_2.CanTouch = false
		head_2.Massless = true
		head_2.CanCollide = false
		head_2.Size = Vector3.new(3.7591, 1.9803, 3.4221)
		head_2.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
		head_2.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
		head_2.CFrame = CFrame.new(Vector3.new(-48.8704, 5.6816, -60.7934)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		do
			headMotor6d_2 = Instance.new("Motor6D")
			headMotor6d_2.Name = "HeadMotor6D"
			headMotor6d_2.MaxVelocity = 0.1
			headMotor6d_2.C0 = CFrame.new(Vector3.new(-0.1998, 3.7683, -0.019))
	...
	leftLeg.TextureID = "rbxassetid://74210666376037"
	...
	leftLeg.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
	leftLeg.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
	leftLeg.CFrame = CFrame.new(Vector3.new(-48.7406, 2.8532, -60.8176)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://111606816825119", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftLeg_2.TextureID = "rbxassetid://99182148252850"
		leftLeg_2.Name = "LeftLeg"
		leftLeg_2.CanCollide = false
		leftLeg_2.CanTouch = false
		leftLeg_2.Massless = true
		leftLeg_2.CanQuery = false
		leftLeg_2.Size = Vector3.new(0.4234, 1.7733, 0.6495)
		leftLeg_2.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
		leftLeg_2.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
		leftLeg_2.CFrame = CFrame.new(Vector3.new(-48.7406, 2.8532, -60.8176)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		leftLeg_2.PivotOffset = CFrame.new(Vector3.yAxis * 0.6171)
		do
			leftLegMotor6d_2 = Instance.new("Motor6D")
			leftLegMotor6d_2.Name = "LeftLegMotor6D"
			leftLegMotor6d_2.MaxVelocity = 0.1
			leftLegMotor6d_2.C0 = CFrame.new(Vector3.new(-0.2291, 0.8962, -0.1298))
	...
	leftArm.TextureID = "rbxassetid://74210666376037"
	...
	leftArm.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
	leftArm.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
	leftArm.CFrame = CFrame.new(Vector3.new(-48.8857, 4.6109, -61.816)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://127707731253213", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftArm_2.TextureID = "rbxassetid://99182148252850"
		leftArm_2.Name = "LeftArm"
		leftArm_2.CanCollide = false
		leftArm_2.CanTouch = false
		leftArm_2.Massless = true
		leftArm_2.CanQuery = false
		leftArm_2.Size = Vector3.new(1.8703, 0.6316, 0.4899)
		leftArm_2.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
		leftArm_2.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
		leftArm_2.CFrame = CFrame.new(Vector3.new(-48.8857, 4.6109, -61.816)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		leftArm_2.PivotOffset = CFrame.new(Vector3.new(0.9005, -0.0665, 0))
		do
			leftArmMotor6d_2 = Instance.new("Motor6D")
			leftArmMotor6d_2.Name = "LeftArmMotor6D"
			leftArmMotor6d_2.MaxVelocity = 0.1
			leftArmMotor6d_2.C0 = CFrame.new(Vector3.new(-1.2238, 2.6627, -0.0037))
	...
	rightLeg.TextureID = "rbxassetid://74210666376037"
	...
	rightLeg.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
	rightLeg.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
	rightLeg.CFrame = CFrame.new(Vector3.new(-48.7406, 2.8532, -60.3696)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://139966409154676", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightLeg_2.TextureID = "rbxassetid://99182148252850"
		...
		rightLeg_2.Size = Vector3.new(0.4234, 1.7733, 0.6495)
		rightLeg_2.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
		rightLeg_2.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
		rightLeg_2.CFrame = CFrame.new(Vector3.new(-48.7406, 2.8532, -60.3696)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		rightLeg_2.PivotOffset = CFrame.new(Vector3.yAxis * 0.6171)
		do
			rightLegMotor6d_2 = Instance.new("Motor6D")
			rightLegMotor6d_2.Name = "RightLegMotor6D"
			rightLegMotor6d_2.MaxVelocity = 0.1
			rightLegMotor6d_2.C0 = CFrame.new(Vector3.new(0.229, 0.8962, -0.1298))
	...
	rightArm.TextureID = "rbxassetid://74210666376037"
	...
	rightArm.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
	rightArm.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
	rightArm.CFrame = CFrame.new(Vector3.new(-48.8857, 4.6109, -59.3712)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://99103628175723", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightArm_2.TextureID = "rbxassetid://99182148252850"
		...
		rightArm_2.Size = Vector3.new(1.8703, 0.6316, 0.4899)
		rightArm_2.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
		rightArm_2.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
		rightArm_2.CFrame = CFrame.new(Vector3.new(-48.8857, 4.6109, -59.3712)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		rightArm_2.PivotOffset = CFrame.new(Vector3.new(-0.9006, -0.0665, 0))
		do
			rightArmMotor6d_2 = Instance.new("Motor6D")
			rightArmMotor6d_2.Name = "RightArmMotor6D"
			rightArmMotor6d_2.MaxVelocity = 0.1
			rightArmMotor6d_2.C0 = CFrame.new(Vector3.new(1.2237, 2.6627, -0.0037))
	...
	rootPart.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
	rootPart.Size = Vector3.new(2, 2, 1)
	rootPart.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
	rootPart.CFrame = CFrame.new(Vector3.new(-48.8893, 1.9481, -60.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = dreamShelly
	humanoidRootPart = Instance.new("Part")
	humanoidRootPart.Name = "HumanoidRootPart"
	humanoidRootPart.Transparency = 1
	humanoidRootPart.AssemblyLinearVelocity = Vector3.new(0, -10.4655, 0)
	humanoidRootPart.Size = Vector3.new(2, 2, 1)
	humanoidRootPart.AssemblyAngularVelocity = Vector3.new(-2.7453, -0.0088, 0.4111)
	humanoidRootPart.CustomPhysicalProperties = PhysicalProperties.new(15, 0.3, 0.5, 1, 1, 1)
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-48.8893, 1.9481, -60.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = dreamShelly
end

dreamShelly.PrimaryPart = humanoidRootPart
