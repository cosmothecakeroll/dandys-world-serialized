local torso, torsoMotor6d, head, headMotor6d, bubbleChat, nameTagOverride, leftLeg, leftLegMotor6d, leftArm, leftArmMotor6d, rightLeg, rightLegMotor6d, rightArm, rightArmMotor6d, rootPart, weldConstraint, humanoidRootPart

local vintageShelly = Instance.new("Model")
vintageShelly.Name = "VintageShelly"
do
	...
	animations.Parent = vintageShelly
	...
	torso.TextureID = "rbxassetid://98216947942614"
	torso.Name = "Torso"
	torso.Massless = true
	torso.CanTouch = false
	torso.CanQuery = false
	torso.Size = Vector3.new(1.5396, 1.5637, 1.2412)
	torso.AssemblyAngularVelocity = Vector3.new(-3.2187, 0.3987, -6.0777)
	torso.AssemblyLinearVelocity = Vector3.new(0.1317, -0.235, 0.5177)
	torso.CFrame = CFrame.new(Vector3.new(-60.8736, 4.2068, -60.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	head.TextureID = "rbxassetid://98216947942614"
	head.Name = "Head"
	head.CanQuery = false
	head.CanTouch = false
	head.Massless = true
	...
	head.AssemblyLinearVelocity = Vector3.new(0.1317, -0.235, 0.5177)
	head.AssemblyAngularVelocity = Vector3.new(-3.2187, 0.3987, -6.0777)
	head.CFrame = CFrame.new(Vector3.new(-60.8704, 5.6816, -60.7934)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	leftLeg.TextureID = "rbxassetid://98216947942614"
	...
	leftLeg.AssemblyAngularVelocity = Vector3.new(-3.2187, 0.3987, -6.0777)
	leftLeg.AssemblyLinearVelocity = Vector3.new(0.1317, -0.235, 0.5177)
	leftLeg.CFrame = CFrame.new(Vector3.new(-60.7406, 2.8532, -60.8176)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftArm.TextureID = "rbxassetid://98216947942614"
	...
	leftArm.AssemblyAngularVelocity = Vector3.new(-3.2187, 0.3987, -6.0777)
	leftArm.AssemblyLinearVelocity = Vector3.new(0.1317, -0.235, 0.5177)
	leftArm.CFrame = CFrame.new(Vector3.new(-60.8857, 4.6109, -61.816)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.TextureID = "rbxassetid://98216947942614"
	...
	rightLeg.AssemblyAngularVelocity = Vector3.new(-3.2187, 0.3987, -6.0777)
	rightLeg.AssemblyLinearVelocity = Vector3.new(0.1317, -0.235, 0.5177)
	rightLeg.CFrame = CFrame.new(Vector3.new(-60.7406, 2.8532, -60.3696)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.TextureID = "rbxassetid://98216947942614"
	...
	rightArm.AssemblyAngularVelocity = Vector3.new(-3.2187, 0.3987, -6.0777)
	rightArm.AssemblyLinearVelocity = Vector3.new(0.1317, -0.235, 0.5177)
	rightArm.CFrame = CFrame.new(Vector3.new(-60.8857, 4.6109, -59.3712)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.AssemblyAngularVelocity = Vector3.new(-3.2187, 0.3987, -6.0777)
	rootPart.Size = Vector3.new(2, 2, 1)
	rootPart.AssemblyLinearVelocity = Vector3.new(0.1317, -0.235, 0.5177)
	rootPart.CFrame = CFrame.new(Vector3.new(-60.8893, 1.9481, -60.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = vintageShelly
	humanoidRootPart = Instance.new("Part")
	humanoidRootPart.Name = "HumanoidRootPart"
	humanoidRootPart.Transparency = 1
	humanoidRootPart.AssemblyLinearVelocity = Vector3.new(0.1317, -0.235, 0.5177)
	humanoidRootPart.Size = Vector3.new(2, 2, 1)
	humanoidRootPart.AssemblyAngularVelocity = Vector3.new(-3.2187, 0.3987, -6.0777)
	humanoidRootPart.CustomPhysicalProperties = PhysicalProperties.new(15, 0.3, 0.5, 1, 1, 1)
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-60.8893, 1.9481, -60.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = vintageShelly
end

vintageShelly.PrimaryPart = humanoidRootPart
