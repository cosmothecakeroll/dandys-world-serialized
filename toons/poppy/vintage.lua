local leftArm, leftArmHighlightMotor6d, rootPart, weldConstraint, head, headMotor6d, head_2, headHighlightMotor6d, torso, torsoMotor6d, humanoidRootPart, leftArm_2, leftArmMotor6d, leftLeg, leftLegMotor6d, rightArm, rightArmMotor6d, rightLeg, rightLegMotor6d, tailHighlight, ponyTailHighlightMotor6d, bowLeft, bowLeftMotor6d, bowCenter, bowCenterMotor6d, tail, ponyTailMotor6d, bowRight, bowRightMotor6d, rightArm_2, rightArmHighlightMotor6d

local vintagePoppy = Instance.new("Model")
vintagePoppy.Name = "VintagePoppy"
vintagePoppy.ModelStreamingMode = Enum.ModelStreamingMode.PersistentPerPlayer
do
	local toonName = Instance.new("StringValue")
	toonName.Name = "ToonName"
	toonName.Value = "Poppy"
	toonName.Parent = vintagePoppy
	...
	humanoid.Parent = vintagePoppy
	local config = Instance.new("Configuration")
	config.Name = "Config"
	do
		local normalTexture = Instance.new("Decal")
		normalTexture.Name = "NormalTexture"
		normalTexture.Texture = "rbxassetid://17675710022"
		normalTexture.Parent = config
		local hurtTexture = Instance.new("Decal")
		hurtTexture.Name = "HurtTexture"
		hurtTexture.Texture = "rbxassetid://17675712871"
		hurtTexture.Parent = config
		local blinkTexture = Instance.new("Decal")
		blinkTexture.Name = "BlinkTexture"
		blinkTexture.Texture = "rbxassetid://102790143676193"
	...
	animations.Parent = vintagePoppy
	leftArm = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://98138845146826", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	leftArm.TextureID = "rbxassetid://17675710022"
	...
	leftArm.CFrame = CFrame.new(Vector3.new(-60.3893, 2.9, -29.8509)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	leftArm.PivotOffset = CFrame.new(Vector3.new(1.2573, -2.7843, 0))
	do
		...
		leftArmHighlightMotor6d.Parent = leftArm
	end
	leftArm.Parent = vintagePoppy
	...
	rootPart.CFrame = CFrame.new(Vector3.new(-60.3893, 1.9481, -28.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	head.TextureID = "rbxassetid://17675710022"
	head.Name = "Head"
	...
	head.CFrame = CFrame.new(Vector3.new(-60.3893, 4.2744, -28.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		head_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://120190272004026", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		head_2.TextureID = "rbxassetid://17675710022"
		head_2.Name = "Head"
		head_2.CanCollide = false
		head_2.CanTouch = false
		head_2.Massless = true
		head_2.CanQuery = false
		head_2.Size = Vector3.new(2.9093, 2.8684, 2.623)
		head_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
		head_2.AssemblyLinearVelocity = Vector3.new(0, -0.0008, 0)
		head_2.CFrame = CFrame.new(Vector3.new(-60.3861, 4.2761, -28.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		head_2.PivotOffset = CFrame.new(Vector3.new(0, -4.1605, 0.0032))
		do
			...
			headHighlightMotor6d.Parent = head_2
		end
		head_2.Parent = head
	end
	head.Parent = vintagePoppy
	...
	torso.TextureID = "rbxassetid://17675710022"
	torso.Name = "Torso"
	torso.Massless = true
	...
	torso.CFrame = CFrame.new(Vector3.new(-60.3893, 2.1998, -28.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-60.3893, 1.9481, -28.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	humanoidRootPart.Parent = vintagePoppy
	...
	leftArm_2.TextureID = "rbxassetid://17675710022"
	...
	leftArm_2.AssemblyLinearVelocity = Vector3.new(0, -0.0008, 0)
	leftArm_2.CFrame = CFrame.new(Vector3.new(-60.3893, 2.8999, -29.8477)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftArmMotor6d.Parent = leftArm_2
	end
	leftArm_2.Parent = vintagePoppy
	...
	leftLeg.TextureID = "rbxassetid://17675710022"
	...
	leftLeg.CFrame = CFrame.new(Vector3.new(-60.2321, 0.9887, -28.8277)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightArm.TextureID = "rbxassetid://17675710022"
	...
	rightArm.CFrame = CFrame.new(Vector3.new(-60.3893, 2.8999, -27.3395)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.TextureID = "rbxassetid://17675710022"
	...
	rightLeg.CFrame = CFrame.new(Vector3.new(-60.2321, 0.9887, -28.3595)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.Parent = vintagePoppy
	tailHighlight = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://90243234136195", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	tailHighlight.TextureID = "rbxassetid://17675710022"
	tailHighlight.Name = "TailHighlight"
	tailHighlight.CanCollide = false
	tailHighlight.CanTouch = false
	tailHighlight.Massless = true
	tailHighlight.CanQuery = false
	tailHighlight.Size = Vector3.new(1.9574, 2.0381, 1.9806)
	tailHighlight.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	tailHighlight.AssemblyLinearVelocity = Vector3.new(0, -0.0008, 0)
	tailHighlight.CFrame = CFrame.new(Vector3.new(-61.9359, 3.6057, -28.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	tailHighlight.PivotOffset = CFrame.new(Vector3.new(0, -3.4901, -1.5466))
	do
		...
		ponyTailHighlightMotor6d.Parent = tailHighlight
	end
	tailHighlight.Parent = vintagePoppy
	...
	bowLeft.TextureID = "rbxassetid://17675710022"
	...
	bowLeft.CFrame = CFrame.new(Vector3.new(-60.0964, 5.6829, -29.6313)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	bowCenter.TextureID = "rbxassetid://17675710022"
	...
	bowCenter.CFrame = CFrame.new(Vector3.new(-60.0141, 5.574, -28.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	bowCenter.Parent = vintagePoppy
	tail = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://74607815933810", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	tail.TextureID = "rbxassetid://17675710022"
	tail.Name = "Tail"
	tail.CanCollide = false
	tail.CanTouch = false
	tail.Massless = true
	tail.CanQuery = false
	tail.Size = Vector3.new(1.8319, 1.9074, 1.8536)
	tail.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	tail.AssemblyLinearVelocity = Vector3.new(0, -0.0008, 0)
	tail.CFrame = CFrame.new(Vector3.new(-61.9362, 3.6054, -28.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	tail.PivotOffset = CFrame.new(Vector3.new(0, -3.4897, -1.5469))
	do
		...
		ponyTailMotor6d.Parent = tail
	end
	tail.Parent = vintagePoppy
	...
	bowRight.TextureID = "rbxassetid://17675710022"
	...
	bowRight.CFrame = CFrame.new(Vector3.new(-60.0964, 5.6829, -27.5559)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	bowRight.Parent = vintagePoppy
	rightArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://88556852057218", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
	rightArm_2.TextureID = "rbxassetid://17675710022"
	...
	rightArm_2.Size = Vector3.new(1.9991, 0.6463, 0.369)
	rightArm_2.AssemblyAngularVelocity = Vector3.new(0, 0, 0)
	rightArm_2.AssemblyLinearVelocity = Vector3.new(0, -0.0008, 0)
	rightArm_2.CFrame = CFrame.new(Vector3.new(-60.3893, 2.9, -27.3363)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	rightArm_2.PivotOffset = CFrame.new(Vector3.new(-1.2574, -2.7843, 0))
	do
		...
		rightArmHighlightMotor6d.Parent = rightArm_2
	end
	rightArm_2.Parent = vintagePoppy
end

vintagePoppy.PrimaryPart = humanoidRootPart
leftArmHighlightMotor6d.Part0 = rootPart
leftArmHighlightMotor6d.Part1 = leftArm
weldConstraint.Part1 = rootPart
weldConstraint.Part0 = humanoidRootPart
headMotor6d.Part0 = rootPart
headMotor6d.Part1 = head
headHighlightMotor6d.Part0 = rootPart
headHighlightMotor6d.Part1 = head_2
torsoMotor6d.Part0 = rootPart
torsoMotor6d.Part1 = torso
leftArmMotor6d.Part0 = rootPart
leftArmMotor6d.Part1 = leftArm_2
...
ponyTailHighlightMotor6d.Part1 = tailHighlight
