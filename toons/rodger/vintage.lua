...
local vintageRodger = Instance.new("Model")
vintageRodger.Name = "VintageRodger"
do
	...
	animations.Parent = vintageRodger
	...
	blinkingParts.Parent = vintageRodger
	...
	head_2.TextureID = "rbxassetid://103859346618479"
	head_2.Name = "Head"
	...
	head_2.AssemblyAngularVelocity = Vector3.new(0.3026, 0.0035, 0.342)
	head_2.AssemblyLinearVelocity = Vector3.new(6.9709, -9.4632, -3.2549)
	head_2.CFrame = CFrame.new(Vector3.new(-45.7501, 3.7679, -45.9382)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	headGlass.TextureID = "rbxassetid://140338986046587"
	...
	headGlass.AssemblyAngularVelocity = Vector3.new(0.3026, 0.0035, 0.342)
	headGlass.Size = Vector3.new(2.1496, 2.1828, 0.14)
	headGlass.AssemblyLinearVelocity = Vector3.new(6.9709, -9.4632, -3.2549)
	headGlass.Material = Enum.Material.SmoothPlastic
	headGlass.CFrame = CFrame.new(Vector3.new(-45.7501, 4.2526, -45.5938)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	headGlass.Parent = vintageRodger
	...
	leftArm.TextureID = "rbxassetid://103859346618479"
	...
	leftArm.AssemblyAngularVelocity = Vector3.new(0.3026, 0.0035, 0.342)
	leftArm.AssemblyLinearVelocity = Vector3.new(6.9709, -9.4632, -3.2549)
	leftArm.CFrame = CFrame.new(Vector3.new(-45.8924, 2.8339, -46.8706)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	leftLeg.TextureID = "rbxassetid://103859346618479"
	...
	leftLeg.AssemblyAngularVelocity = Vector3.new(0.3026, 0.0035, 0.342)
	leftLeg.AssemblyLinearVelocity = Vector3.new(6.9709, -9.4632, -3.2549)
	leftLeg.CFrame = CFrame.new(Vector3.new(-45.7467, 0.9977, -45.8276)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	magnifyingGlassGeo.TextureID = "rbxassetid://103859346618479"
	...
	magnifyingGlassGeo.AssemblyAngularVelocity = Vector3.new(0.3026, 0.0035, 0.342)
	magnifyingGlassGeo.AssemblyLinearVelocity = Vector3.new(6.9709, -9.4632, -3.2549)
	magnifyingGlassGeo.CFrame = CFrame.new(Vector3.new(-45.8894, 2.2302, -45.5956)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	magnifyingGlassGeo.Parent = vintageRodger
	...
	rightArm.TextureID = "rbxassetid://103859346618479"
	...
	rightArm.AssemblyAngularVelocity = Vector3.new(0.3026, 0.0035, 0.342)
	rightArm.AssemblyLinearVelocity = Vector3.new(6.9709, -9.4632, -3.2549)
	rightArm.CFrame = CFrame.new(Vector3.new(-45.8924, 2.8339, -44.3166)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rightLeg.TextureID = "rbxassetid://103859346618479"
	...
	rightLeg.AssemblyAngularVelocity = Vector3.new(0.3026, 0.0035, 0.342)
	rightLeg.AssemblyLinearVelocity = Vector3.new(6.9709, -9.4632, -3.2549)
	rightLeg.CFrame = CFrame.new(Vector3.new(-45.7467, 0.9977, -45.3596)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	torso.TextureID = "rbxassetid://103859346618479"
	torso.Name = "Torso"
	torso.Massless = true
	torso.CanTouch = false
	torso.CanQuery = false
	torso.Size = Vector3.new(1.0186, 1.6069, 0.887)
	torso.AssemblyAngularVelocity = Vector3.new(0.3026, 0.0035, 0.342)
	torso.AssemblyLinearVelocity = Vector3.new(6.9709, -9.4632, -3.2549)
	torso.CFrame = CFrame.new(Vector3.new(-45.8605, 2.3431, -45.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	rootPart.AssemblyAngularVelocity = Vector3.new(0.3026, 0.0035, 0.342)
	rootPart.Size = Vector3.new(2, 2, 1)
	rootPart.AssemblyLinearVelocity = Vector3.new(6.9709, -9.4632, -3.2549)
	rootPart.CFrame = CFrame.new(Vector3.new(-45.8894, 0.0456, -45.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = vintageRodger
	humanoidRootPart = Instance.new("Part")
	humanoidRootPart.Name = "HumanoidRootPart"
	humanoidRootPart.Transparency = 1
	humanoidRootPart.AssemblyLinearVelocity = Vector3.new(6.9709, -9.4632, -3.2549)
	humanoidRootPart.Size = Vector3.new(2, 2, 1)
	humanoidRootPart.AssemblyAngularVelocity = Vector3.new(0.3026, 0.0035, 0.342)
	humanoidRootPart.CustomPhysicalProperties = PhysicalProperties.new(15, 1, 0.3, 1, 1, 1)
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-45.8894, 1.9481, -45.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = vintageRodger
end

vintageRodger.PrimaryPart = humanoidRootPart
