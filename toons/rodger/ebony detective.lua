...
local aceDetective = Instance.new("Model")
aceDetective.Name = "AceDetective"
do
	...
	blinkingParts.Parent = aceDetective
	local animations = Instance.new("Configuration")
	animations.Name = "Animations"
	do
		local ability = Instance.new("Animation")
		ability.Name = "Ability"
		ability.AnimationId = "rbxassetid://86546894862650"
		ability.Parent = animations
		local decode = Instance.new("Animation")
		decode.Name = "Decode"
		decode.AnimationId = "rbxassetid://126001914005116"
		decode.Parent = animations
		local idle = Instance.new("Animation")
		idle.Name = "Idle"
		idle.AnimationId = "rbxassetid://87574137172546"
		idle.Parent = animations
		local quirk = Instance.new("Animation")
		quirk.Name = "Quirk"
		quirk.AnimationId = "rbxassetid://112785443432375"
		quirk.Parent = animations
		local run = Instance.new("Animation")
		run.Name = "Run"
		run.AnimationId = "rbxassetid://124008009539439"
		run.Parent = animations
		local walk = Instance.new("Animation")
		walk.Name = "Walk"
		walk.AnimationId = "rbxassetid://100684475582940"
		walk.Parent = animations
	end
	animations.Parent = aceDetective
	...
	head_2.TextureID = "rbxassetid://86854944999267"
	head_2.Name = "Head"
	...
	head_2.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
	head_2.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
	head_2.CFrame = CFrame.new(Vector3.new(-41.7501, 3.7679, -45.9382)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		head_3 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://110505790427959", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		head_3.TextureID = "rbxassetid://86854944999267"
		head_3.Name = "_Head"
		head_3.CanCollide = false
		head_3.CanTouch = false
		head_3.Massless = true
		head_3.CanQuery = false
		head_3.Size = Vector3.new(3.4766, 3.8, 0.3334)
		head_3.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
		head_3.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
		head_3.CFrame = CFrame.new(Vector3.new(-41.7501, 3.7679, -45.9382)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		head_3.PivotOffset = CFrame.new(Vector3.new(0.3451, -3.728, 0.1395)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			headMotor6d_2 = Instance.new("Motor6D")
			headMotor6d_2.Name = "HeadMotor6D"
			headMotor6d_2.MaxVelocity = 0.1
			headMotor6d_2.C0 = CFrame.new(Vector3.new(-0.3452, 3.7279, -0.1396))
	...
	headGlass.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
	headGlass.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
	headGlass.Size = Vector3.new(2.1496, 2.1828, 0.14)
	headGlass.Material = Enum.Material.SmoothPlastic
	headGlass.CFrame = CFrame.new(Vector3.new(-41.7501, 4.2526, -45.5938)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		headGlass_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://114259673051879", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		...
		headGlass_2.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
		headGlass_2.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
		headGlass_2.Size = Vector3.new(2.1527, 2.1859, 0.1402)
		headGlass_2.Material = Enum.Material.SmoothPlastic
		headGlass_2.CFrame = CFrame.new(Vector3.new(-41.7501, 4.2526, -45.5938)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		headGlass_2.PivotOffset = CFrame.new(Vector3.new(0, -4.2131, 0.1395)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			headGlassMotor6d_2 = Instance.new("Motor6D")
			headGlassMotor6d_2.Name = "HeadGlassMotor6D"
			headGlassMotor6d_2.MaxVelocity = 0.1
			headGlassMotor6d_2.C0 = CFrame.new(Vector3.new(0, 4.213, -0.1396))
	...
	leftArm.TextureID = "rbxassetid://86854944999267"
	...
	leftArm.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
	leftArm.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
	leftArm.CFrame = CFrame.new(Vector3.new(-41.8924, 2.8339, -46.8706)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://84959867621413", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftArm_2.TextureID = "rbxassetid://86854944999267"
		leftArm_2.Name = "LeftArm"
		leftArm_2.CanCollide = false
		leftArm_2.CanTouch = false
		leftArm_2.Massless = true
		leftArm_2.CanQuery = false
		leftArm_2.Size = Vector3.new(2, 0.6608, 0.5525)
		leftArm_2.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
		leftArm_2.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
		leftArm_2.CFrame = CFrame.new(Vector3.new(-41.8924, 2.8339, -46.8706)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		leftArm_2.PivotOffset = CFrame.new(Vector3.new(1.2585, -2.7894, -0.0084)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			leftArmMotor6d_2 = Instance.new("Motor6D")
			leftArmMotor6d_2.Name = "LeftArmMotor6D"
			leftArmMotor6d_2.MaxVelocity = 0.1
			leftArmMotor6d_2.C0 = CFrame.new(Vector3.new(-1.2586, 2.7893, 0.0083))
	...
	leftLeg.TextureID = "rbxassetid://86854944999267"
	...
	leftLeg.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
	leftLeg.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
	leftLeg.CFrame = CFrame.new(Vector3.new(-41.7467, 0.9977, -45.8276)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		leftLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://92022520149474", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		leftLeg_2.TextureID = "rbxassetid://86854944999267"
		leftLeg_2.Name = "LeftLeg"
		leftLeg_2.CanCollide = false
		leftLeg_2.CanTouch = false
		leftLeg_2.Massless = true
		leftLeg_2.CanQuery = false
		leftLeg_2.Size = Vector3.new(0.4375, 1.837, 0.657)
		leftLeg_2.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
		leftLeg_2.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
		leftLeg_2.CFrame = CFrame.new(Vector3.new(-41.7467, 0.9977, -45.8276)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		leftLeg_2.PivotOffset = CFrame.new(Vector3.new(0.2344, -0.9125, 0.1406)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			leftLegMotor6d_2 = Instance.new("Motor6D")
			leftLegMotor6d_2.Name = "LeftLegMotor6D"
			leftLegMotor6d_2.MaxVelocity = 0.1
			leftLegMotor6d_2.C0 = CFrame.new(Vector3.new(-0.2345, 0.9124, -0.1407))
	...
	magnifyingGlassGeo.TextureID = "rbxassetid://86854944999267"
	...
	magnifyingGlassGeo.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
	magnifyingGlassGeo.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
	magnifyingGlassGeo.CFrame = CFrame.new(Vector3.new(-41.8894, 2.2302, -45.5956)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		magnifyingGlassGeo_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://91118070996279", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		magnifyingGlassGeo_2.TextureID = "rbxassetid://92432478151507"
		...
		magnifyingGlassGeo_2.Size = Vector3.new(0.6978, 1.2775, 0.2098)
		magnifyingGlassGeo_2.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
		magnifyingGlassGeo_2.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
		magnifyingGlassGeo_2.CFrame = CFrame.new(Vector3.new(-41.8894, 2.2302, -45.5956)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		magnifyingGlassGeo_2.PivotOffset = CFrame.new(Vector3.new(0.002, -2.1878, 0)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			...
			magnifyingGlassGeoMotor6d_2.C0 = CFrame.new(Vector3.new(-0.0021, 2.1877, 0))
	...
	magnifyingGlassGeo.Parent = aceDetective
	...
	rightArm.TextureID = "rbxassetid://86854944999267"
	...
	rightArm.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
	rightArm.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
	rightArm.CFrame = CFrame.new(Vector3.new(-41.8924, 2.8339, -44.3166)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightArm_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://109766287265490", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightArm_2.TextureID = "rbxassetid://86854944999267"
		...
		rightArm_2.Size = Vector3.new(2, 0.6608, 0.5525)
		rightArm_2.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
		rightArm_2.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
		rightArm_2.CFrame = CFrame.new(Vector3.new(-41.8924, 2.8339, -44.3166)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		rightArm_2.PivotOffset = CFrame.new(Vector3.new(-1.2586, -2.7894, -0.0084)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			rightArmMotor6d_2 = Instance.new("Motor6D")
			rightArmMotor6d_2.Name = "RightArmMotor6D"
			rightArmMotor6d_2.MaxVelocity = 0.1
			rightArmMotor6d_2.C0 = CFrame.new(Vector3.new(1.2585, 2.7893, 0.0083))
	...
	rightLeg.TextureID = "rbxassetid://86854944999267"
	...
	rightLeg.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
	rightLeg.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
	rightLeg.CFrame = CFrame.new(Vector3.new(-41.7467, 0.9977, -45.3596)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		rightLeg_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://114658461010402", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		rightLeg_2.TextureID = "rbxassetid://86854944999267"
		...
		rightLeg_2.Size = Vector3.new(0.4375, 1.837, 0.657)
		rightLeg_2.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
		rightLeg_2.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
		rightLeg_2.CFrame = CFrame.new(Vector3.new(-41.7467, 0.9977, -45.3596)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		rightLeg_2.PivotOffset = CFrame.new(Vector3.new(-0.2345, -0.9125, 0.1406)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			rightLegMotor6d_2 = Instance.new("Motor6D")
			rightLegMotor6d_2.Name = "RightLegMotor6D"
			rightLegMotor6d_2.MaxVelocity = 0.1
			rightLegMotor6d_2.C0 = CFrame.new(Vector3.new(0.2344, 0.9124, -0.1407))
	...
	torso.TextureID = "rbxassetid://86854944999267"
	torso.Name = "Torso"
	...
	torso.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
	torso.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
	torso.CFrame = CFrame.new(Vector3.new(-41.8605, 2.3431, -45.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	...
	do
		...
		torso_2 = game:GetService("InsertService"):CreateMeshPartAsync("rbxassetid://104291532309876", Enum.CollisionFidelity.Box, Enum.RenderFidelity.Automatic)
		torso_2.TextureID = "rbxassetid://86854944999267"
		torso_2.Name = "Torso"
		torso_2.CanCollide = false
		torso_2.CanTouch = false
		torso_2.Massless = true
		torso_2.CanQuery = false
		torso_2.Size = Vector3.new(1.0202, 1.6094, 0.8883)
		torso_2.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
		torso_2.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
		torso_2.CFrame = CFrame.new(Vector3.new(-41.8605, 2.3431, -45.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
		torso_2.PivotOffset = CFrame.new(Vector3.new(0, -2.301, 0.0288)) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		do
			torsoMotor6d_2 = Instance.new("Motor6D")
			torsoMotor6d_2.Name = "TorsoMotor6D"
			torsoMotor6d_2.MaxVelocity = 0.1
			torsoMotor6d_2.C0 = CFrame.new(Vector3.new(0, 2.3009, -0.0289))
	...
	rootPart.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
	rootPart.Size = Vector3.new(2, 2, 1)
	rootPart.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
	rootPart.CFrame = CFrame.new(Vector3.new(-41.8894, 0.0456, -45.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	rootPart.Parent = aceDetective
	humanoidRootPart = Instance.new("Part")
	humanoidRootPart.Name = "HumanoidRootPart"
	humanoidRootPart.Transparency = 1
	humanoidRootPart.AssemblyLinearVelocity = Vector3.new(0.0098, -11.738, -0.0557)
	humanoidRootPart.Size = Vector3.new(2, 2, 1)
	humanoidRootPart.AssemblyAngularVelocity = Vector3.new(0.2508, 0.2087, 0.3055)
	humanoidRootPart.CustomPhysicalProperties = PhysicalProperties.new(15, 1, 0.3, 1, 1, 1)
	humanoidRootPart.CFrame = CFrame.new(Vector3.new(-41.8894, 1.9481, -45.5936)) * CFrame.fromEulerAnglesXYZ(0, math.rad(-90), 0)
	do
	...
	humanoidRootPart.Parent = aceDetective
end

aceDetective.PrimaryPart = humanoidRootPart
