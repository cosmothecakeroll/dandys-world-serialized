...
do
	...
	buffParticle.Color = ColorSequence.new(Color3.fromRGB(255, 240, 30), Color3.fromRGB(255, 255, 255))
	buffParticle.Parent = speed
	...
	glow.Color = ColorSequence.new(Color3.fromRGB(111, 103, 16), Color3.fromRGB(111, 103, 16))
	glow.Parent = speed
end
