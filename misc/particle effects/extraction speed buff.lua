local decodeSpeed = Instance.new("Folder")
decodeSpeed.Name = "DecodeSpeed"
do
	...
	glow.Color = ColorSequence.new(Color3.fromRGB(70, 21, 111), Color3.fromRGB(70, 21, 111))
	glow.Parent = decodeSpeed
	...
	buffParticle.Color = ColorSequence.new(Color3.fromRGB(129, 66, 255), Color3.fromRGB(255, 255, 255))
	buffParticle.Parent = decodeSpeed
end
