...
every rig and model was **serialized** (from model → script) manually using [Darkceius' Instance Serializer](https://create.roblox.com/store/asset/128675874900923/Instance-Serializer) because who uses automated systems ahaHAhaha
