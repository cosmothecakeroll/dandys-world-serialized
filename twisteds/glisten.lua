...
do
	...
	do
		...
		walk.Name = "Walk"
		walk.AnimationId = "rbxassetid://102431855894099"
		walk.Parent = animations
		local run = Instance.new("Animation")
		run.Name = "Run"
		run.AnimationId = "rbxassetid://104865739814918"
		run.Parent = animations
		local madWalk = Instance.new("Animation")
		madWalk.Name = "MadWalk"
		madWalk.AnimationId = "rbxassetid://100629080976015"
		madWalk.Parent = animations
		local lostInterest = Instance.new("Animation")
		lostInterest.Name = "LostInterest"
		lostInterest.AnimationId = "rbxassetid://123033537243489"
		lostInterest.Parent = animations
		local idle = Instance.new("Animation")
		idle.Name = "Idle"
		idle.AnimationId = "rbxassetid://75108379231870"
		idle.Parent = animations
		local enrage = Instance.new("Animation")
		enrage.Name = "Enrage"
		enrage.AnimationId = "rbxassetid://94903912457052"
		enrage.Parent = animations
		local attack = Instance.new("Animation")
		attack.Name = "Attack"
		attack.AnimationId = "rbxassetid://72846539718490"
